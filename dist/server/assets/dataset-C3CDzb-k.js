//#region i18n/es-ES/dataset.json
var allExternalTip = "Al usar solo conocimiento externo, el usuario puede elegir si desea habilitar el modelo Rerank. Si no se habilita, los fragmentos recuperados se ordenarán en función de las puntuaciones. Cuando las estrategias de recuperación de diferentes bases de conocimiento son inconsistentes, serán inexactas.";
var allKnowledge = "Todo el conocimiento";
var allKnowledgeDescription = "Seleccione esta opción para mostrar todos los conocimientos de este espacio de trabajo. Solo el propietario del espacio de trabajo puede administrar todo el conocimiento.";
var appCount = " aplicaciones vinculadas";
var connectDataset = "Conéctese a una base de conocimientos externa";
var createDataset = "Crear Conocimiento";
var createDatasetIntro = "Importa tus propios datos de texto o escribe datos en tiempo real a través de Webhook para mejorar el contexto de LLM.";
var createExternalAPI = "Adición de una API de conocimiento externa";
var createFromPipeline = "Crear desde Knowledge Pipeline";
var createNewExternalAPI = "Creación de una nueva API de conocimiento externo";
var datasetDeleteFailed = "Error al eliminar el Conocimiento";
var datasetDeleted = "Conocimiento eliminado";
var datasetUsedByApp = "El conocimiento está siendo utilizado por algunas aplicaciones. Las aplicaciones ya no podrán utilizar este Conocimiento y todas las configuraciones y registros de las sugerencias se eliminarán permanentemente.";
var datasets = "CONOCIMIENTO";
var datasetsApi = "ACCESO A LA API";
var defaultRetrievalTip = "De forma predeterminada, se utiliza la recuperación de varias rutas. El conocimiento se recupera de múltiples bases de conocimiento y luego se vuelve a clasificar.";
var deleteDatasetConfirmContent = "Eliminar el Conocimiento es irreversible. Los usuarios ya no podrán acceder a tu Conocimiento y todas las configuraciones y registros de las sugerencias se eliminarán permanentemente.";
var deleteDatasetConfirmTitle = "¿Eliminar este Conocimiento?";
var didYouKnow = "¿Sabías?";
var docAllEnabled_one = "Documento {{count}} activado";
var docAllEnabled_other = "Todos los documentos {{count}} habilitados";
var docsFailedNotice = "no se pudieron indexar los documentos";
var documentCount = " documentos";
var documentsDisabled = "{{num}} Documentos desactivados - inactivos durante más de 30 días";
var editExternalAPIFormTitle = "Editar la API de conocimiento externo";
var editExternalAPITooltipTitle = "CONOCIMIENTO VINCULADO";
var embeddingModelNotAvailable = "El modelo de embeddings no está disponible.";
var enable = "Habilitar";
var externalAPI = "API externa";
var externalAPIPanelDescription = "La API de conocimiento externo se utiliza para conectarse a una base de conocimiento fuera de Dify y recuperar conocimiento de esa base de conocimiento.";
var externalAPIPanelDocumentation = "Más información sobre cómo crear una API de conocimiento externo";
var externalAPIPanelTitle = "API de conocimiento externo";
var externalKnowledgeBase = "Base de conocimientos externa";
var externalKnowledgeDescription = "Descripción del conocimiento";
var externalKnowledgeDescriptionPlaceholder = "Describa lo que hay en esta base de conocimientos (opcional)";
var externalKnowledgeId = "ID de conocimiento externo";
var externalKnowledgeIdPlaceholder = "Introduzca el ID de conocimiento";
var externalKnowledgeName = "Nombre del conocimiento externo";
var externalKnowledgeNamePlaceholder = "Introduzca el nombre de la base de conocimientos";
var externalTag = "Externo";
var inconsistentEmbeddingModelTip = "Se requiere el modelo de reclasificación si los modelos de incrustación de las bases de conocimiento seleccionadas son inconsistentes.";
var intro1 = "El Conocimiento se puede integrar en la aplicación Dify ";
var intro2 = "como contexto";
var intro3 = ",";
var intro4 = "o ";
var intro5 = "se puede crear";
var intro6 = " como un complemento independiente de ChatGPT para publicar";
var knowledge = "Conocimiento";
var learnHowToWriteGoodKnowledgeDescription = "Aprende a escribir una buena descripción del conocimiento";
var localDocs = "Documentos locales";
var mixtureHighQualityAndEconomicTip = "Se requiere el modelo de reclasificación para la mezcla de bases de conocimiento de alta calidad y económicas.";
var mixtureInternalAndExternalTip = "El modelo de Rerank es necesario para la mezcla de conocimiento interno y externo.";
var multimodal = "Multimodal";
var nTo1RetrievalLegacy = "La recuperación N-a-1 será oficialmente obsoleta a partir de septiembre. Se recomienda utilizar la última recuperación de múltiples rutas para obtener mejores resultados.";
var nTo1RetrievalLegacyLink = "Más información";
var nTo1RetrievalLegacyLinkText = "La recuperación N-a-1 será oficialmente obsoleta en septiembre.";
var noExternalKnowledge = "Todavía no hay una API de conocimiento externo, haga clic aquí para crear";
var partialEnabled_one = "Total de {{count}} documentos, {{num}} disponibles";
var partialEnabled_other = "Total de {{count}} documentos, {{num}} disponibles";
var preprocessDocument = "{{num}} Documentos de preprocesamiento";
var rerankSettings = "Configuración de reclasificación";
var retrievalSettings = "Configuración de recuperación";
var retry = "Reintentar";
var unavailable = "No disponible";
var unknownError = "Error desconocido";
var updated = "Actualizado";
var wordCount = " mil palabras";
var dataset_default = {
	allExternalTip,
	allKnowledge,
	...
	"externalKnowledgeForm.connectedFailed": "Error al conectar la Base de Conocimiento Externa",
	"externalKnowledgeForm.connectedSuccess": "Base de Conocimiento Externa conectada correctamente",
	externalKnowledgeId,
