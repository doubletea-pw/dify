//#region i18n/ru-RU/tools.json
var allTools = "Все инструменты";
var author = "Автор";
var builtInPromptTitle = "Подсказка";
var copyToolName = "Копировать имя";
var createCustomTool = "Создать пользовательский инструмент";
var customToolTip = "Узнать больше о пользовательских инструментах Dify";
var howToGet = "Как получить";
var includeToolNum = "Включено {{num}} {{action}}";
var noTools = "Инструменты не найдены";
var notAuthorized = "Инструмент не авторизован";
var openInStudio = "Открыть в Studio";
var title = "Инструменты";
var toolNameUsageTip = "Название вызова инструмента для рассуждений агента и подсказок";
var toolRemoved = "Инструмент удален";
var tools_default = {
	...
	"mcp.modal.invalidServerIdentifier": "Введите корректный идентификатор сервера",
	"mcp.modal.invalidServerUrl": "Введите корректный URL сервера",
