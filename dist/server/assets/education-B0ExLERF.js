//#region i18n/ar-TN/education.json
var currentSigned = "تم تسجيل الدخول حاليًا باسم";
var emailLabel = "بريدك الإلكتروني الحالي";
var learn = "تعرف على كيفية التحقق من التعليم";
var rejectContent = "لسوء الحظ، أنت غير مؤهل للحصول على حالة التحقق التعليمي وبالتالي لا يمكنك الحصول على كوبون حصري 100٪ لخطة Dify Professional إذا كنت تستخدم عنوان البريد الإلكتروني هذا.";
var rejectTitle = "تم رفض التحقق التعليمي الخاص بك في Dify";
var submit = "إرسال";
var submitError = "فشل إرسال النموذج. يرجى المحاولة مرة أخرى لاحقًا.";
var successContent = "لقد أصدرنا كوبون خصم 100٪ لخطة Dify Professional لحسابك. الكوبون ساري لمدة عام واحد، يرجى استخدامه خلال فترة الصلاحية.";
var successTitle = "لقد حصلت على التحقق التعليمي من Dify";
var toVerified = "احصل على التحقق التعليمي";
