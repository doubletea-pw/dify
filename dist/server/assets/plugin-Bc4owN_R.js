//#region i18n/en-US/plugin.json
var allCategories = "All Categories";
var deprecated = "Deprecated";
var difyVersionNotCompatible = "The current Dify version is not compatible with this plugin, please upgrade to the minimum version required: {{minimalDifyVersion}}";
var endpointsEnabled = "{{num}} sets of endpoints enabled";
var findMoreInMarketplace = "Find more in Marketplace";
var from = "From";
var fromMarketplace = "From Marketplace";
var install = "{{num}} installs";
var installAction = "Install";
var installFrom = "INSTALL FROM";
var installPlugin = "Install plugin";
var publishPlugins = "Publish plugins";
var requestAPlugin = "Request a plugin";
var search = "Search";
var searchCategories = "Search Categories";
var searchInMarketplace = "Search in Marketplace";
var searchPlugins = "Search plugins";
