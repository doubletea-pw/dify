//#region i18n/uk-UA/tools.json
var allTools = "Всі інструменти";
var author = "Автор";
var builtInPromptTitle = "Підказка";
var copyToolName = "Ім'я копії";
var createCustomTool = "Створити власний інструмент";
var customToolTip = "Дізнайтеся більше про користувацькі інструменти Dify";
var howToGet = "Як отримати";
var includeToolNum = "{{num}} {{action}} включено";
var noTools = "Інструментів не знайдено";
var notAuthorized = "Інструмент не авторизовано";
var openInStudio = "Відкрити в Студії";
var title = "Інструменти";
var toolNameUsageTip = "Ім'я виклику інструменту для міркувань і підказок агента";
var toolRemoved = "Інструмент видалено";
var tools_default = {
	...
	"mcp.modal.invalidServerIdentifier": "Будь ласка, введіть дійсний ідентифікатор сервера",
	"mcp.modal.invalidServerUrl": "Будь ласка, введіть дійсну URL-адресу сервера",
