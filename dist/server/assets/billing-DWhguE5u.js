//#region i18n/fr-FR/billing.json
var buyPermissionDeniedTip = "Veuillez contacter votre administrateur d'entreprise pour vous abonner";
var currentPlan = "Plan Actuel";
var teamMembers = "Membres de l'équipe";
var viewBilling = "Gérer la facturation et les abonnements";
var viewBillingAction = "Gérer";
var viewBillingDescription = "Gérer les méthodes de paiement, les factures et les modifications d'abonnement";
var viewBillingTitle = "Facturation et abonnements";
var billing_default = {
	"annotatedResponse.fullTipLine1": "Mettez à niveau votre plan pour",
	"annotatedResponse.fullTipLine2": "annotez plus de conversations.",
	"annotatedResponse.quotaTitle": "Quota de Réponse d'Annotation",
	"apps.contactUs": "Contactez-nous",
	"apps.fullTip1": "Mettez à niveau pour créer plus d'applications",
	"apps.fullTip1des": "Vous avez atteint la limite de création d'applications avec ce plan.",
	"apps.fullTip2": "Limite de plan atteinte",
	...
	"plans.community.features": [
		"Toutes les fonctionnalités principales publiées dans le dépôt public",
		"Espace de travail unique",
		"Conforme à la licence open source Dify"
	],
	"plans.community.for": "Pour les utilisateurs individuels, les petites équipes ou les projets non commerciaux",
	...
	"plans.enterprise.features": [
		"Solutions de déploiement évolutives de niveau entreprise",
		"Autorisation de licence commerciale",
		"Fonctionnalités exclusives pour les entreprises",
		"Espaces de travail multiples et gestion d'entreprise",
		"SSO",
		"Accords sur les SLA négociés par les partenaires Dify",
		"Sécurité et contrôles avancés",
		"Mises à jour et maintenance par Dify Officiellement",
	...
	"plans.premium.btnText": "Obtenez Premium dans",
	"plans.premium.comingSoon": "Support de Microsoft Azure et Google Cloud bientôt disponible",
	"plans.premium.description": "Pour les organisations et les équipes de taille moyenne",
	"plans.premium.features": [
		"Fiabilité autonome par divers fournisseurs de cloud",
		"Espace de travail unique",
		"Personnalisation du logo et de l'image de marque de l'application web",
		"Assistance prioritaire par e-mail et chat"
	],
	"plans.premium.for": "Pour les organisations et les équipes de taille moyenne",
	"plans.premium.includesTitle": "Tout de la communauté, en plus :",
	"plans.premium.name": "Premium",
	"plans.premium.price": "Scalable",
	"plans.premium.priceTip": "Basé sur le marché des nuages",
	"plans.professional.description": "Pour les individus et les petites équipes afin de débloquer plus de puissance à un prix abordable.",
	"plans.professional.for": "Pour les développeurs indépendants/petites équipes",
	"plans.professional.name": "Professionnel",
	"plans.sandbox.description": "200 essais gratuits de GPT",
	"plans.sandbox.for": "Essai gratuit des fonctionnalités principales",
	"plans.sandbox.name": "Bac à sable",
	...
	"plansCommon.contactSales": "Contacter les ventes",
	"plansCommon.contractOwner": "Contacter le chef d'équipe",
	"plansCommon.contractSales": "Contactez les ventes",
	"plansCommon.currentPlan": "Plan Actuel",
	"plansCommon.customTools": "Outils personnalisés",
	"plansCommon.days": "jours",
	"plansCommon.documentProcessingPriority": "Priorité de Traitement de Document",
	"plansCommon.documentProcessingPriorityTip": "Pour une priorité de traitement des documents plus élevée, veuillez mettre à niveau votre plan.",
	"plansCommon.documentProcessingPriorityUpgrade": "Traitez plus de données avec une précision plus élevée à des vitesses plus rapides.",
	"plansCommon.documents": "{{count,number}} Documents de connaissance",
	"plansCommon.documentsRequestQuota": "{{count,number}}/min Limite de Fréquence de Demande de Connaissance",
	"plansCommon.documentsRequestQuotaTooltip": "Spécifie le nombre total d'actions qu'un espace de travail peut effectuer par minute dans la base de connaissances, y compris la création, la suppression, les mises à jour de jeux de données, le téléchargement de documents, les modifications, l'archivage et les requêtes de la base de connaissances. Ce paramètre est utilisé pour évaluer les performances des requêtes de la base de connaissances. Par exemple, si un utilisateur de Sandbox effectue 10 tests de validité consécutifs en une minute, son espace de travail sera temporairement restreint dans l'exécution des actions suivantes pendant la minute suivante : création, suppression, mises à jour de jeux de données, et téléchargements ou modifications de documents.",
	"plansCommon.documentsTooltip": "Quota sur le nombre de documents importés à partir de la source de données de connaissance.",
	"plansCommon.free": "Gratuit",
	"plansCommon.freeTrialTip": "essai gratuit de 200 appels OpenAI.",
	...
	"plansCommon.month": "mois",
	"plansCommon.mostPopular": "Le Plus Populaire",
	"plansCommon.planRange.monthly": "Mensuel",
	"plansCommon.planRange.yearly": "Annuel",
	"plansCommon.priceTip": "par espace de travail/",
	"plansCommon.priority.priority": "Priorité",
	"plansCommon.priority.standard": "Standard",
	"plansCommon.priority.top-priority": "Priorité Maximale",
	"plansCommon.ragAPIRequestTooltip": "Fait référence au nombre d'appels API invoquant uniquement les capacités de traitement de la base de connaissances de Dify.",
	"plansCommon.receiptInfo": "Seuls le propriétaire de l'équipe et l'administrateur de l'équipe peuvent s'abonner et consulter les informations de facturation",
	"plansCommon.save": "Enregistrer",
	"plansCommon.self": "Auto-hébergé",
	"plansCommon.startBuilding": "Commencez à construire",
	"plansCommon.startForFree": "Commencez gratuitement",
	"plansCommon.startNodes.limited": "Jusqu'à {{count}} déclencheurs/workflow",
	"plansCommon.startNodes.unlimited": "Déclencheurs/workflows illimités",
	"plansCommon.support": "Assistance",
	"plansCommon.supportItems.SSOAuthentication": "Authentification SSO",
	"plansCommon.supportItems.agentMode": "Mode Agent",
	"plansCommon.supportItems.bulkUpload": "Téléchargement en masse de documents",
	"plansCommon.supportItems.communityForums": "Forums communautaires",
	"plansCommon.supportItems.customIntegration": "Intégration personnalisée et support",
	"plansCommon.supportItems.dedicatedAPISupport": "Support dédié pour l'API",
	"plansCommon.supportItems.emailSupport": "Support par email",
	"plansCommon.supportItems.llmLoadingBalancing": "Équilibrage de charge LLM",
	"plansCommon.supportItems.llmLoadingBalancingTooltip": "Ajoutez plusieurs clés API aux modèles, en contournant efficacement les limites de débit de l’API.",
	"plansCommon.supportItems.logoChange": "Changement de logo",
	"plansCommon.supportItems.personalizedSupport": "Soutien personnalisé",
	"plansCommon.supportItems.priorityEmail": "Support prioritaire par email et chat",
	"plansCommon.supportItems.ragAPIRequest": "Requêtes API RAG",
	...
	"plansCommon.title.description": "Sélectionnez le plan qui correspond le mieux aux besoins de votre équipe.",
	"plansCommon.title.plans": "plans",
	"plansCommon.triggerEvents.professional": "{{count,number}} Déclenchements par mois",
	"plansCommon.triggerEvents.sandbox": "{{count,number}} Déclencher des événements",
	"plansCommon.triggerEvents.tooltip": "Le nombre d'événements qui déclenchent automatiquement des flux de travail via des déclencheurs Plugin, Planification ou Webhook.",
	"plansCommon.triggerEvents.unlimited": "Événements Déclencheurs Illimités",
	...
	"triggerLimitModal.dismiss": "Fermer",
	"triggerLimitModal.title": "Mettez à niveau pour débloquer plus d'événements déclencheurs",
	"triggerLimitModal.upgrade": "Mettre à niveau",
	...
	"usagePage.annotationQuota": "Quota d'annotation",
	"usagePage.buildApps": "Construire des applications",
	...
	"usagePage.vectorSpaceTooltip": "Les documents avec le mode d'indexation de haute qualité utiliseront des ressources de stockage de données de connaissance. Lorsque le stockage de données de connaissance atteindra la limite, de nouveaux documents ne pourront pas être téléchargés.",
	"vectorSpace.fullSolution": "Mettez à niveau votre plan pour obtenir plus d'espace.",
	"vectorSpace.fullTip": "L'espace vectoriel est plein.",
	viewBilling,
	viewBillingAction,
