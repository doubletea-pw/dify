//#region i18n/en-US/dataset-pipeline.json
var configurationTip = "Configure {{pluginName}}";
var editPipelineInfo = "Edit pipeline info";
var editPipelineInfoNameRequired = "Please enter a name for the Knowledge Base.";
var inputField = "Input Field";
var knowledgeDescription = "Knowledge description";
var knowledgeDescriptionPlaceholder = "Describe what is in this Knowledge Base. A detailed description allows AI to access the content of the dataset more accurately. If empty, Dify will use the default hit strategy. (Optional)";
var knowledgeNameAndIcon = "Knowledge name & icon";
var knowledgeNameAndIconPlaceholder = "Please enter the name of the Knowledge Base";
var knowledgePermissions = "Permissions";
var pipelineNameAndIcon = "Pipeline name & icon";
