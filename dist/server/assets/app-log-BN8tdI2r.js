//#region i18n/zh-Hant/app-log.json
var agentLog = "Agent 日誌";
var dateFormat = "月/日/年";
var dateTimeFormat = "YYYY-MM-DD HH:mm:ss";
var description = "日誌記錄了應用的執行情況，包括使用者的輸入和 AI 的回覆。";
var promptLog = "Prompt 日誌";
var title = "日誌";
var viewLog = "檢視日誌";
var workflowSubtitle = "日誌記錄了應用的執行情況";
var workflowTitle = "日誌";
var app_log_default = {
	agentLog,
	...
	"table.empty.element.content": "在這裡觀測和標註終端使用者和 AI 應用程式之間的互動，以不斷提高 AI 的準確性。您可以嘗試<shareLink>分享</shareLink>或<testLink>測試</testLink>此Web應用程序，然後返回此頁面。",
