//#region i18n/nl-NL/dataset.json
var allExternalTip = "When using external knowledge only, the user can choose whether to enable the Rerank model. If not enabled, retrieved chunks will be sorted based on scores. When the retrieval strategies of different knowledge bases are inconsistent, it will be inaccurate.";
var allKnowledge = "All Knowledge";
var allKnowledgeDescription = "Select to display all knowledge in this workspace. Only the Workspace Owner can manage all knowledge.";
var appCount = " linked apps";
var connectDataset = "Connect to an External Knowledge Base";
var createDataset = "Create Knowledge";
var createDatasetIntro = "Import your own text data or write data in real-time via Webhook for LLM context enhancement.";
var createExternalAPI = "Add an External Knowledge API";
var createFromPipeline = "Create from Knowledge Pipeline";
var createNewExternalAPI = "Create a new External Knowledge API";
var datasetDeleteFailed = "Failed to delete Knowledge";
var datasetDeleted = "Knowledge deleted";
var datasetUsedByApp = "The knowledge is being used by some apps. Apps will no longer be able to use this Knowledge, and all prompt configurations and logs will be permanently deleted.";
var datasets = "KNOWLEDGE";
var datasetsApi = "API ACCESS";
var defaultRetrievalTip = "Multi-path retrieval is used by default. Knowledge is retrieved from multiple knowledge bases and then re-ranked.";
var deleteDatasetConfirmContent = "Deleting the Knowledge is irreversible. Users will no longer be able to access your Knowledge, and all prompt configurations and logs will be permanently deleted.";
var deleteDatasetConfirmTitle = "Delete this Knowledge?";
var didYouKnow = "Did you know?";
var docAllEnabled_one = "{{count}} document enabled";
var docAllEnabled_other = "All {{count}} documents enabled";
var docsFailedNotice = "documents indexed failed";
var documentCount = " docs";
var documentsDisabled = "{{num}} documents disabled - inactive for over 30 days";
var editExternalAPIFormTitle = "Edit the External Knowledge API";
var editExternalAPITooltipTitle = "LINKED KNOWLEDGE";
var embeddingModelNotAvailable = "Embedding model is unavailable.";
var enable = "Enable";
var externalAPI = "External API";
var externalAPIPanelDescription = "The external knowledge API is used to connect to a knowledge base outside of Dify and retrieve knowledge from that knowledge base.";
var externalAPIPanelDocumentation = "Learn how to create an External Knowledge API";
var externalAPIPanelTitle = "External Knowledge API";
var externalKnowledgeBase = "External Knowledge Base";
var externalKnowledgeDescription = "Knowledge Description";
var externalKnowledgeDescriptionPlaceholder = "Describe what's in this Knowledge Base (optional)";
var externalKnowledgeId = "External Knowledge ID";
var externalKnowledgeIdPlaceholder = "Please enter the Knowledge ID";
var externalKnowledgeName = "External Knowledge Name";
var externalKnowledgeNamePlaceholder = "Please enter the name of the knowledge base";
var externalTag = "External";
var inconsistentEmbeddingModelTip = "The Rerank model is required if the Embedding models of the selected knowledge bases are inconsistent.";
var intro1 = "The Knowledge can be integrated into the Dify application ";
var intro2 = "as a context";
var intro3 = ",";
var intro4 = "or it ";
var intro5 = "can be published";
var intro6 = " as an independent service.";
var knowledge = "Knowledge";
var learnHowToWriteGoodKnowledgeDescription = "Learn how to write a good knowledge description";
var localDocs = "Local Docs";
var mixtureHighQualityAndEconomicTip = "The Rerank model is required for mixture of high quality and economical knowledge bases.";
var mixtureInternalAndExternalTip = "The Rerank model is required for mixture of internal and  external knowledge.";
var multimodal = "Multimodal";
var nTo1RetrievalLegacy = "N-to-1 retrieval will be officially deprecated from September. It is recommended to use the latest Multi-path retrieval to obtain better results. ";
var nTo1RetrievalLegacyLink = "Learn more";
var nTo1RetrievalLegacyLinkText = " N-to-1 retrieval will be officially deprecated in September.";
var noExternalKnowledge = "There is no External Knowledge API yet, click here to create";
var partialEnabled_one = "Total of {{count}} document, {{num}} available";
var partialEnabled_other = "Total of {{count}} documents, {{num}} available";
var preprocessDocument = "{{num}} Preprocess Documents";
var rerankSettings = "Rerank Setting";
var retrievalSettings = "Retrieval Setting";
var retry = "Retry";
var unavailable = "Unavailable";
var unknownError = "Onbekende fout";
var updated = "Updated";
var wordCount = " k words";
var dataset_default = {
	allExternalTip,
	allKnowledge,
	...
	"externalKnowledgeForm.connectedFailed": "Verbinden met externe kennisbank mislukt",
	"externalKnowledgeForm.connectedSuccess": "Externe kennisbank succesvol verbonden",
	externalKnowledgeId,
