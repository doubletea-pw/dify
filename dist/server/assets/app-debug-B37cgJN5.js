//#region i18n/uk-UA/app-debug.json
var autoAddVar = "На невизначені змінні, на які посилаються в попередньому запиті, є посилання. Ви хочете додати їх у форму вводу користувача?";
var chatSubTitle = "Інструкції";
var completionSubTitle = "Префікс команди";
var debugAsMultipleModel = "Налагодження як багато моделей";
var debugAsSingleModel = "Налагодження як одна модель";
var duplicateModel = "Дублювання";
var formattingChangedText = "Змінення форматування призведе до скидання області налагодження. Ви впевнені?";
var formattingChangedTitle = "Змінено форматування";
var noResult = "Тут буде відображено вихідні дані.";
var notSetVar = "Змінні дозволяють користувачам вводити підказки або вступні зауваження під час заповнення форм. Ви можете спробувати ввести \"{{input}}\" у слова підказки.";
var orchestrate = "Диригувати";
var promptTip = "Запити керують відповідями ШІ, надаючи інструкції та обмеження. Вставте змінні, як-от {{input}}. Цей запит не буде видно користувачам.";
var publishAs = "Опублікувати як";
var result = "Вихідний текст";
var variableTip = "Користувачі заповнюють змінні у формі, автоматично замінюючи змінні в команді.";
var variableTitle = "Змінні";
