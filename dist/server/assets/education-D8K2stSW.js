//#region i18n/en-US/education.json
var currentSigned = "CURRENTLY SIGNED IN AS";
var emailLabel = "Your current email";
var learn = "Learn how to get education verified";
var rejectContent = "Unfortunately, you are not eligible for Education Verified status and therefore cannot receive the exclusive 100% coupon for the Dify Professional Plan if you use this email address.";
var rejectTitle = "Your Dify Educational Verification Has Been Rejected";
var submit = "Submit";
var submitError = "Form submission failed. Please try again later.";
var successContent = "We have issued a 100% discount coupon for the Dify Professional plan to your account. The coupon is valid for one year, please use it within the validity period.";
var successTitle = "You Have Got Dify Education Verified";
var toVerified = "Get Education Verified";
