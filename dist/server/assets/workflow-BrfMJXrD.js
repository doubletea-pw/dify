//#region i18n/fa-IR/workflow.json
var customWebhook = "وب‌هوک سفارشی";
var difyTeam = "تیم Dify";
var workflow_default = {
	...
	"blocks.parameter-extractor": "استخراج‌کننده پارامتر",
	"blocks.question-classifier": "دسته‌بندی‌کننده سؤال",
	"blocks.start": "شروع",
	"blocks.template-transform": "مبدل الگو",
	"blocks.tool": "ابزار",
	"blocks.trigger-plugin": "راه‌انداز پلاگین",
	"blocks.trigger-schedule": "راه‌انداز زمان‌بندی",
	"blocks.trigger-webhook": "راه‌انداز وب‌هوک",
	"blocks.variable-aggregator": "تجمیع‌کننده متغیر",
	"blocks.variable-assigner": "تخصیص‌دهنده متغیر",
	"blocksAbout.agent": "فراخوانی مدل‌های زبانی بزرگ برای پاسخ به سؤالات یا پردازش زبان طبیعی",
	"blocksAbout.answer": "تعریف محتوای پاسخ در مکالمه چت",
	"blocksAbout.assigner": "گره تخصیص متغیر برای مقداردهی به متغیرهای قابل‌نوشتن (مانند متغیرهای مکالمه) استفاده می‌شود.",
	"blocksAbout.code": "اجرای کد Python یا NodeJS برای پیاده‌سازی منطق سفارشی",
	"blocksAbout.datasource": "درباره منبع داده",
	"blocksAbout.datasource-empty": "جایگزین منبع داده خالی",
	"blocksAbout.document-extractor": "تجزیه اسناد آپلودشده به متنی قابل‌فهم برای LLM",
	...
	"blocksAbout.iteration": "اجرای چندین مرحله روی آیتم‌های یک لیست تا تمام نتایج خروجی داده شوند",
	...
	"blocksAbout.list-operator": "فیلتر یا مرتب‌سازی محتوای آرایه",
	...
	"blocksAbout.loop-end": "معادل «break». این گره بدون تنظیمات است. هنگامی که بدنه حلقه به این گره برسد، حلقه متوقف می‌شود.",
	"blocksAbout.loop-start": "گره شروع حلقه",
	"blocksAbout.parameter-extractor": "استخراج پارامترهای ساختاریافته از زبان طبیعی توسط مدل زبانی بزرگ برای فراخوانی ابزارها یا درخواست‌های HTTP",
	"blocksAbout.question-classifier": "تعریف شرایط دسته‌بندی سؤالات کاربر؛ مدل زبانی بزرگ بر اساس توضیحات دسته‌بندی، مسیر مکالمه را تعیین می‌کند",
	"blocksAbout.start": "تعریف پارامترهای اولیه برای آغاز گردش کار",
	"blocksAbout.template-transform": "تبدیل داده‌ها به رشته با نحو الگوی Jinja",
	"blocksAbout.tool": "استفاده از ابزارهای خارجی برای گسترش قابلیت‌های گردش کار",
	"blocksAbout.trigger-plugin": "یکپارچه‌سازی با سرویس‌های ثالث برای آغاز گردش کار از رویدادهای پلتفرم خارجی",
	"blocksAbout.trigger-schedule": "راه‌انداز مبتنی بر زمان برای اجرای گردش کار طبق برنامه زمان‌بندی",
	"blocksAbout.trigger-webhook": "دریافت درخواست‌های HTTP از سیستم‌های خارجی برای راه‌اندازی خودکار گردش کار",
	"blocksAbout.variable-aggregator": "تجمیع متغیرهای چند شاخه در یک متغیر واحد برای پیکربندی یکپارچه گره‌های پایین‌دستی",
	"blocksAbout.variable-assigner": "تجمیع متغیرهای چند شاخه در یک متغیر واحد برای پیکربندی یکپارچه گره‌های پایین‌دستی",
	...
	"changeHistory.hintText": "عملیات ویرایش شما در تاریخچه تغییرات ردگیری می‌شود و تا پایان این جلسه روی دستگاه شما ذخیره می‌ماند. با خروج از ویرایشگر این تاریخچه پاک خواهد شد.",
	...
	"changeHistory.nodeDragStop": "گره جابه‌جا شد",
	"changeHistory.nodePaste": "گره جای‌گذاری شد",
	...
	"chatVariable.modal.value": "مقدار پیش‌فرض",
	"chatVariable.modal.valuePlaceholder": "مقدار پیش‌فرض؛ برای عدم تنظیم خالی بگذارید",
	...
	"common.ImageUploadLegacyTip": "اکنون می‌توانید متغیرهای نوع فایل را در فرم شروع ایجاد کنید. پشتیبانی از ویژگی قدیمی آپلود تصویر به‌زودی متوقف خواهد شد.",
	...
	"common.backupCurrentDraft": "پشتیبان‌گیری از پیش‌نویس فعلی",
	"common.batchRunApp": "اجرای دسته‌ای برنامه",
	"common.branch": "شاخه",
	...
	"common.copy": "کپی",
	"common.currentDraft": "پیش‌نویس فعلی",
	"common.currentDraftUnpublished": "پیش‌نویس فعلی منتشر نشده",
	"common.currentView": "نمای فعلی",
	"common.currentWorkflow": "گردش کار فعلی",
	"common.debugAndPreview": "اشکال‌زدایی و پیش‌نمایش",
	"common.disconnect": "قطع اتصال",
	"common.duplicate": "تکثیر",
	"common.editing": "در حال ویرایش",
	"common.effectVarConfirm.content": "این متغیر در گره‌های دیگر استفاده شده است. آیا مطمئنید می‌خواهید آن را حذف کنید؟",
	"common.effectVarConfirm.title": "حذف متغیر",
	"common.embedIntoSite": "جای‌گذاری در سایت",
	"common.enableJinja": "فعال‌سازی پشتیبانی از الگوی Jinja",
	"common.exitVersions": "خروج از تاریخچه نسخه‌ها",
	...
	"common.humanInputEmailTip": "ایمیل (روش ارسال) به گیرندگان پیکربندی‌شده ارسال شد",
	"common.humanInputEmailTipInDebugMode": "ایمیل (روش ارسال) به <email>{{email}}</email> ارسال شد",
	"common.humanInputWebappTip": "فقط پیش‌نمایش اشکال‌زدایی؛ کاربر نهایی این را در برنامه وب نخواهد دید.",
	"common.importDSL": "وارد کردن DSL",
	"common.importDSLTip": "پیش‌نویس فعلی بازنویسی خواهد شد. پیشنهاد می‌شود قبل از وارد کردن، از گردش کار خروجی بگیرید.",
	"common.importFailure": "خطا در وارد کردن",
	"common.importSuccess": "وارد کردن موفقیت‌آمیز",
	"common.importWarning": "هشدار",
	"common.importWarningDetails": "تفاوت نسخه DSL ممکن است بر برخی ویژگی‌ها تأثیر بگذارد",
	"common.inPreview": "در حالت پیش‌نمایش",
	"common.inPreviewMode": "در حالت پیش‌نمایش",
	...
	"common.needConnectTip": "این مرحله به هیچ گره‌ای متصل نیست",
	...
	"common.parallelTip.limit": "موازی‌سازی به {{num}} شاخه محدود می‌شود.",
	"common.pasteHere": "جای‌گذاری در اینجا",
	"common.pointerMode": "حالت اشاره‌گر",
	"common.preview": "پیش‌نمایش",
	"common.previewPlaceholder": "محتوا را در کادر زیر وارد کنید تا اشکال‌زدایی چت‌بات آغاز شود",
	"common.processData": "پردازش داده‌ها",
	"common.publish": "انتشار",
	"common.publishUpdate": "انتشار به‌روزرسانی",
	...
	"common.syncingData": "همگام‌سازی داده‌ها، چند ثانیه صبر کنید",
	"common.tagBound": "تعداد برنامه‌هایی که از این برچسب استفاده می‌کنند",
	...
	"debug.relations.dependencies": "وابستگی‌ها",
	"debug.relations.dependenciesDescription": "گره‌هایی که این گره به آن‌ها وابسته است",
	"debug.relations.dependents": "وابستگان",
	"debug.relations.dependentsDescription": "گره‌هایی که به این گره وابسته هستند",
	...
	"debug.variableInspect.clearAll": "پاک‌سازی همه",
	"debug.variableInspect.clearNode": "پاک کردن متغیرهای کش‌شده",
	"debug.variableInspect.edited": "ویرایش شده",
	"debug.variableInspect.emptyLink": "بیشتر بدانید",
	"debug.variableInspect.emptyTip": "پس از اجرای گره روی بوم، می‌توانید مقدار فعلی متغیرها را در بازرسی متغیر مشاهده کنید.",
	...
	"debug.variableInspect.largeDataNoExport": "داده حجیم - فقط پیش‌نمایش جزئی",
	"debug.variableInspect.listening.defaultNodeName": "این تریگر",
	"debug.variableInspect.listening.defaultPluginName": "این افزونه فعال می‌شود",
	"debug.variableInspect.listening.defaultScheduleTime": "پیکربندی نشده",
	"debug.variableInspect.listening.selectedTriggers": "تریگرهای انتخاب‌شده",
	"debug.variableInspect.listening.stopButton": "توقف",
	"debug.variableInspect.listening.tip": "اکنون می‌توانید با ارسال درخواست‌های آزمایشی به {{nodeName}} رویدادها را شبیه‌سازی کنید. تمام خروجی‌ها در بازرسی متغیر قابل مشاهده خواهند بود.",
	"debug.variableInspect.listening.tipFallback": "در انتظار رویدادهای ورودی... خروجی‌ها اینجا نمایش داده خواهند شد.",
	...
	"env.envDescription": "متغیرهای محیطی برای ذخیره اطلاعات حساس و اعتبارنامه‌ها استفاده می‌شوند. آن‌ها فقط‌خواندنی هستند و هنگام خروجی DSL قابل جداسازی هستند.",
	...
	"env.modal.secretTip": "برای اطلاعات حساس استفاده می‌شود؛ تنظیمات DSL از نشت آن‌ها جلوگیری می‌کند.",
	...
	"error.operations.updatingWorkflow": "به‌روزرسانی گردش کار",
	...
	"errorMsg.fields.rerankModel": "مدل بازرتبه‌بندی",
	...
	"errorMsg.rerankModelRequired": "قبل از فعال‌سازی Rerank Model، لطفاً مطمئن شوید که مدل در تنظیمات با موفقیت پیکربندی شده است.",
	...
	"globalVar.description": "متغیرهای سیستمی، متغیرهای سراسری هستند که هر گره در صورت تطابق نوع می‌تواند بدون سیم‌کشی از آن‌ها استفاده کند (مانند شناسه کاربر و شناسه گردش کار).",
	...
	"nodes.agent.linkToPlugin": "لینک به افزونه‌ها",
	...
	"nodes.agent.modelNotInMarketplace.manageInPlugins": "مدیریت در افزونه‌ها",
	...
	"nodes.agent.modelNotSupport.desc": "نسخه فعلی افزونه از این مدل پشتیبانی نمی‌کند.",
	"nodes.agent.modelNotSupport.descForVersionSwitch": "نسخه فعلی افزونه از این مدل پشتیبانی نمی‌کند. برای تغییر نسخه کلیک کنید.",
	"nodes.agent.modelNotSupport.title": "مدل پشتیبانی نمی‌شود",
	"nodes.agent.modelSelectorTooltips.deprecated": "این مدل منسوخ شده است",
	"nodes.agent.notAuthorized": "مجاز نیست",
	"nodes.agent.outputVars.files.title": "فایل‌های تولیدشده توسط عامل",
	"nodes.agent.outputVars.files.transfer_method": "روش انتقال (remote_url یا local_file)",
	"nodes.agent.outputVars.files.type": "نوع پشتیبانی‌شده (فعلاً فقط تصویر)",
	...
	"nodes.agent.pluginNotFoundDesc": "این افزونه از GitHub نصب شده. برای نصب مجدد به بخش افزونه‌ها بروید.",
	"nodes.agent.pluginNotInstalled": "این افزونه نصب نشده است",
	"nodes.agent.pluginNotInstalledDesc": "این افزونه از GitHub نصب شده. برای نصب مجدد به بخش افزونه‌ها بروید.",
	"nodes.agent.strategy.configureTip": "لطفاً استراتژی عامل را پیکربندی کنید.",
	"nodes.agent.strategy.configureTipDesc": "پس از انتخاب استراتژی عامل، تنظیمات مربوطه به‌طور خودکار بارگذاری می‌شوند. این استراتژی بر مکانیسم استدلال چندمرحله‌ای ابزار تأثیر می‌گذارد.",
	"nodes.agent.strategy.label": "استراتژی عامل",
	"nodes.agent.strategy.searchPlaceholder": "جستجو در استراتژی‌های عامل",
	"nodes.agent.strategy.selectTip": "استراتژی عامل را انتخاب کنید",
	"nodes.agent.strategy.shortLabel": "استراتژی",
	"nodes.agent.strategy.tooltip": "استراتژی‌های مختلف تعیین می‌کنند سیستم چگونه فراخوانی‌های چندمرحله‌ای ابزار را برنامه‌ریزی و اجرا کند.",
	"nodes.agent.strategyNotFoundDesc": "نسخه فعلی افزونه این استراتژی را ارائه نمی‌دهد.",
	"nodes.agent.strategyNotFoundDescAndSwitchVersion": "نسخه فعلی افزونه این استراتژی را ارائه نمی‌دهد. برای تغییر نسخه کلیک کنید.",
	...
	"nodes.agent.unsupportedStrategy": "استراتژی پشتیبانی نمی‌شود",
	"nodes.answer.answer": "پاسخ",
	"nodes.answer.outputVars": "متغیرهای خروجی",
	"nodes.assigner.append": "الحاق",
	"nodes.assigner.assignedVariable": "متغیر تخصیص‌یافته",
	"nodes.assigner.assignedVarsDescription": "متغیرهای تخصیص‌یافته باید قابل‌نوشتن باشند (مانند متغیرهای مکالمه).",
	"nodes.assigner.clear": "پاک کردن",
	"nodes.assigner.noAssignedVars": "هیچ متغیر تخصیص‌یافته‌ای موجود نیست",
	...
	"nodes.assigner.operations.clear": "پاک‌سازی",
	...
	"nodes.assigner.selectAssignedVariable": "انتخاب متغیر تخصیص‌یافته...",
	...
	"nodes.assigner.writeModeTip": "وقتی متغیر تخصیص‌یافته آرایه باشد، حالت الحاق مقدار را به انتهای آرایه اضافه می‌کند.",
	"nodes.code.advancedDependencies": "وابستگی‌های پیشرفته",
	"nodes.code.advancedDependenciesTip": "وابستگی‌هایی که زمان بارگذاری بالایی دارند یا به‌طور پیش‌فرض موجود نیستند را اینجا اضافه کنید",
	"nodes.code.inputVars": "متغیرهای ورودی",
	"nodes.code.outputVars": "متغیرهای خروجی",
	"nodes.code.searchDependencies": "جستجوی وابستگی‌ها",
	"nodes.code.syncFunctionSignature": "همگام‌سازی امضای تابع با کد",
	"nodes.common.errorHandle.defaultValue.desc": "در صورت بروز خطا، یک مقدار خروجی ثابت مشخص کنید.",
	"nodes.common.errorHandle.defaultValue.inLog": "استثنا در گره؛ خروجی بر اساس مقدار پیش‌فرض.",
	"nodes.common.errorHandle.defaultValue.output": "مقدار پیش‌فرض خروجی",
	"nodes.common.errorHandle.defaultValue.tip": "در صورت خطا، مقدار زیر برگردانده می‌شود.",
	"nodes.common.errorHandle.defaultValue.title": "مقدار پیش‌فرض",
	"nodes.common.errorHandle.failBranch.customize": "برای سفارشی‌سازی منطق شاخه شکست به بوم بروید.",
	"nodes.common.errorHandle.failBranch.customizeTip": "با فعال‌سازی شاخه شکست، استثناهای گره‌ها فرآیند را متوقف نمی‌کنند. در عوض، شاخه شکست اجرا می‌شود تا بتوانید پیام خطا، لاگ یا اقدامات جایگزین ارائه دهید.",
	"nodes.common.errorHandle.failBranch.desc": "در صورت بروز خطا، شاخه استثنا اجرا می‌شود",
	...
	"nodes.common.memories.title": "حافظه‌ها",
	...
	"nodes.docExtractor.supportFileTypes": "انواع فایل پشتیبانی‌شده: {{types}}.",
	"nodes.end.output.type": "نوع خروجی",
	"nodes.end.output.variable": "متغیر خروجی",
	"nodes.end.outputs": "خروجی‌ها",
	...
	"nodes.http.bulkEdit": "ویرایش دسته‌ای",
	"nodes.http.curl.placeholder": "رشته cURL را اینجا جای‌گذاری کنید",
	...
	"nodes.http.outputVars.files": "لیست فایل‌ها",
	...
	"nodes.http.verifySSL.warningTooltip": "غیرفعال کردن تأیید SSL در محیط عملیاتی توصیه نمی‌شود. این تنها باید در حالت توسعه یا آزمایش استفاده شود.",
	...
	"nodes.humanInput.deliveryMethod.emailSender.testSendTip": "ارسال ایمیل آزمایشی به گیرندگان پیکربندی‌شده",
	"nodes.humanInput.deliveryMethod.emailSender.testSendTipInDebugMode": "ارسال ایمیل آزمایشی به {{email}}",
	"nodes.humanInput.deliveryMethod.emailSender.tip": "توصیه می‌شود <strong>حالت اشکال‌زدایی را فعال کنید</strong> تا ارسال ایمیل را آزمایش کنید.",
	...
	"nodes.humanInput.deliveryMethod.emailSender.wholeTeamDone1": "ایمیل به اعضای <team>{{team}}</team> و نشانی‌های زیر ارسال شد:",
	"nodes.humanInput.deliveryMethod.emailSender.wholeTeamDone2": "ایمیل به اعضای <team>{{team}}</team> ارسال شد.",
	"nodes.humanInput.deliveryMethod.emailSender.wholeTeamDone3": "ایمیل به نشانی‌های زیر ارسال شد:",
	"nodes.humanInput.deliveryMethod.emailSender.wholeTeamTip1": "ایمیل به اعضای <team>{{team}}</team> و نشانی‌های زیر ارسال خواهد شد:",
	"nodes.humanInput.deliveryMethod.emailSender.wholeTeamTip2": "ایمیل به اعضای <team>{{team}}</team> ارسال خواهد شد.",
	"nodes.humanInput.deliveryMethod.emailSender.wholeTeamTip3": "ایمیل به نشانی‌های زیر ارسال خواهد شد:",
	...
	"nodes.humanInput.deliveryMethod.upgradeTip": "فعال‌سازی ارسال ایمیل برای ورودی انسانی",
	"nodes.humanInput.deliveryMethod.upgradeTipContent": "ارسال درخواست تأیید ایمیلی پیش از اقدام عامل‌ها — مناسب برای گردش‌کارهای بازبینی و تأیید.",
	"nodes.humanInput.deliveryMethod.upgradeTipHide": "رد کردن",
	"nodes.humanInput.editor.previewTip": "در حالت پیش‌نمایش، دکمه‌های عملیاتی غیرفعال هستند.",
	"nodes.humanInput.errorMsg.duplicateActionId": "شناسه عملیات تکراری است",
	"nodes.humanInput.errorMsg.emptyActionId": "شناسه عملیات نمی‌تواند خالی باشد",
	"nodes.humanInput.errorMsg.emptyActionTitle": "عنوان عملیات نمی‌تواند خالی باشد",
	...
	"nodes.humanInput.formContent.hotkeyTip": "<Key/> را برای درج متغیر و <CtrlKey/><Key/> را برای درج فیلد ورودی فشار دهید",
	...
	"nodes.humanInput.formContent.tooltip": "محتوایی که کاربر پس از باز کردن فرم مشاهده خواهد کرد. از قالب‌بندی Markdown پشتیبانی می‌شود.",
	...
	"nodes.humanInput.userActions.tooltip": "دکمه‌هایی تعریف کنید که کاربر برای پاسخ به فرم روی آن‌ها کلیک کند. هر دکمه می‌تواند مسیر متفاوتی در گردش کار ایجاد کند. شناسه عملیات باید با حرف یا زیرخط شروع شود.",
	"nodes.humanInput.userActions.triggered": "عملیات <strong>{{actionName}}</strong> فعال شد",
	...
	"nodes.ifElse.elseDescription": "منطقی که در صورت عدم برقراری شرط IF اجرا می‌شود.",
	...
	"nodes.iteration.ErrorMethod.operationTerminated": "خاتمه‌یافته",
	"nodes.iteration.ErrorMethod.removeAbnormalOutput": "حذف خروجی غیرعادی",
	"nodes.iteration.MaxParallelismDesc": "حداکثر موازی‌سازی برای کنترل تعداد وظایف همزمان در یک تکرار واحد.",
	"nodes.iteration.MaxParallelismTitle": "حداکثر موازی‌سازی",
	"nodes.iteration.answerNodeWarningDesc": "هشدار حالت موازی: گره‌های پاسخ، تخصیص متغیر مکالمه و عملیات خواندن/نوشتن مداوم در تکرارها ممکن است باعث استثنا شوند.",
	"nodes.iteration.comma": "،",
	"nodes.iteration.currentIteration": "تکرار فعلی",
	"nodes.iteration.deleteDesc": "حذف گره تکرار باعث حذف تمام گره‌های فرزند می‌شود",
	...
	"nodes.iteration.flattenOutput": "مسطح‌سازی خروجی",
	"nodes.iteration.flattenOutputDesc": "در صورت فعال بودن، اگر تمام خروجی‌های تکرار آرایه باشند، به یک آرایه واحد مسطح می‌شوند. در غیر این صورت ساختار تودرتو حفظ می‌شود.",
	...
	"nodes.iteration.parallelModeEnableDesc": "در حالت موازی، وظایف درون تکرارها همزمان اجرا می‌شوند. می‌توانید این را در پنل ویژگی‌ها پیکربندی کنید.",
	"nodes.iteration.parallelModeEnableTitle": "حالت موازی فعال است",
	"nodes.iteration.parallelModeUpper": "حالت موازی",
	"nodes.iteration.parallelPanelDesc": "در حالت موازی، وظایف در تکرار از اجرای همزمان پشتیبانی می‌کنند.",
	...
	"nodes.knowledgeBase.chunkStructureTip.message": "پایگاه دانش Dify از سه ساختار چانک پشتیبانی می‌کند: عمومی، والد-فرزند و پرسش‌وپاسخ. هر پایگاه دانش فقط می‌تواند یک ساختار داشته باشد. خروجی گره قبلی باید با ساختار انتخاب‌شده هماهنگ باشد.",
	"nodes.knowledgeBase.chunkStructureTip.title": "لطفاً یک ساختار چانک انتخاب کنید",
	"nodes.knowledgeBase.chunksInput": "چانک‌ها",
	"nodes.knowledgeBase.chunksInputTip": "متغیر ورودی گره پایگاه دانش چانک‌ها است. نوع متغیر یک شیء با طرح JSON خاص است که باید با ساختار چانک انتخاب‌شده سازگار باشد.",
	"nodes.knowledgeBase.chunksVariableIsRequired": "متغیر چانک‌ها الزامی است",
	...
	"nodes.knowledgeBase.indexMethodIsRequired": "روش ایندکس‌گذاری الزامی است",
	"nodes.knowledgeBase.rerankingModelIsInvalid": "مدل بازرتبه‌بندی نامعتبر است",
	"nodes.knowledgeBase.rerankingModelIsRequired": "مدل بازرتبه‌بندی الزامی است",
	"nodes.knowledgeBase.retrievalSettingIsRequired": "تنظیمات بازیابی الزامی است",
	"nodes.knowledgeRetrieval.knowledge": "دانش",
	"nodes.knowledgeRetrieval.metadata.options.automatic.desc": "تولید خودکار شرایط فیلتر متادیتا بر اساس متغیر پرس‌وجو",
	...
	"nodes.knowledgeRetrieval.metadata.options.disabled.subTitle": "غیرفعال‌سازی فیلترهای متادیتا",
	...
	"nodes.knowledgeRetrieval.metadata.tip": "فیلتر متادیتا فرایند استفاده از ویژگی‌های متادیتا (مانند برچسب‌ها، دسته‌بندی‌ها یا سطح دسترسی) برای محدود کردن و دقیق‌تر کردن نتایج بازیابی است.",
	"nodes.knowledgeRetrieval.metadata.title": "فیلتر متادیتا",
	"nodes.knowledgeRetrieval.outputVars.content": "محتوای بخش‌بندی‌شده",
	"nodes.knowledgeRetrieval.outputVars.files": "فایل‌های بازیابی‌شده",
	"nodes.knowledgeRetrieval.outputVars.icon": "آیکون بخش",
	"nodes.knowledgeRetrieval.outputVars.metadata": "سایر متادیتا",
	"nodes.knowledgeRetrieval.outputVars.output": "داده‌های بازیابی‌شده",
	"nodes.knowledgeRetrieval.outputVars.title": "عنوان بخش",
	"nodes.knowledgeRetrieval.outputVars.url": "URL بخش",
	"nodes.knowledgeRetrieval.queryAttachment": "پیوست‌های پرس‌وجو",
	"nodes.knowledgeRetrieval.queryText": "متن پرس‌وجو",
	"nodes.knowledgeRetrieval.queryVariable": "متغیر پرس‌وجو",
	...
	"nodes.listFilter.orderBy": "مرتب‌سازی بر اساس",
	...
	"nodes.llm.contextTooltip": "می‌توانید دانش را به عنوان زمینه وارد کنید",
	"nodes.llm.files": "فایل‌ها",
	...
	"nodes.llm.jsonSchema.generationTip": "می‌توانید با زبان طبیعی یک JSON Schema تولید کنید.",
	...
	"nodes.llm.jsonSchema.resultTip": "این نتیجه تولیدشده است. اگر راضی نیستید، می‌توانید بازگردید و درخواست را ویرایش کنید.",
	"nodes.llm.jsonSchema.showAdvancedOptions": "نمایش گزینه‌های پیشرفته",
	...
	"nodes.llm.model": "مدل",
	"nodes.llm.notSetContextInPromptTip": "برای فعال‌سازی ویژگی زمینه، لطفاً متغیر Context را در پرامپت قرار دهید.",
	...
	"nodes.llm.reasoningFormat.tagged": "تگ‌های تفکر داخل متن",
	"nodes.llm.reasoningFormat.title": "فعال‌سازی جداسازی تگ‌های استدلال",
	"nodes.llm.reasoningFormat.tooltip": "استخراج محتوا از تگ‌های تفکر و ذخیره در فیلد reasoning_content.",
	"nodes.llm.resolution.high": "بالا",
	"nodes.llm.resolution.low": "پایین",
	"nodes.llm.resolution.name": "وضوح تصویر",
	"nodes.llm.roleDescription.assistant": "پاسخ‌های مدل بر اساس پیام‌های کاربر",
	...
	"nodes.loop.ErrorMethod.operationTerminated": "خاتمه‌یافته",
	...
	"nodes.loop.deleteDesc": "حذف گره حلقه باعث حذف تمام گره‌های فرزند می‌شود",
	...
	"nodes.note.editor.bulletList": "لیست نشانه‌دار",
	...
	"nodes.note.editor.strikethrough": "خط‌خورده",
	...
	"nodes.parameterExtractor.addExtractParameterContent.requiredContent": "الزامی بودن فقط به عنوان راهنما برای استنتاج مدل استفاده می‌شود و برای اعتبارسنجی اجباری خروجی نیست.",
	...
	"nodes.parameterExtractor.extractParametersNotSet": "پارامترهای استخراجی تنظیم نشده‌اند",
	...
	"nodes.parameterExtractor.instructionTip": "دستورالعمل اضافی برای کمک به مدل در استخراج دقیق‌تر پارامترها.",
	...
	"nodes.questionClassifiers.instructionTip": "دستورالعمل اضافی برای کمک به مدل در دسته‌بندی دقیق‌تر سؤالات.",
	...
	"nodes.templateTransform.codeSupportTip": "فقط از Jinja2 پشتیبانی می‌شود",
	"nodes.templateTransform.inputVars": "متغیرهای ورودی",
	"nodes.templateTransform.outputVars.output": "محتوای تبدیل‌شده",
	...
	"nodes.tool.outputVars.files.title": "فایل‌های تولیدشده توسط ابزار",
	"nodes.tool.outputVars.files.transfer_method": "روش انتقال (remote_url یا local_file)",
	"nodes.tool.outputVars.files.type": "نوع پشتیبانی‌شده (فعلاً فقط تصویر)",
	...
	"nodes.triggerPlugin.availableSubscriptions": "اشتراک‌های موجود",
	...
	"nodes.triggerPlugin.oauthClientDescription": "تنظیم اطلاعات OAuth Client برای فعال‌سازی احراز هویت",
	...
	"nodes.triggerPlugin.parametersDescription": "تنظیم پارامترها و ویژگی‌های تریگر",
	"nodes.triggerPlugin.properties": "ویژگی‌ها",
	"nodes.triggerPlugin.propertiesDescription": "ویژگی‌های پیکربندی اضافی برای این تریگر",
	...
	"nodes.triggerSchedule.executionTimeCalculationError": "خطا در محاسبه زمان‌های اجرا",
	...
	"nodes.triggerSchedule.lastDayTooltip": "همه ماه‌ها ۳۱ روز ندارند. از «آخرین روز» برای انتخاب روز پایانی هر ماه استفاده کنید.",
	...
	"nodes.triggerSchedule.nodeTitle": "راه‌انداز زمان‌بندی",
	...
	"nodes.triggerSchedule.title": "زمان‌بندی",
	...
	"nodes.triggerWebhook.configPlaceholder": "پیکربندی وب‌هوک اینجا انجام می‌شود",
	...
	"nodes.triggerWebhook.debugUrlPrivateAddressWarning": "این URL یک آدرس داخلی است و ممکن است درخواست‌های وب‌هوک ناموفق شوند. می‌توانید TRIGGER_URL را به یک آدرس عمومی تغییر دهید.",
	...
	"nodes.triggerWebhook.noQueryParameters": "پارامترهای Query تنظیم نشده‌اند",
	"nodes.triggerWebhook.nodeTitle": "🔗 وب‌هوک",
	...
	"nodes.triggerWebhook.title": "راه‌انداز وب‌هوک",
	"nodes.triggerWebhook.urlCopied": "URL کپی شد",
	"nodes.triggerWebhook.urlGenerated": "URL وب‌هوک با موفقیت تولید شد",
	"nodes.triggerWebhook.urlGenerationFailed": "تولید URL وب‌هوک ناموفق بود",
	"nodes.triggerWebhook.validation.invalidParameterType": "نوع نامعتبر «{{type}}» برای پارامتر «{{name}}»",
	"nodes.triggerWebhook.validation.webhookUrlRequired": "URL وب‌هوک الزامی است",
	...
	"nodes.triggerWebhook.webhookUrl": "URL وب‌هوک",
	"nodes.triggerWebhook.webhookUrlPlaceholder": "برای تولید URL وب‌هوک روی «تولید» کلیک کنید",
	"nodes.variableAssigner.addGroup": "افزودن گروه",
	"nodes.variableAssigner.aggregationGroup": "گروه تجمیع",
	"nodes.variableAssigner.aggregationGroupTip": "فعال‌سازی این ویژگی اجازه می‌دهد تجمیع‌کننده متغیرها چندین مجموعه متغیر را تجمیع کند.",
	...
	"onboarding.description": "گره‌های شروع مختلف، قابلیت‌های متفاوتی دارند. نگران نباشید، همیشه می‌توانید بعداً آن‌ها را تغییر دهید.",
	...
	"onboarding.triggerDescription": "تریگرها می‌توانند به عنوان گره شروع گردش کار عمل کنند، مانند کارهای زمان‌بندی‌شده، وب‌هوک‌های سفارشی یا یکپارچه‌سازی با برنامه‌های دیگر.",
	...
	"operator.zoomIn": "بزرگ‌نمایی",
	"operator.zoomOut": "کوچک‌نمایی",
	"operator.zoomTo100": "بزرگ‌نمایی به ۱۰۰٪",
	"operator.zoomTo50": "بزرگ‌نمایی به ۵۰٪",
	"operator.zoomToFit": "تناسب با صفحه",
	"panel.about": "درباره",
	"panel.addNextStep": "افزودن مرحله بعدی به این فرآیند",
	"panel.change": "تغییر",
	"panel.changeBlock": "تغییر گره",
	"panel.checklist": "چک‌لیست",
	"panel.checklistResolved": "تمام مشکلات برطرف شده‌اند",
	"panel.checklistTip": "قبل از انتشار، مطمئن شوید که تمام مشکلات برطرف شده‌اند",
	"panel.createdBy": "ساخته شده توسط",
	"panel.goTo": "برو به",
	"panel.helpLink": "راهنما",
	"panel.maximize": "تمام‌صفحه",
	"panel.minimize": "خروج از تمام‌صفحه",
	...
	"panel.organizeBlocks": "مرتب‌سازی گره‌ها",
	"panel.runThisStep": "اجرای این مرحله",
	"panel.scrollToSelectedNode": "رفتن به گره انتخاب‌شده",
	"panel.selectNextStep": "انتخاب مرحله بعدی",
	"panel.startNode": "گره شروع",
	"panel.userInputField": "فیلد ورودی کاربر",
	"publishLimit.startNodeDesc": "شما به محدودیت ۲ تریگر در هر گردش کار برای این پلن رسیده‌اید. برای انتشار این گردش کار ارتقا دهید.",
	"publishLimit.startNodeTitlePrefix": "ارتقا به",
	"publishLimit.startNodeTitleSuffix": "برای فعال‌سازی تعداد نامحدود تریگر در هر گردش کار",
	"sidebar.exportWarning": "خروجی نسخه ذخیره‌شده فعلی",
	"sidebar.exportWarningDesc": "این عملیات نسخه فعلی ذخیره‌شده را صادر می‌کند. اگر تغییرات ذخیره‌نشده‌ای دارید، ابتدا از گزینه خروجی در بوم استفاده کنید.",
	...
	"tabs.noPluginsFound": "هیچ افزونه‌ای یافت نشد",
	...
	"tabs.sources": "منابع",
	"tabs.start": "شروع",
	"tabs.startDisabledTip": "گره تریگر و گره ورودی کاربر نمی‌توانند همزمان فعال باشند.",
	"tabs.tools": "ابزارها",
	...
	"variableReference.assignedVarsDescription": "متغیرهای تخصیص‌یافته باید قابل‌نوشتن باشند، مانند",
	"variableReference.conversationVars": "متغیرهای مکالمه",
	"variableReference.noAssignedVars": "هیچ متغیر تخصیص‌یافته‌ای موجود نیست",
	"variableReference.noAvailableVars": "هیچ متغیری موجود نیست",
	"variableReference.noVarsForOperation": "هیچ متغیری برای تخصیص با عملیات انتخاب‌شده موجود نیست.",
	...
	"versionHistory.defaultName": "نسخه بی‌نام",
	"versionHistory.deletionTip": "حذف غیرقابل بازگشت است، لطفاً تأیید کنید.",
	"versionHistory.editField.releaseNotes": "یادداشت‌های انتشار",
	"versionHistory.editField.releaseNotesLengthLimit": "یادداشت‌های انتشار نمی‌توانند از {{limit}} کاراکتر بیشتر شوند",
	"versionHistory.editField.title": "عنوان",
	"versionHistory.editField.titleLengthLimit": "عنوان نمی‌تواند از {{limit}} کاراکتر بیشتر شود",
	...
	"versionHistory.filter.onlyShowNamedVersions": "فقط نسخه‌های نام‌گذاری‌شده",
	"versionHistory.filter.onlyYours": "فقط نسخه‌های شما",
	"versionHistory.filter.reset": "بازنشانی فیلتر",
	"versionHistory.latest": "آخرین",
	"versionHistory.nameThisVersion": "نام‌گذاری این نسخه",
	"versionHistory.releaseNotesPlaceholder": "شرح دهید چه چیزی تغییر کرده است",
	"versionHistory.restorationTip": "پس از بازیابی نسخه، پیش‌نویس فعلی بازنویسی خواهد شد.",
	"versionHistory.title": "تاریخچه نسخه‌ها"
};
//#endregion
