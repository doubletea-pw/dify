//#region i18n/ru-RU/app-debug.json
var autoAddVar = "В предварительной промпте упоминаются неопределенные переменные, хотите ли вы добавить их в форму пользовательского ввода?";
var chatSubTitle = "Инструкции";
var completionSubTitle = "Префикс Промпта";
var debugAsMultipleModel = "Отладка как нескольких моделей";
var debugAsSingleModel = "Отладка как одной модели";
var duplicateModel = "Дублировать";
var formattingChangedText = "Изменение форматирования приведет к сбросу области отладки, вы уверены?";
var formattingChangedTitle = "Форматирование изменено";
var noResult = "Вывод будет отображаться здесь.";
var notSetVar = "Переменные позволяют пользователям вводить промпты или вступительные замечания при заполнении форм. Вы можете попробовать ввести \"{{input}}\" в промптах.";
var orchestrate = "Оркестрация";
var promptTip = "Промпт направляют ответы ИИ с помощью инструкций и ограничений. Вставьте переменные, такие как {{input}}. Этот Промпт не будет видна пользователям.";
var publishAs = "Опубликовать как";
var result = "Выходной текст";
var variableTip = "Пользователи заполняют переменные в форме, автоматически заменяя переменные в промпте.";
var variableTitle = "Переменные";
