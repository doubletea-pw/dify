//#region i18n/tr-TR/dataset-pipeline.json
var configurationTip = "{{pluginName}}'yi yapılandır";
var editPipelineInfo = "İşlem hattı bilgilerini düzenleme";
var editPipelineInfoNameRequired = "Lütfen Bilgi Bankası için bir ad girin.";
var inputField = "Giriş Alanı";
var knowledgeDescription = "Bilgi açıklaması";
var knowledgeDescriptionPlaceholder = "Bu Bilgi Bankasında neler olduğunu açıklayın. Ayrıntılı bir açıklama, yapay zekanın veri kümesinin içeriğine daha doğru bir şekilde erişmesini sağlar. Boşsa, Dify varsayılan isabet stratejisini kullanacaktır. (İsteğe bağlı)";
var knowledgeNameAndIcon = "Bilgi adı ve simgesi";
var knowledgeNameAndIconPlaceholder = "Lütfen Bilgi Bankasının adını giriniz";
var knowledgePermissions = "İzinler";
var pipelineNameAndIcon = "İşlem hattı adı & simgesi";
