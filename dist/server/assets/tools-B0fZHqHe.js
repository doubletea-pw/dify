//#region i18n/ja-JP/tools.json
var allTools = "すべての道具";
var author = "著者：";
var builtInPromptTitle = "プロンプト";
var copyToolName = "名前をコピー";
var createCustomTool = "カスタムツールを作成する";
var customToolTip = "Dify カスタムツールの詳細";
var howToGet = "取得方法";
var includeToolNum = "{{num}} {{action}} が含まれています";
var noTools = "ツールが見つかりませんでした";
var notAuthorized = "ツールが認可されていません";
var openInStudio = "スタジオで開く";
var title = "ツール";
var toolNameUsageTip = "ツール呼び出し名、エージェントの推論とプロンプトの単語に使用されます";
var toolRemoved = "ツールが削除されました";
var tools_default = {
	...
	"createTool.nameForToolCallPlaceHolder": "機械認識に使用される名前，例えば、getCurrentWeather、list_pets",
	...
	"mcp.create.cardTitle": "MCP サーバー（HTTP）を追加",
	...
	"mcp.modal.headerValuePlaceholder": "例：ベアラートークン123",
	"mcp.modal.headers": "ヘッダー",
	"mcp.modal.headersTip": "MCPサーバーへのリクエストに送信する追加のHTTPヘッダー",
	"mcp.modal.invalidServerIdentifier": "有効なサーバー識別子を入力してください",
	"mcp.modal.invalidServerUrl": "有効なサーバーURLを入力してください",
	...
	"mcp.modal.serverIdentifierPlaceholder": "ユニーク識別子（例：my-mcp-server）",
	...
	"mcp.modal.title": "MCP サーバー（HTTP）を追加",
	...
	"mcp.server.modal.descriptionPlaceholder": "このツールの機能と LLM（大規模言語モデル）での使用方法を説明してください。",
