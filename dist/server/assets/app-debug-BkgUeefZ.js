//#region i18n/ko-KR/app-debug.json
var autoAddVar = "프리프롬프트에서 참조되는 미정의 변수가 있습니다. 사용자 입력 양식에 추가하시겠습니까?";
var chatSubTitle = "단계";
var completionSubTitle = "접두사 프롬프트";
var debugAsMultipleModel = "다중 모델로 디버그";
var debugAsSingleModel = "단일 모델로 디버그";
var duplicateModel = "복제";
var formattingChangedText = "포맷을 변경하면 디버그 영역이 재설정됩니다. 계속하시겠습니까?";
var formattingChangedTitle = "포맷이 변경되었습니다";
var noResult = "출력이 여기에 표시됩니다.";
var notSetVar = "변수를 사용하면 사용자는 양식에 입력할 때 프롬프트의 단어나 시작 단어를 소개할 수 있습니다. \"{{input}}\"을 프롬프트 단어에 입력해 보세요.";
var orchestrate = "오케스트레이션";
var promptTip = "프롬프트는 AI 의 응답을 지시하고 제한하여 유도합니다. {{input}}과 같은 변수를 삽입하세요. 이 프롬프트는 사용자에게 표시되지 않습니다.";
var publishAs = "로 게시";
var result = "출력 텍스트";
var variableTip = "사용자는 양식에 변수를 입력하고, 프롬프트 내의 변수가 자동으로 대체됩니다.";
var variableTitle = "변수";
