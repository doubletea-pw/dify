//#region i18n/ru-RU/dataset-pipeline.json
var configurationTip = "Настроить {{pluginName}}";
var editPipelineInfo = "Редактирование сведений о воронке продаж";
var editPipelineInfoNameRequired = "Пожалуйста, введите название базы знаний.";
var inputField = "Поле ввода";
var knowledgeDescription = "Описание знаний";
var knowledgeDescriptionPlaceholder = "Опишите, что входит в эту базу знаний. Подробное описание позволяет ИИ более точно получать доступ к содержимому набора данных. Если значение пусто, Dify будет использовать стратегию попадания по умолчанию. (Дополнительный)";
var knowledgeNameAndIcon = "Имя и значок базы знаний";
var knowledgeNameAndIconPlaceholder = "Пожалуйста, введите название базы знаний";
var knowledgePermissions = "Разрешения";
var pipelineNameAndIcon = "Имя и иконка конвейера";
