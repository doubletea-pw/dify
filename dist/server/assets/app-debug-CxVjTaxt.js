//#region i18n/en-US/app-debug.json
var autoAddVar = "Undefined variables referenced in pre-prompt, are you want to add them in user input form?";
var chatSubTitle = "Instructions";
var completionSubTitle = "Prefix Prompt";
var debugAsMultipleModel = "Debug as Multiple Models";
var debugAsSingleModel = "Debug as Single Model";
var duplicateModel = "Duplicate";
var formattingChangedText = "Modifying the formatting will reset the debug area, are you sure?";
var formattingChangedTitle = "Formatting changed";
var manageModels = "Manage models";
var noModelProviderConfigured = "No model provider configured";
var noModelProviderConfiguredTip = "Install or configure a model provider to get started.";
var noModelSelected = "No model selected";
var noModelSelectedTip = "configure a model above to continue.";
var noResult = "Output will be displayed here.";
var notSetVar = "Variables allow users to introduce prompt words or opening remarks when filling out forms. You can try entering \"{{input}}\" in the prompt words.";
var orchestrate = "Orchestrate";
var promptTip = "Prompts guide AI responses with instructions and constraints. Insert variables like {{input}}. This prompt won't be visible to users.";
var publishAs = "Publish as";
var result = "Output Text";
var variableTip = "Users fill variables in a form, automatically replacing variables in the prompt.";
var variableTitle = "Variables";
var app_debug_default = {
	...
	variableTip,
	variableTitle,
	"vision.description": "Enable Vision will allows the model to take in images and answer questions about them.\xA0",
	"vision.name": "Vision",
