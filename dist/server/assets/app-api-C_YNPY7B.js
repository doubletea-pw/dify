//#region i18n/fa-IR/app-api.json
var apiKey = "کلید API";
var apiServer = "سرور API";
var copied = "کپی شد";
var copy = "کپی";
var disabled = "غیرفعال";
var loading = "در حال بارگذاری";
var never = "هرگز";
var ok = "در سرویس";
var pause = "مکث";
var play = "پخش";
var playing = "در حال پخش";
var regenerate = "بازسازی";
var status = "وضعیت";
var app_api_default = {
	...
	"actionMsg.ok": "تایید",
	apiKey,
	"apiKeyModal.apiSecretKey": "کلید مخفی API",
	"apiKeyModal.apiSecretKeyTips": "برای جلوگیری از سوء استفاده از API، از کلید API خود محافظت کنید. از استفاده از آن به صورت متن ساده در کد فرانت‌اند خودداری کنید. :)",
