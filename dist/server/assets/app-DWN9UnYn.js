//#region i18n/ru-RU/app.json
var accessControl = "Управление доступом к веб-приложению";
var appDeleteFailed = "Не удалось удалить приложение";
var appDeleted = "Приложение удалено";
var appNamePlaceholder = "Придумайте название для вашего приложения";
var communityIntro = "Общайтесь с членами команды, участниками и разработчиками на разных каналах.";
var createApp = "СОЗДАТЬ ПРИЛОЖЕНИЕ";
var createFromConfigFile = "Создать из файла DSL";
var deleteAppConfirmContent = "Удаление приложения необратимо. Пользователи больше не смогут получить доступ к вашему приложению, и все настройки подсказок и журналы будут безвозвратно удалены.";
var deleteAppConfirmInputLabel = "Для подтверждения введите \"{{appName}}\" в поле ниже:";
var deleteAppConfirmInputPlaceholder = "Введите название приложения";
var deleteAppConfirmTitle = "Удалить это приложение?";
var duplicate = "Дублировать";
var duplicateTitle = "Дублировать приложение";
var editApp = "Редактировать информацию";
var editAppTitle = "Редактировать информацию о приложении";
var editDone = "Информация о приложении обновлена";
var editFailed = "Не удалось обновить информацию о приложении";
var exportFailed = "Ошибка экспорта DSL.";
var importDSL = "Импортировать файл DSL";
var importFromDSL = "Импортировать из DSL";
var importFromDSLFile = "Из файла DSL";
var importFromDSLUrl = "Из URL";
var importFromDSLUrlPlaceholder = "Вставьте ссылку DSL сюда";
var join = "Присоединяйтесь к сообществу";
var maxActiveRequests = "Максимальное количество параллельных запросов";
var maxActiveRequestsPlaceholder = "Введите 0 для неограниченного количества";
var maxActiveRequestsTip = "Максимальное количество одновременно активных запросов на одно приложение (0 для неограниченного количества)";
var noAccessPermission = "Нет разрешения на доступ к веб-приложению";
var noUserInputNode = "Отсутствует узел ввода пользователя";
var notPublishedYet = "Приложение ещё не опубликовано";
var openInExplore = "Открыть в разделе «Обзор»";
var removeOriginal = "Удалить исходное приложение";
var roadmap = "Посмотреть наш roadmap";
var showMyCreatedAppsOnly = "Показать только созданные мной приложения";
var switchLabel = "Копия приложения, которая будет создана";
var switchStart = "Переключиться";
var switchTip = "не позволит";
var switchTipEnd = " переключиться обратно на базовую организацию.";
var switchTipStart = "Для вас будет создана новая копия Workflow. Новая копия ";
var app_default = {
	accessControl,
	...
	"gotoAnything.emptyState.tryDifferentTerm": "Попробуйте другой поисковый термин",
