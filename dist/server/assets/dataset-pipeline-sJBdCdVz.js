//#region i18n/es-ES/dataset-pipeline.json
var configurationTip = "Configurar {{pluginName}}";
var editPipelineInfo = "Editar información de canalización";
var editPipelineInfoNameRequired = "Por favor, ingrese un nombre para la Base de Conocimiento.";
var inputField = "Campo de entrada";
var knowledgeDescription = "Descripción del conocimiento";
var knowledgeDescriptionPlaceholder = "Describa lo que hay en esta base de conocimientos. Una descripción detallada permite a la IA acceder al contenido del conjunto de datos con mayor precisión. Si está vacío, Dify usará la estrategia de golpe predeterminada. (Opcional)";
var knowledgeNameAndIcon = "Nombre e icono de conocimiento";
var knowledgeNameAndIconPlaceholder = "Ingrese el nombre de la base de conocimientos";
var knowledgePermissions = "Permisos";
var pipelineNameAndIcon = "Nombre e icono de la tubería";
