//#region i18n/vi-VN/app.json
var accessControl = "Kiểm soát truy cập ứng dụng web";
var appDeleteFailed = "Không thể xóa ứng dụng";
var appDeleted = "Ứng dụng đã bị xóa";
var appNamePlaceholder = "Đặt tên cho ứng dụng của bạn";
var communityIntro = "Thảo luận với các thành viên nhóm, người đóng góp và nhà phát triển trên các kênh khác nhau.";
var createApp = "TẠO ỨNG DỤNG";
var createFromConfigFile = "Tạo từ tệp DSL";
var deleteAppConfirmContent = "Việc xóa ứng dụng là không thể hoàn tác. Người dùng sẽ không thể truy cập vào ứng dụng của bạn nữa và tất cả cấu hình cũng như nhật ký nhắc sẽ bị xóa vĩnh viễn.";
var deleteAppConfirmInputLabel = "Để xác nhận, hãy nhập \"{{appName}}\" vào ô bên dưới:";
var deleteAppConfirmInputPlaceholder = "Nhập tên ứng dụng";
var deleteAppConfirmTitle = "Xóa ứng dụng này?";
var duplicate = "Sao chép";
var duplicateTitle = "Sao chép ứng dụng";
var editApp = "Chỉnh sửa thông tin";
var editAppTitle = "Chỉnh sửa thông tin ứng dụng";
var editDone = "Thông tin ứng dụng đã được cập nhật";
var editFailed = "Không thể cập nhật thông tin ứng dụng";
var exportFailed = "Xuất DSL thất bại.";
var importDSL = "Nhập tệp DSL";
var importFromDSL = "Nhập từ DSL";
var importFromDSLFile = "Từ tệp DSL";
var importFromDSLUrl = "Từ URL";
var importFromDSLUrlPlaceholder = "Dán liên kết DSL vào đây";
var join = "Tham gia cộng đồng";
var maxActiveRequests = "Số yêu cầu đồng thời tối đa";
var maxActiveRequestsPlaceholder = "Nhập 0 để không giới hạn";
var maxActiveRequestsTip = "Số yêu cầu hoạt động đồng thời tối đa cho mỗi ứng dụng (0 để không giới hạn)";
var noAccessPermission = "Không được phép truy cập ứng dụng web";
var noUserInputNode = "Thiếu nút nhập liệu của người dùng";
var notPublishedYet = "Ứng dụng chưa được phát hành";
var openInExplore = "Mở trong Khám phá";
var removeOriginal = "Xóa ứng dụng gốc";
var roadmap = "Xem lộ trình của chúng tôi";
var showMyCreatedAppsOnly = "Chỉ hiển thị ứng dụng do tôi tạo";
var switchLabel = "Bản sao ứng dụng sẽ được tạo";
var switchStart = "Bắt đầu chuyển";
var switchTip = "không thể";
var switchTipEnd = " chuyển lại quản lý cơ bản.";
var switchTipStart = "Một bản sao ứng dụng mới sẽ được tạo và chuyển sang quản lý quy trình. Bản sao mới sẽ ";
var app_default = {
	accessControl,
	...
	"gotoAnything.emptyState.tryDifferentTerm": "Thử từ khóa tìm kiếm khác",
