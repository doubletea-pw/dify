//#region i18n/fr-FR/dataset-pipeline.json
var configurationTip = "Configurer {{pluginName}}";
var editPipelineInfo = "Modifier les informations sur le pipeline";
var editPipelineInfoNameRequired = "Veuillez saisir un nom pour la Base de connaissances.";
var inputField = "Champ de saisie";
var knowledgeDescription = "Description des connaissances";
var knowledgeDescriptionPlaceholder = "Décrivez le contenu de cette base de connaissances. Une description détaillée permet à l’IA d’accéder plus précisément au contenu de l’ensemble de données. S’il est vide, Dify utilisera la stratégie d’accès par défaut. (Facultatif)";
var knowledgeNameAndIcon = "Nom et icône de la connaissance";
var knowledgeNameAndIconPlaceholder = "Entrez le nom de la base de connaissances";
var knowledgePermissions = "Autorisations";
var pipelineNameAndIcon = "Nom et icône du pipeline";
