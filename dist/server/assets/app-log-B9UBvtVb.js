//#region i18n/zh-Hans/app-log.json
var agentLog = "Agent 日志";
var dateFormat = "YYYY-MM-DD";
var dateTimeFormat = "YYYY-MM-DD HH:mm:ss";
var description = "日志记录了应用的运行情况，包括用户的输入和 AI 的回复。";
var promptLog = "Prompt 日志";
var title = "日志";
var viewLog = "查看日志";
var workflowSubtitle = "日志记录了应用的执行情况";
var workflowTitle = "日志";
var app_log_default = {
	agentLog,
	...
	"table.empty.element.content": "在这里观测和标注最终用户和 AI 应用程序之间的交互，以不断提高 AI 的准确性。您可以尝试<shareLink>分享</shareLink>或<testLink>测试</testLink>此Web应用程序，然后返回此页面。",
