//#region i18n/fa-IR/app.json
var accessControl = "کنترل دسترسی به وب اپلیکیشن";
var appDeleteFailed = "حذف برنامه ناموفق بود";
var appDeleted = "برنامه حذف شد";
var appNamePlaceholder = "به برنامه خود یک نام بدهید";
var communityIntro = "در کانال‌های مختلف با اعضای تیم، مشارکت‌کنندگان و توسعه‌دهندگان بحث کنید.";
var createApp = "ایجاد برنامه";
var createFromConfigFile = "ایجاد از فایل DSL";
var deleteAppConfirmContent = "حذف برنامه غیرقابل برگشت است. کاربران دیگر قادر به دسترسی به برنامه شما نخواهند بود و تمام تنظیمات و گزارشات درخواست‌ها به صورت دائم حذف خواهند شد.";
var deleteAppConfirmInputLabel = "برای تأیید، \"{{appName}}\" را در کادر زیر تایپ کنید:";
var deleteAppConfirmInputPlaceholder = "نام برنامه را وارد کنید";
var deleteAppConfirmTitle = "آیا این برنامه حذف شود؟";
var duplicate = "تکرار";
var duplicateTitle = "تکرار برنامه";
var editApp = "ویرایش اطلاعات";
var editAppTitle = "ویرایش اطلاعات برنامه";
var editDone = "اطلاعات برنامه به‌روزرسانی شد";
var editFailed = "به‌روزرسانی اطلاعات برنامه ناموفق بود";
var exportFailed = "صادر کردن DSL ناموفق بود.";
var importDSL = "وارد کردن فایل DSL";
var importFromDSL = "وارد کردن از DSL";
var importFromDSLFile = "از فایل DSL";
var importFromDSLUrl = "از URL";
var importFromDSLUrlPlaceholder = "لینک DSL را اینجا بچسبانید";
var join = "پیوستن به جامعه";
var maxActiveRequests = "بیشترین درخواست‌های همزمان";
var maxActiveRequestsPlaceholder = "برای نامحدود، 0 را وارد کنید";
var maxActiveRequestsTip = "حداکثر تعداد درخواست‌های فعال همزمان در هر برنامه (0 برای نامحدود)";
var noAccessPermission = "دسترسی به برنامه وب مجاز نیست";
var noUserInputNode = "ورودی کاربر پیدا نشد";
var notPublishedYet = "اپ هنوز منتشر نشده است";
var openInExplore = "باز کردن در کاوش";
var removeOriginal = "حذف برنامه اصلی";
var roadmap = "نقشه راه ما را ببینید";
var showMyCreatedAppsOnly = "فقط برنامه‌های ایجاد شده توسط من را نشان بده";
var switchLabel = "نسخه برنامه که ایجاد می‌شود";
var switchStart = "شروع تغییر";
var switchTip = "اجازه نمی‌دهد";
var switchTipEnd = " تغییر به سازماندهی اساسی بازگردد.";
var switchTipStart = "یک نسخه جدید از برنامه برای شما ایجاد خواهد شد و نسخه جدید به سازماندهی گردش کار تغییر خواهد کرد. نسخه جدید ";
var app_default = {
	accessControl,
