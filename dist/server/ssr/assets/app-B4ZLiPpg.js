//#region i18n/nl-NL/app.json
var accessControl = "Web App Access Control";
var appDeleteFailed = "Failed to delete app";
var appDeleted = "App deleted";
var appNamePlaceholder = "Give your app a name";
var communityIntro = "Discuss with team members, contributors and developers on different channels.";
var createApp = "CREATE APP";
var createFromConfigFile = "Create from DSL file";
var deleteAppConfirmContent = "Deleting the app is irreversible. Users will no longer be able to access your app, and all prompt configurations and logs will be permanently deleted.";
var deleteAppConfirmInputLabel = "To confirm, type \"{{appName}}\" in the box below:";
var deleteAppConfirmInputPlaceholder = "Enter app name";
var deleteAppConfirmTitle = "Delete this app?";
var duplicate = "Duplicate";
var duplicateTitle = "Duplicate App";
var editApp = "Edit Info";
var editAppTitle = "Edit App Info";
var editDone = "App info updated";
var editFailed = "Failed to update app info";
var exportFailed = "Export DSL failed.";
var importDSL = "Import DSL file";
var importFromDSL = "Import from DSL";
var importFromDSLFile = "From DSL file";
var importFromDSLUrl = "From URL";
var importFromDSLUrlPlaceholder = "Paste DSL link here";
var join = "Join the community";
var maxActiveRequests = "Max concurrent requests";
var maxActiveRequestsPlaceholder = "Enter 0 for unlimited";
var maxActiveRequestsTip = "Maximum number of concurrent active requests per app (0 for unlimited)";
var noAccessPermission = "No permission to access web app";
var noUserInputNode = "Missing user input node";
var notPublishedYet = "App is not published yet";
var openInExplore = "Open in Explore";
var removeOriginal = "Delete the original app";
var roadmap = "See our roadmap";
var showMyCreatedAppsOnly = "Created by me";
var switchLabel = "The app copy to be created";
var switchStart = "Start switch";
var switchTip = "not allow";
var switchTipEnd = " switching back to Basic Orchestrate.";
var switchTipStart = "A new app copy will be created for you, and the new copy will switch to Workflow Orchestrate. The new copy will ";
var app_default = {
	accessControl,
