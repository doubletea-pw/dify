//#region i18n/uk-UA/dataset-pipeline.json
var configurationTip = "Налаштувати {{pluginName}}";
var editPipelineInfo = "Як редагувати інформацію про воронку продажів";
var editPipelineInfoNameRequired = "Будь ласка, введіть назву Бази знань.";
var inputField = "Поле введення";
var knowledgeDescription = "Опис знань";
var knowledgeDescriptionPlaceholder = "Опишіть, що є в цій Базі знань. Детальний опис дозволяє штучному інтелекту більш точно отримати доступ до вмісту набору даних. Якщо значення порожнє, Dify використовуватиме стратегію удару за замовчуванням. (Необов'язково)";
var knowledgeNameAndIcon = "Знання ім'я та піктограма";
var knowledgeNameAndIconPlaceholder = "Будь ласка, введіть назву Бази знань";
var knowledgePermissions = "Дозволи";
var pipelineNameAndIcon = "Назва та піктограма воронки продажів";
