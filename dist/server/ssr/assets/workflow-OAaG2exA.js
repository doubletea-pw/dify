//#region i18n/ja-JP/workflow.json
var customWebhook = "カスタムWebhook";
var difyTeam = "Dify チーム";
var workflow_default = {
	...
	"common.parallel": "並列",
	"common.parallelTip.click.desc": "で追加",
	"common.parallelTip.click.title": "クリック",
	"common.parallelTip.depthLimit": "並列ネスト最大階層数：{{num}}",
	"common.parallelTip.drag.desc": "で接続",
	"common.parallelTip.drag.title": "ドラッグ",
	"common.parallelTip.limit": "並列処理可能ブランチ数：{{num}}",
	"common.pasteHere": "ここに貼り付け",
	"common.pointerMode": "ポインターモード",
	"common.preview": "プレビュー",
	"common.previewPlaceholder": "入力欄にテキストを入力してチャットボットのデバッグを開始",
	...
	"common.restore": "復元",
	"common.run": "テスト実行",
	"common.runAllTriggers": "すべてのトリガーを実行",
	...
	"debug.lastOutput": "最後の出力",
	"debug.lastRunInputsCopied": "前回の実行から{{count}}個の入力をコピーしました",
	"debug.lastRunTab": "最後の実行",
	"debug.noData.description": "最後の実行の結果がここに表示されます",
	"debug.noData.runThisNode": "このノードを実行してください",
	"debug.noLastRunFound": "以前の実行が見つかりませんでした。",
	"debug.noMatchingInputsFound": "前回の実行から一致する入力が見つかりませんでした。",
	"debug.relations.dependencies": "依存元",
	"debug.relations.dependenciesDescription": "このノードが依存している他のノード",
	"debug.relations.dependents": "依存先",
	"debug.relations.dependentsDescription": "このノードに依存している他のノード",
	"debug.relations.noDependencies": "依存元なし",
	"debug.relations.noDependents": "依存先なし",
	"debug.relationsTab": "関係",
	"debug.settingsTab": "設定",
	"debug.variableInspect.chatNode": "会話",
	"debug.variableInspect.clearAll": "すべてリセット",
	"debug.variableInspect.clearNode": "キャッシュされた変数をクリアする",
	"debug.variableInspect.edited": "編集された",
	"debug.variableInspect.emptyLink": "もっと学ぶ",
	"debug.variableInspect.emptyTip": "キャンバス上でノードをステップ実行するか、ノードを一歩ずつ実行した後、変数インスペクトでノード変数の現在の値を確認できます。",
	"debug.variableInspect.envNode": "環境",
	"debug.variableInspect.export": "輸出",
	"debug.variableInspect.exportToolTip": "変数をファイルとしてエクスポートする",
	"debug.variableInspect.largeData": "大きなデータ、読み取り専用のプレビュー。すべてを表示するにはエクスポートしてください。",
	"debug.variableInspect.largeDataNoExport": "大規模データ - 一部プレビューのみ",
	"debug.variableInspect.listening.defaultNodeName": "このトリガー",
	"debug.variableInspect.listening.defaultPluginName": "このプラグイントリガー",
	"debug.variableInspect.listening.defaultScheduleTime": "未設定",
	"debug.variableInspect.listening.selectedTriggers": "選択したトリガー",
	"debug.variableInspect.listening.stopButton": "停止",
	"debug.variableInspect.listening.tip": "HTTP {{nodeName}} エンドポイントにテストリクエストを送信するか、ライブイベントデバッグ用のコールバック URL として利用してイベントトリガーをシミュレートできます。すべての出力は Variable Inspector で直接確認できます。",
	"debug.variableInspect.listening.tipFallback": "トリガーイベントを待機しています。出力はここに表示されます。",
	...
	"debug.variableInspect.title": "変数検査",
	"debug.variableInspect.trigger.cached": "キャッシュされた変数を表示",
	"debug.variableInspect.trigger.clear": "クリア",
	"debug.variableInspect.trigger.normal": "変数検査",
	"debug.variableInspect.trigger.running": "キャッシング実行状況",
	"debug.variableInspect.trigger.stop": "走るのを止めて",
	"debug.variableInspect.view": "ログを表示",
	difyTeam,
	"entryNodeStatus.disabled": "開始 • 無効",
	"entryNodeStatus.enabled": "スタート",
	"env.envDescription": "環境変数は、個人情報や認証情報を格納するために使用することができます。これらは読み取り専用であり、DSL ファイルからエクスポートする際には分離されます。",
	"env.envPanelButton": "環境変数を追加",
	"env.envPanelTitle": "環境変数",
	...
	"env.modal.name": "変数名",
	"env.modal.namePlaceholder": "変数名を入力",
	"env.modal.secretTip": "この変数は機密情報やデータを定義するために使用されます。DSL をエクスポートするときに漏洩防止メカニズムを設定されます。",
	"env.modal.title": "環境変数を追加",
	"env.modal.type": "タイプ",
	"env.modal.value": "値",
	...
	"errorMsg.fields.rerankModel": "Rerank モデル",
	"errorMsg.fields.variable": "変数名",
	"errorMsg.fields.variableValue": "変数値",
	...
	"errorMsg.toolParameterRequired": "{{field}}: パラメータ [{{param}}] は必須です",
	"globalVar.description": "システム変数は、タイプが適合していれば配線なしで任意のノードから参照できるグローバル変数です。エンドユーザーIDやワークフローIDなどが含まれます。",
	"globalVar.fieldsDescription.appId": "アプリケーションID",
	"globalVar.fieldsDescription.conversationId": "会話ID",
	"globalVar.fieldsDescription.dialogCount": "会話数",
	"globalVar.fieldsDescription.triggerTimestamp": "アプリケーションの起動タイムスタンプ",
	"globalVar.fieldsDescription.userId": "ユーザーID",
	...
	"nodes.agent.configureModel": "モデルを設定する",
	"nodes.agent.installPlugin.cancel": "キャンセル",
	"nodes.agent.installPlugin.changelog": "変更ログ",
	"nodes.agent.installPlugin.desc": "次のプラグインをインストールしようとしています",
	"nodes.agent.installPlugin.install": "インストール",
	"nodes.agent.installPlugin.title": "プラグインをインストールする",
	"nodes.agent.learnMore": "もっと学ぶ",
	"nodes.agent.linkToPlugin": "プラグインへのリンク",
	"nodes.agent.maxIterations": "最大反復回数",
	"nodes.agent.model": "モデル",
	"nodes.agent.modelNotInMarketplace.desc": "このモデルはローカルまたは GitHub リポジトリからインストールされます。インストール後にご利用ください。",
	"nodes.agent.modelNotInMarketplace.manageInPlugins": "プラグインを管理する",
	"nodes.agent.modelNotInMarketplace.title": "モデルがインストールされていません",
	"nodes.agent.modelNotInstallTooltip": "このモデルはインストールされていません",
	"nodes.agent.modelNotSelected": "モデルが選択されていません",
	"nodes.agent.modelNotSupport.desc": "インストールされたプラグインのバージョンは、このモデルを提供していません。",
	"nodes.agent.modelNotSupport.descForVersionSwitch": "インストールされたプラグインのバージョンはこのモデルを提供していません。バージョンを切り替えるにはクリックしてください。",
	"nodes.agent.modelNotSupport.title": "サポートされていないモデル",
	"nodes.agent.modelSelectorTooltips.deprecated": "このモデルは廃止されました",
	"nodes.agent.notAuthorized": "権限がありません",
	"nodes.agent.outputVars.files.title": "エージェント生成ファイル",
	"nodes.agent.outputVars.files.transfer_method": "転送方法。値は remote_url または local_file です。",
	"nodes.agent.outputVars.files.type": "サポートタイプ。現在はサポート画像のみ",
	"nodes.agent.outputVars.files.upload_file_id": "ファイル ID をアップロード",
	"nodes.agent.outputVars.files.url": "画像の URL",
	"nodes.agent.outputVars.json": "エージェント生成の JSON",
	"nodes.agent.outputVars.text": "エージェント生成コンテンツ",
	"nodes.agent.outputVars.usage": "モデル使用量",
	"nodes.agent.parameterSchema": "パラメータスキーマ",
	"nodes.agent.pluginInstaller.install": "インストール",
	"nodes.agent.pluginInstaller.installing": "インストール中",
	"nodes.agent.pluginNotFoundDesc": "このプラグインは GitHub からインストールされています。再インストールするにはプラグインに移動してください。",
	"nodes.agent.pluginNotInstalled": "このプラグインはインストールされていません",
	"nodes.agent.pluginNotInstalledDesc": "このプラグインは GitHub からインストールされています。再インストールするにはプラグインに移動してください。",
	"nodes.agent.strategy.configureTip": "エージェンティック戦略を設定してください。",
	"nodes.agent.strategy.configureTipDesc": "エージェント戦略を設定した後、このノードは残りの設定を自動的に読み込みます。この戦略は、マルチステップツール推論のメカニズムに影響を与えます。",
	"nodes.agent.strategy.label": "エージェンティック戦略",
	"nodes.agent.strategy.searchPlaceholder": "エージェンティック戦略を検索する",
	"nodes.agent.strategy.selectTip": "エージェンシー戦略を選択する",
	"nodes.agent.strategy.shortLabel": "戦略",
	"nodes.agent.strategy.tooltip": "異なるエージェンティック戦略が、システムがマルチステップのツール呼び出しを計画し実行する方法を決定します。",
	"nodes.agent.strategyNotFoundDesc": "インストールされたプラグインのバージョンは、この戦略を提供していません。",
	"nodes.agent.strategyNotFoundDescAndSwitchVersion": "インストールされたプラグインのバージョンはこの戦略を提供していません。バージョンを切り替えるにはクリックしてください。",
	"nodes.agent.strategyNotInstallTooltip": "{{strategy}}はインストールされていません",
	"nodes.agent.strategyNotSet": "エージェンティック戦略は設定されていません",
	...
	"nodes.agent.tools": "ツール",
	"nodes.agent.unsupportedStrategy": "サポートされていない戦略",
	"nodes.answer.answer": "応答",
	"nodes.answer.outputVars": "出力変数",
	"nodes.assigner.append": "追記",
	"nodes.assigner.assignedVariable": "代入された変数",
	"nodes.assigner.assignedVarsDescription": "代入される変数は、会話変数などの書き込み可能な変数である必要があります。",
	"nodes.assigner.clear": "クリア",
	"nodes.assigner.noAssignedVars": "使用可能な代入変数がありません",
	"nodes.assigner.noVarTip": "「+」ボタンをクリックして変数を追加します",
	"nodes.assigner.operations.*=": "*=",
	"nodes.assigner.operations.+=": "+=",
	"nodes.assigner.operations.-=": "-=",
	"nodes.assigner.operations./=": "/=",
	"nodes.assigner.operations.append": "追加",
	"nodes.assigner.operations.clear": "クリア",
	"nodes.assigner.operations.extend": "延ばす",
	"nodes.assigner.operations.over-write": "上書き",
	"nodes.assigner.operations.overwrite": "上書き",
	"nodes.assigner.operations.remove-first": "最初を削除する",
	"nodes.assigner.operations.remove-last": "最後を削除する",
	"nodes.assigner.operations.set": "セット",
	"nodes.assigner.operations.title": "操作",
	"nodes.assigner.over-write": "上書き",
	"nodes.assigner.plus": "プラス",
	"nodes.assigner.selectAssignedVariable": "代入変数を選択...",
	"nodes.assigner.setParameter": "パラメータを設定...",
	"nodes.assigner.setVariable": "変数を設定する",
	"nodes.assigner.varNotSet": "変数が設定されていません",
	"nodes.assigner.variable": "変数",
	"nodes.assigner.variables": "変数",
	"nodes.assigner.writeMode": "書き込みモード",
	"nodes.assigner.writeModeTip": "代入された変数が配列の場合，末尾に追記モードを追加する。",
	"nodes.code.advancedDependencies": "高度な依存関係",
	"nodes.code.advancedDependenciesTip": "消費に時間がかかる、またはデフォルトで組み込まれていない事前ロードされた依存関係を追加します",
	"nodes.code.inputVars": "入力変数",
	"nodes.code.outputVars": "出力変数",
	"nodes.code.searchDependencies": "依存関係を検索",
	"nodes.code.syncFunctionSignature": "コードの関数署名を同期",
	"nodes.common.errorHandle.defaultValue.desc": "例外発生時のデフォルト出力",
	"nodes.common.errorHandle.defaultValue.inLog": "ノード例外 - デフォルト値を出力",
	"nodes.common.errorHandle.defaultValue.output": "デフォルト値出力",
	"nodes.common.errorHandle.defaultValue.tip": "例外発生時に返される値：",
	"nodes.common.errorHandle.defaultValue.title": "デフォルト値",
	"nodes.common.errorHandle.failBranch.customize": "失敗分岐ロジックをカスタマイズ",
	"nodes.common.errorHandle.failBranch.customizeTip": "例外発生時、失敗分岐でエラー処理を柔軟に設定可能（エラーログ表示/修復処理/操作スキップ等）",
	"nodes.common.errorHandle.failBranch.desc": "例外発生時に分岐を実行",
	"nodes.common.errorHandle.failBranch.inLog": "ノード例外 - 失敗分岐を実行。エラー情報を下流に伝播",
	...
	"nodes.common.insertVarTip": "変数を挿入",
	"nodes.common.memories.builtIn": "組み込み",
	"nodes.common.memories.tip": "チャットの記憶管理",
	"nodes.common.memories.title": "メモリ",
	"nodes.common.memory.assistant": "アシスタント接頭辞",
	"nodes.common.memory.conversationRoleName": "会話ロール名",
	"nodes.common.memory.memory": "メモリ",
	"nodes.common.memory.memoryTip": "チャットメモリ設定",
	"nodes.common.memory.user": "ユーザー接頭辞",
	...
	"nodes.common.retry.retry": "再試行",
	"nodes.common.retry.retryFailed": "再試行失敗",
	"nodes.common.retry.retryFailedTimes": "{{times}}回再試行失敗",
	"nodes.common.retry.retryInterval": "再試行間隔",
	"nodes.common.retry.retryOnFailure": "失敗時再試行",
	"nodes.common.retry.retrySuccessful": "再試行成功",
	"nodes.common.retry.retryTimes": "失敗時 {{times}}回再試行",
	"nodes.common.retry.retrying": "再試行中...",
	"nodes.common.retry.times": "回",
	"nodes.common.typeSwitch.input": "入力値",
	"nodes.common.typeSwitch.variable": "変数を使用する",
	"nodes.dataSource.add": "データソースを追加",
	"nodes.dataSource.supportedFileFormats": "サポートされているファイル形式",
	"nodes.dataSource.supportedFileFormatsPlaceholder": "ファイル拡張子、例：doc",
	"nodes.docExtractor.inputVar": "入力変数",
	"nodes.docExtractor.learnMore": "詳細はこちら",
	"nodes.docExtractor.outputVars.text": "抽出されたテキスト",
	"nodes.docExtractor.supportFileTypes": "サポートするファイルタイプ：{{types}}。",
	"nodes.end.output.type": "出力形式",
	"nodes.end.output.variable": "出力変数",
	"nodes.end.outputs": "出力設定",
	"nodes.end.type.none": "なし",
	"nodes.end.type.plain-text": "プレーンテキスト",
	"nodes.end.type.structured": "構造化",
	"nodes.http.api": "API",
	"nodes.http.apiPlaceholder": "URL を入力（変数使用時は\"/\"を入力）",
	...
	"nodes.http.outputVars.headers": "レスポンスヘッダ（JSON）",
	...
	"nodes.knowledgeBase.chunkStructureTip.message": "Difyナレッジベースは、一般的な、親子関係、Q&Aの3つのチャンク構造をサポートしています。各ナレッジベースには一つの構造のみが持てます。前のノードからの出力は、選択されたチャンク構造と一致する必要があります。チャンク構造の選択が利用可能なインデックス方式に影響を与えることに注意してください。",
	...
	"nodes.knowledgeRetrieval.metadata.options.automatic.desc": "Query Variable（検索変数）に基づきフィルタ条件を自動生成",
	...
	"nodes.triggerSchedule.invalidTimeFormat": "無効な時間形式（期待される形式：HH:MM AM/PM）",
	...
	"onboarding.triggerDescription": "トリガーは、スケジュールされたタスク、カスタムwebhook、または他のアプリとの統合など、ワークフローの開始ノードとして機能できます。",
	"onboarding.userInputDescription": "ユーザー入力変数の設定を可能にする開始ノードで、Webアプリ、サービスAPI、MCPサーバー、およびツールとしてのワークフロー機能を持ちます。",
