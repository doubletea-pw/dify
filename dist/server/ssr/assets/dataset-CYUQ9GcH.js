//#region i18n/hi-IN/dataset.json
var allExternalTip = "केवल बाहरी ज्ञान का उपयोग करते समय, उपयोगकर्ता यह चुन सकता है कि Rerank मॉडल को सक्षम करना है या नहीं। यदि सक्षम नहीं है, तो पुनर्प्राप्त किए गए विखंडू स्कोर के आधार पर क्रमबद्ध किए जाएंगे। जब विभिन्न ज्ञान आधारों की पुनर्प्राप्ति रणनीतियाँ असंगत होती हैं, तो यह गलत होगी।";
var allKnowledge = "सर्व ज्ञान";
var allKnowledgeDescription = "इस कार्यस्थान में सभी ज्ञान प्रदर्शित करने के लिए चयन करें. केवल कार्यस्थान स्वामी ही सभी ज्ञान का प्रबंधन कर सकता है.";
var appCount = " जुड़े हुए ऐप्स";
var connectDataset = "किसी बाह्य ज्ञानकोष से कनेक्ट करना";
var createDataset = "ज्ञान बनाएं";
var createDatasetIntro = "अपना खुद का टेक्स्ट डेटा आयात करें या एलएलएम संदर्भ वृद्धि के लिए वेबहुक के माध्यम से वास्तविक समय में डेटा लिखें।";
var createExternalAPI = "कोई बाहरी नॉलेज API जोड़ना";
var createFromPipeline = "ज्ञान पाइपलाइन से बनाएं";
var createNewExternalAPI = "एक नया बाहरी नॉलेज API बनाएँ";
var datasetDeleteFailed = "ज्ञान हटाने में विफल";
var datasetDeleted = "ज्ञान हटा दिया गया";
var datasetUsedByApp = "यह ज्ञान कुछ ऐप्स द्वारा उपयोग किया जा रहा है। ऐप्स अब इस ज्ञान का उपयोग नहीं कर पाएंगे, और सभी प्रॉम्प्ट कॉन्फ़िगरेशन और लॉग स्थायी रूप से हटा दिए जाएंगे।";
var datasets = "ज्ञान";
var datasetsApi = "API पहुँच";
var defaultRetrievalTip = "मल्टी-पाथ रिट्रीवल का उपयोग डिफ़ॉल्ट रूप से किया जाता है। ज्ञान को कई ज्ञान आधारों से पुनर्प्राप्त किया जाता है और फिर फिर से रैंक किया जाता है।";
var deleteDatasetConfirmContent = "ज्ञान को हटाना अपरिवर्तनीय है। उपयोगकर्ता अब आपके ज्ञान को प्राप्त नहीं कर पाएंगे, और सभी प्रॉम्प्ट कॉन्फ़िगरेशन और लॉग स्थायी रूप से मिटा दिए जाएंगे।";
var deleteDatasetConfirmTitle = "क्या आप यह ज्ञान हटाना चाहते हैं?";
var didYouKnow = "क्या आप जानते हैं?";
var docAllEnabled_one = "{{count}} दस्तावेज़ सक्षम किया गया";
var docAllEnabled_other = "सभी {{count}} दस्तावेज़ सक्षम हैं";
var docsFailedNotice = "दस्तावेज़ों को अनुक्रमित करने में विफल";
var documentCount = " दस्तावेज़";
var documentsDisabled = "{{num}} दस्तावेज़ अक्षम - 30 दिनों से अधिक समय से निष्क्रिय";
var editExternalAPIFormTitle = "बाह्य ज्ञान API संपादित करें";
var editExternalAPITooltipTitle = "लिंक किया गया ज्ञान";
var embeddingModelNotAvailable = "एम्बेडिंग मॉडल उपलब्ध नहीं है।";
var enable = "योग्य बनाना";
var externalAPI = "बाहरी एपीआई";
var externalAPIPanelDescription = "बाहरी ज्ञान API का उपयोग Dify के बाहर नॉलेज बेस से कनेक्ट करने और उस नॉलेज बेस से ज्ञान प्राप्त करने के लिए किया जाता है।";
var externalAPIPanelDocumentation = "बाहरी नॉलेज API बनाने का तरीका जानें";
var externalAPIPanelTitle = "बाहरी ज्ञान एपीआई";
var externalKnowledgeBase = "बाहरी ज्ञान आधार";
var externalKnowledgeDescription = "ज्ञान विवरण";
var externalKnowledgeDescriptionPlaceholder = "वर्णन करें कि इस ज्ञानकोष में क्या है (वैकल्पिक)";
var externalKnowledgeId = "बाहरी ज्ञान ID";
var externalKnowledgeIdPlaceholder = "कृपया नॉलेज आईडी दर्ज करें";
var externalKnowledgeName = "बाहरी ज्ञान का नाम";
var externalKnowledgeNamePlaceholder = "कृपया नॉलेज बेस का नाम दर्ज करें";
var externalTag = "बाह्य";
var inconsistentEmbeddingModelTip = "यदि चयनित ज्ञान आधारों के एम्बेडिंग मॉडल असंगत हैं, तो पुनः रैंकिंग मॉडल आवश्यक है।";
var intro1 = "ज्ञान को Dify एप्लिकेशन में ";
var intro2 = "एक संदर्भ के रूप में ";
var intro3 = ",";
var intro4 = "या यह ";
var intro5 = "बनाया जा सकता है";
var intro6 = " एक स्वतंत्र ChatGPT इंडेक्स प्लग-इन के रूप में प्रकाशित करने के लिए";
var knowledge = "ज्ञान";
var learnHowToWriteGoodKnowledgeDescription = "एक अच्छा ज्ञान विवरण लिखना सीखें";
var localDocs = "स्थानीय डॉक्स";
var mixtureHighQualityAndEconomicTip = "उच्च गुणवत्ता और किफायती ज्ञान आधारों के मिश्रण के लिए पुनः रैंकिंग मॉडल आवश्यक है।";
var mixtureInternalAndExternalTip = "आंतरिक और बाहरी ज्ञान के मिश्रण के लिए रीरैंक मॉडल की आवश्यकता होती है।";
var multimodal = "बहु-मोडल";
var nTo1RetrievalLegacy = "N-से-1 पुनर्प्राप्ति सितंबर से आधिकारिक तौर पर बंद कर दी जाएगी। बेहतर परिणाम प्राप्त करने के लिए नवीनतम बहु-मार्ग पुनर्प्राप्ति का उपयोग करने की सिफारिश की जाती है।";
var nTo1RetrievalLegacyLink = "और जानें";
var nTo1RetrievalLegacyLinkText = "N-से-1 पुनर्प्राप्ति सितंबर में आधिकारिक तौर पर बंद कर दी जाएगी।";
var noExternalKnowledge = "अभी तक कोई बाहरी ज्ञान एपीआई नहीं है, बनाने के लिए यहां क्लिक करें";
var partialEnabled_one = "कुल {{count}} दस्तावेज़, {{num}} उपलब्ध";
var partialEnabled_other = "कुल {{count}} दस्तावेज़, {{num}} उपलब्ध";
var preprocessDocument = "{{num}} प्रीप्रोसेस दस्तावेज़";
var rerankSettings = "पुनः रैंकिंग सेटिंग्स";
var retrievalSettings = "पुनर्प्राप्ति सेटिंग्स";
var retry = "पुनः प्रयास करें";
var unavailable = "उपलब्ध नहीं";
var unknownError = "अज्ञात त्रुटि";
var updated = "अपडेट किया गया";
var wordCount = " के शब्द";
var dataset_default = {
	allExternalTip,
	allKnowledge,
	...
	"externalAPIForm.encrypted.end": "टेक्‍नोलॉजी।",
	...
	"externalKnowledgeForm.connect": "जोड़ना",
