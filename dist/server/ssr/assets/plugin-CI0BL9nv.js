//#region i18n/tr-TR/plugin.json
var allCategories = "Tüm Kategoriler";
var deprecated = "Kaldırılmış";
var difyVersionNotCompatible = "Mevcut Dify sürümü bu eklentiyle uyumlu değil, lütfen gerekli minimum sürüme güncelleyin: {{minimalDifyVersion}}";
var endpointsEnabled = "{{num}} uç nokta kümesi etkinleştirildi";
var findMoreInMarketplace = "Pazar Yeri'nde daha fazla bilgi edinin";
var from = "Kaynak";
var fromMarketplace = "Pazar Yeri'nden";
var install = "{{num}} yükleme";
var installAction = "Yükle";
var installFrom = "ŞURADAN YÜKLE";
var installPlugin = "Eklentiyi yükle";
var publishPlugins = "Eklentileri yayınlayın";
var requestAPlugin = "Bir eklenti iste";
var search = "Ara";
var searchCategories = "Arama Kategorileri";
var searchInMarketplace = "Pazar Yeri'nde arama yapın";
var searchPlugins = "Eklentileri ara";
var searchTools = "Arama araçları...";
var plugin_default = {
	"action.checkForUpdates": "Güncellemeleri kontrol et",
	...
	allCategories,
	"auth.addApi": "API Anahtarını Ekle",
	"auth.addOAuth": "OAuth ekle",
	"auth.authRemoved": "Yetki kaldırıldı",
	"auth.authorization": "Yetkilendirme",
	"auth.authorizationName": "Yetkilendirme Adı",
	"auth.authorizations": "Yetkilendirmeler",
	"auth.clientInfo": "Bu araç sağlayıcı için sistem istemci gizlilikleri bulunmadığından, manuel olarak ayar yapılması gerekmektedir. redirect_uri için lütfen şu adresi kullanın",
	"auth.connectedWorkspace": "Bağlı Çalışma Alanı",
	"auth.credentialUnavailable": "Kimlik bilgileri şu anda mevcut değil. Lütfen yönetici ile iletişime geçin.",
	"auth.credentialUnavailableInButton": "Kimlik bilgileri mevcut değil",
	"auth.custom": "Özel",
	...
	"autoUpdate.changeTimezone": "Zaman dilimini değiştirmek için <setTimezone>Ayarlar</setTimezone> sekmesine gidin",
	"autoUpdate.excludeUpdate": "Aşağıdaki {{num}} eklenti otomatik olarak güncellenmeyecek",
	"autoUpdate.nextUpdateTime": "Sonraki otomatik güncelleme: {{time}}",
	"autoUpdate.noPluginPlaceholder.noFound": "Hiçbir eklenti bulunamadı",
	"autoUpdate.noPluginPlaceholder.noInstalled": "Hiçbir eklenti yüklenmemiş",
	"autoUpdate.operation.clearAll": "Hepsini temizle",
	"autoUpdate.operation.select": "Eklentileri seçin",
	"autoUpdate.partialUPdate": "Sadece aşağıdaki {{num}} eklenti otomatik olarak güncellenecek",
	"autoUpdate.pluginDowngradeWarning.description": "Bu eklenti için otomatik güncelleme şu anda etkin. Sürümün düşürülmesi, bir sonraki otomatik güncelleme sırasında değişikliklerinizin üzerine yazılmasına neden olabilir.",
	"autoUpdate.pluginDowngradeWarning.downgrade": "Her durumda düşürme",
	"autoUpdate.pluginDowngradeWarning.exclude": "Otomatik güncellemeden hariç tut",
	...
	"autoUpdate.updateTimeTitle": "Güncelleme zamanı",
	"autoUpdate.upgradeMode.all": "Hepsini güncelle",
	"autoUpdate.upgradeMode.exclude": "Seçilenleri hariç tut",
	...
	"detailPanel.deprecation.fullMessage": "Bu eklenti {{deprecatedReason}} nedeniyle kullanım dışı bırakılmıştır ve artık güncellenmeyecek. Lütfen bunun yerine <CustomLink href='https://example.com/'>{{-alternativePluginId}}</CustomLink>'i kullanın.",
	"detailPanel.deprecation.noReason": "Bu eklenti kullanımdan kaldırıldı ve artık güncellenmeyecek.",
	"detailPanel.deprecation.onlyReason": "Bu eklenti {{deprecatedReason}} nedeniyle kullanımdan kaldırılmıştır ve artık güncellenmeyecektir.",
	...
	"detailPanel.endpointDisableTip": "Uç Noktayı Devre Dışı Bırak",
	"detailPanel.endpointModalDesc": "Yapılandırıldıktan sonra, eklenti tarafından API uç noktaları aracılığıyla sağlanan özellikler kullanılabilir.",
	"detailPanel.endpointModalTitle": "Uç noktayı ayarlama",
	"detailPanel.endpoints": "Bitiş noktası",
	...
	"detailPanel.toolSelector.paramsTip2": "'Otomatik' kapalıyken, varsayılan değer kullanılır.",
	...
	"detailPanel.toolSelector.uninstalledTitle": "Araç yüklü değil",
	"detailPanel.toolSelector.unsupportedContent": "Yüklü eklenti sürümü bu eylemi sağlamaz.",
	"detailPanel.toolSelector.unsupportedContent2": "Sürümü değiştirmek için tıklayın.",
	"detailPanel.toolSelector.unsupportedMCPTool": "Şu anda seçili olan ajan stratejisi eklenti sürümü MCP araçlarını desteklemiyor.",
	"detailPanel.toolSelector.unsupportedTitle": "Desteklenmeyen Eylem",
	...
	"installFromGitHub.installNote": "Lütfen eklentileri yalnızca güvenilir bir kaynaktan yüklediğinizden emin olun.",
	"installFromGitHub.installPlugin": "GitHub'dan eklenti yükleyin",
	"installFromGitHub.installedSuccessfully": "Yükleme başarılı",
	"installFromGitHub.selectPackage": "Paket seç",
	"installFromGitHub.selectPackagePlaceholder": "Lütfen bir paket seçin",
	"installFromGitHub.selectVersion": "Sürümü seçin",
	"installFromGitHub.selectVersionPlaceholder": "Lütfen bir sürüm seçin",
	"installFromGitHub.updatePlugin": "GitHub'dan eklentiyi güncelleyin",
	...
	"installModal.installPlugin": "Eklentiyi Yükle",
	"installModal.installWarning": "Bu eklentinin yüklenmesine izin verilmemektedir.",
	"installModal.installedSuccessfully": "Yükleme başarılı",
	"installModal.installedSuccessfullyDesc": "Eklenti başarıyla yüklendi.",
	"installModal.installing": "Yükleme...",
	...
	"installModal.readyToInstallPackage": "Aşağıdaki eklentiyi yüklemek üzere",
	"installModal.readyToInstallPackages": "Aşağıdaki {{num}} eklentilerini yüklemek üzereyim",
	"installModal.uploadFailed": "Karşıya yükleme başarısız oldu",
	...
	"marketplace.sortOption.recentlyUpdated": "Son Güncelleme",
	"marketplace.verifiedTip": "Dify tarafından doğrulanmıştır.",
