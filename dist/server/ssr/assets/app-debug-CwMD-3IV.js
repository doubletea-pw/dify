//#region i18n/zh-Hant/app-debug.json
var autoAddVar = "提示詞中引用了未定義的變數，是否自動新增到使用者輸入表單中？";
var chatSubTitle = "提示詞";
var completionSubTitle = "字首提示詞";
var debugAsMultipleModel = "多個模型進行除錯";
var debugAsSingleModel = "單一模型進行除錯";
var duplicateModel = "複製模型";
var formattingChangedText = "修改編排將重置除錯區域，確定嗎？";
var formattingChangedTitle = "編排已改變";
var noResult = "輸出將顯示在此處。";
var notSetVar = "變數能使使用者輸入表單引入提示詞或開場白，你可以試試在提示詞中輸入 {{input}}";
var orchestrate = "編排";
var promptTip = "提示詞用於對 AI 的回覆做出一系列指令和約束。可插入表單變數，例如 {{input}}。這段提示詞不會被終端使用者所看到。";
var publishAs = "釋出為";
var result = "結果";
var variableTip = "變數將以表單形式讓使用者在對話前填寫，使用者填寫的表單內容將自動替換提示詞中的變數。";
var variableTitle = "變數";
var app_debug_default = {
	...
	"generate.template.excelFormulaExpert.instruction": "一個聊天機器人，可以説明新手使用者根據使用者指令理解、使用和創建Excel公式",
	...
	result,
	"trailUseGPT4Info.description": "使用 gpt-4，請設定 API Key",
	...
	"vision.visionSettings.resolutionTooltip": "低解析度模式將使模型接收影象的低解析度版本，尺寸為 512 x 512，並使用 65 Tokens 來表示影象。這樣可以使 API 更快地返回響應，並在不需要高細節的用例中消耗更少的輸入。\n高解析度模式將首先允許模型檢視低解析度影象，然後根據輸入影象的大小建立 512 畫素的詳細裁剪影象。每個詳細裁剪影象使用兩倍的預算總共為 129 Tokens。",
