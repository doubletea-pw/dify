...
import { Gr as s7, rr as f1 } from "./react-D5xHzNYo.js";
import { b as useTranslation } from "./floating-ui.utils.dom-B62kDwTz.js";
import { t as cn } from "./classnames-LHQnX9lX.js";
import { ln as require_with_selector } from "./base-BuKAg6Le.js";
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.28.5_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useIsomorphicLayoutEffect.js
var useIsomorphicLayoutEffect = typeof window !== "undefined" ? useLayoutEffect : useEffect;
//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.28.5_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useField.js
...
var Field = (({ children, ...fieldOptions }) => {
	...
	return /* @__PURE__ */ jsx(Fragment$1, { children: useMemo(() => functionalUpdate(children, fieldApi), [children, fieldApi]) });
});
//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.28.5_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useUUID.js
function useUUID() {
	return useState(() => uuid())[0];
}
//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.28.5_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useFormId.js
var _React = React$1;
var useFormId = React$1.version.split(".")[0] === "17" ? useUUID : _React.useId;
//#endregion
//#region node_modules/.pnpm/@tanstack+react-form@1.28.5_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/@tanstack/react-form/dist/esm/useForm.js
function LocalSubscribe({ form, selector = (state) => state, children }) {
	return /* @__PURE__ */ jsx(Fragment$1, { children: functionalUpdate(children, useStore(form.store, selector)) });
}
...
//#endregion
//#region app/components/base/select/pure.tsx
var PureSelect = (props) => {
	const { options, containerProps, triggerProps, popupProps, placeholder, disabled, triggerPopupSameWidth, multiple, value, onChange } = props;
	const { t } = useTranslation();
	const { open, onOpenChange, placement, offset } = containerProps || {};
	const { className: triggerClassName } = triggerProps || {};
	const { wrapperClassName: popupWrapperClassName, className: popupClassName, itemClassName: popupItemClassName, title: popupTitle, titleClassName: popupTitleClassName } = popupProps || {};
	...
	const triggerText = useMemo(() => {
		...
		if (multiple) return value?.length ? t("dynamicSelect.selected", {
			ns: "common",
			count: value.length
		}) : placeholderText;
	...
	return /* @__PURE__ */ jsxs(PortalToFollowElem, {
		...
		children: [/* @__PURE__ */ jsx(PortalToFollowElemTrigger, {
			...
			children: /* @__PURE__ */ jsxs("div", {
				className: cn("system-sm-regular group flex h-8 items-center rounded-lg bg-components-input-bg-normal px-2 text-components-input-text-filled", !disabled && "cursor-pointer hover:bg-state-base-hover-alt", disabled && "cursor-not-allowed opacity-50", mergedOpen && !disabled && "bg-state-base-hover-alt", triggerClassName),
			...
			className: cn("z-[9999]", popupWrapperClassName),
			children: /* @__PURE__ */ jsxs("div", {
				className: cn("max-h-80 overflow-auto rounded-xl border-[0.5px] border-components-panel-border bg-components-panel-bg-blur p-1 shadow-lg", popupClassName),
				children: [popupTitle && /* @__PURE__ */ jsx("div", {
					className: cn("system-xs-medium-uppercase flex h-[22px] items-center px-3 text-text-tertiary", popupTitleClassName),
					children: popupTitle
				}), options.map((option) => /* @__PURE__ */ jsxs("div", {
					...
					onClick: () => {
						...
						if (multiple) {
							...
							const nextValues = currentValues.includes(option.value) ? currentValues.filter((valueItem) => valueItem !== option.value) : [...currentValues, option.value];
							onChange?.(nextValues);
							return;
						}
					...
					}), (multiple ? (value ?? []).includes(option.value) : value === option.value) && /* @__PURE__ */ jsx(s7, { className: "h-4 w-4 shrink-0 text-text-accent" })]
				}, option.value))]
			})
		})]
	});
...
//#endregion
export { concatenatePaths as a, makePathArray as c, useStore as i, createStore as l, useForm as n, functionalUpdate as o, useIsomorphicLayoutEffect as r, getBy as s, PureSelect as t };
