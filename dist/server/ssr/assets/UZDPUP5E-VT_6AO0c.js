...
import { n as PLUGIN_TITLE_CONTAINER_ID, t as PLUGIN_CONTAINER_ID } from "./A767CXXU-Bt0hS8G8.js";
import { n as keyboardModifiers } from "./BNGI36V3-l1cupg2U.js";
import { A as useContext, D as onMount, E as onCleanup, S as getOwner, _ as createMemo, a as ssr, b as createSignal, c as ssrStyleProperty, d as Show, g as createEffect, h as createContext, i as notSup, l as For, m as createComponent, n as escape, o as ssrAttribute, r as memo, s as ssrStyle, t as Portal, v as createRenderEffect, w as mergeProps, y as createRoot } from "./server-mshjPt2o.js";
import { t as createStore } from "./server-ChDNLTyU.js";
import { a as getAllPermutations, i as TANSTACK_DEVTOOLS, o as uppercaseFirstLetter, s as usePiPWindow, t as DevtoolsContext } from "./AP5L3KAF-C3-NGrDb.js";
import { D as ThemeContextProvider, E as u, S as XCircleIcon, T as h, _ as SearchIcon, a as Cogs, b as SocialBubble, d as Keyboard, f as Link, g as PiP, h as PageSearch, i as CloseIcon, l as ExternalLinkIcon, m as PackageIcon, n as CheckCircleIcon, p as List, r as ChevronDownIcon, t as MainPanel$1, u as GeoTag, v as SettingsCog, w as useStyles$1, x as X, y as SettingsIcon } from "./main-panel-DA_gs2A_.js";
/**
* Solid's `onCleanup` that doesn't warn in development if used outside of a component.
*/
var tryOnCleanup = onCleanup;
//#endregion
//#region node_modules/.pnpm/@solid-primitives+event-listener@2.4.5_solid-js@1.9.11/node_modules/@solid-primitives/event-listener/dist/eventListener.js
...
//#endregion
//#region node_modules/.pnpm/@solid-primitives+rootless@1.5.3_solid-js@1.9.11/node_modules/@solid-primitives/rootless/dist/index.js
/**
...
//#endregion
//#region node_modules/.pnpm/@tanstack+devtools-ui@0.5.1_csstype@3.2.3_solid-js@1.9.11/node_modules/@tanstack/devtools-ui/dist/esm/components/checkbox.js
var _tmpl$$5 = /* @__PURE__ */ notSup(`<div><label><input type=checkbox><div>`), _tmpl$2$4 = /* @__PURE__ */ notSup(`<span>`);
function Checkbox(props) {
	...
	return (() => {
		...
		createRenderEffect((_p$) => {
			...
			_v$3 !== _p$.a && notSup(_el$3, _p$.a = _v$3);
			_v$4 !== _p$.o && notSup(_el$4, _p$.o = _v$4);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
notSup(["input"]);
//#endregion
//#region node_modules/.pnpm/@tanstack+devtools-ui@0.5.1_csstype@3.2.3_solid-js@1.9.11/node_modules/@tanstack/devtools-ui/dist/esm/components/input.js
var _tmpl$$4 = /* @__PURE__ */ notSup(`<div><div><input>`), _tmpl$2$3 = /* @__PURE__ */ notSup(`<label>`), _tmpl$3$3 = /* @__PURE__ */ notSup(`<p>`);
function Input(props) {
	...
	return (() => {
		...
		createRenderEffect((_p$) => {
			...
			_v$ !== _p$.e && notSup(_el$, _p$.e = _v$);
			_v$2 !== _p$.t && notSup(_el$2, _p$.t = _v$2);
			_v$3 !== _p$.a && notSup(_el$3, "type", _p$.a = _v$3);
			_v$4 !== _p$.o && notSup(_el$3, _p$.o = _v$4);
			_v$5 !== _p$.i && notSup(_el$3, "placeholder", _p$.i = _v$5);
			return _p$;
		}, {
			e: void 0,
			t: void 0,
...
notSup(["input"]);
//#endregion
//#region node_modules/.pnpm/@tanstack+devtools-ui@0.5.1_csstype@3.2.3_solid-js@1.9.11/node_modules/@tanstack/devtools-ui/dist/esm/components/select.js
var _tmpl$$3 = /* @__PURE__ */ notSup(`<div><div><select>`), _tmpl$2$2 = /* @__PURE__ */ notSup(`<label>`), _tmpl$3$2 = /* @__PURE__ */ notSup(`<p>`), _tmpl$4$2 = /* @__PURE__ */ notSup(`<option>`);
...
notSup(["input"]);
//#endregion
//#region node_modules/.pnpm/@tanstack+devtools-ui@0.5.1_csstype@3.2.3_solid-js@1.9.11/node_modules/@tanstack/devtools-ui/dist/esm/components/button.js
var _tmpl$$2 = /* @__PURE__ */ notSup(`<button>`);
...
//#endregion
//#region node_modules/.pnpm/@tanstack+devtools-ui@0.5.1_csstype@3.2.3_solid-js@1.9.11/node_modules/@tanstack/devtools-ui/dist/esm/components/section.js
var _tmpl$$1 = /* @__PURE__ */ notSup(`<section>`), _tmpl$2$1 = /* @__PURE__ */ notSup(`<h3>`), _tmpl$3$1 = /* @__PURE__ */ notSup(`<p>`), _tmpl$4$1 = /* @__PURE__ */ notSup(`<span>`);
...
//#endregion
//#region node_modules/.pnpm/@tanstack+devtools-client@0.0.6/node_modules/@tanstack/devtools-client/dist/esm/index.js
...
//#endregion
//#region node_modules/.pnpm/@solid-primitives+resize-observer@2.1.5_solid-js@1.9.11/node_modules/@solid-primitives/resize-observer/dist/index.js
...
//#endregion
//#region node_modules/.pnpm/@tanstack+devtools@0.11.0_csstype@3.2.3_solid-js@1.9.11/node_modules/@tanstack/devtools/dist/devtools/UZDPUP5E.js
var useDraw = (props) => {
...
function useDrawContext() {
	...
	if (context === void 0) throw new Error(`useDrawContext must be used within a DrawClientProvider`);
	return context;
}
var useDevtoolsContext = () => {
	const context = useContext(DevtoolsContext);
	if (context === void 0) throw new Error("useDevtoolsShellContext must be used within a ShellContextProvider");
	return context;
};
function useTheme() {
...
var usePlugins = () => {
	...
	createEffect(() => {
		if (activePlugins().length === 0) setForceExpand(true);
		else setForceExpand(false);
	});
	const toggleActivePlugins = (pluginId) => {
		setStore((prev) => {
			const isActive = prev.state.activePlugins.includes(pluginId);
			const currentPlugin = store.plugins?.find((plugin) => plugin.id === pluginId);
			if (currentPlugin?.destroy && isActive) currentPlugin.destroy(pluginId);
...
var _tmpl$ = "<div></div>";
var _tmpl$2 = [
	"<button type=\"button\" aria-label=\"Open TanStack Devtools\"",
	">",
	"</button>"
];
...
var Trigger = (props) => {
	...
	const buttonStyle = createMemo(() => {
		return clsx(styles().mainCloseBtn, styles().mainCloseBtnPosition(settings().position), styles().mainCloseBtnAnimation(props.isOpen(), settings().hideUntilHover));
	});
	createEffect(() => {
						...
						ssr(_tmpl$32, ssrAttribute("class", escape(styles().settingsGroup, true), false), escape(createComponent(Checkbox, {
							...
							get children() {
								return ssr(_tmpl$23, ssrAttribute("class", escape(styles().conditionalSetting, true), false), escape(createComponent(Input, {
									...
									onChange: (e) => setSettings({ urlFlag: e })
								})));
							}
						})))
					];
...
var getBadgeClass = (card, styles) => {
	...
	switch (card.actionType) {
		...
		case "already-installed": return `${base} ${s.pluginMarketplaceCardBadgeAdd}`;
		case "bump-version": return `${base} ${s.pluginMarketplaceCardBadgeRequires}`;
		case "version-mismatch": return `${base} ${s.pluginMarketplaceCardBadgeRequires}`;
...
var _tmpl$13 = [
	...
	"><div",
	"><h3",
	">Marketplace Settings</h3><button",
	">",
	"</button></div><div",
	">",
	"</div></div>"
...
var _tmpl$15 = [
	...
	"><div",
	"><h2",
	">Plugin Marketplace</h2><div style=\"",
	"\"><div",
	">",
	"<input type=\"text\"",
	...
	">",
	"</button></div></div><p",
	">Discover and install devtools for TanStack Query, Router, Form, and Pacer</p>",
	"</div>"
];
...
var PluginMarketplace = () => {
	...
	const updatePluginCards = (pkg) => {
		if (!pkg) return;
		setPluginSections(groupIntoSections(buildPluginCards(pkg, detectFramework(pkg, FRAMEWORKS), new Set(plugins()?.map((p) => p.id || "") || []), pluginSections().flatMap((s) => s.cards))));
	};
...
var PluginsTab = (props) => {
	...
	createEffect(() => {
		(plugins()?.filter((plugin) => activePlugins().includes(plugin.id)))?.forEach((plugin) => {
			const ref = pluginRefs().get(plugin.id);
			if (ref) plugin.render(ref, {
				theme: theme(),
	...
	return createComponent(Show, {
		...
		get children() {
			return ssr(_tmpl$17, ssrAttribute("class", escape(styles().pluginsTabPanel, true), false), ssrAttribute("class", escape(clsx(styles().pluginsTabDraw(expanded()), { [styles().pluginsTabDraw(expanded())]: expanded() }, styles().pluginsTabDrawTransition(animationMs)), true), false), ssrAttribute("class", escape(clsx(styles().pluginsTabSidebar(expanded()), styles().pluginsTabSidebarTransition(animationMs)), true), false), ssrAttribute("class", escape(styles().pluginsList, true), false), escape(createComponent(For, {
				get each() {
					return plugins();
				},
				children: (plugin) => {
					...
					return ssr(_tmpl$28, ssrAttribute("class", escape(clsx(styles().pluginName, { active: isActive() }), true), false), `${escape(PLUGIN_TITLE_CONTAINER_ID, true)}-${escape(plugin.id, true)}`);
				}
			})), ssrAttribute("class", escape(clsx(styles().pluginNameAddMore, { active: showMarketplace() }), true), false), escape(createComponent(Show, {
				get when() {
	...
	onMount(() => {
		const headObserver = new MutationObserver((mutations) => {
			for (const m of mutations) if (m.type === "childList") {
				m.addedNodes.forEach((node) => onChange({
					kind: "added",
					node
				}, m));
				m.removedNodes.forEach((node) => onChange({
					kind: "removed",
					node
				}, m));
		...
		get children() {
			return createComponent(Section, { get children() {
				return [
					...
					createComponent(SectionDescription, { children: "See how your current page will look when shared on popular social networks. The tool checks for essential meta tags and highlights any that are missing." }),
...
var Tabs = (props) => {
	...
	return ssr(_tmpl$19, ssrAttribute("class", escape(styles().tabContainer, true), false), escape(createComponent(For, {
		each: tabs,
		children: (tab) => ssr(_tmpl$210, ssrAttribute("class", escape(clsx(styles().tab, { active: state().activeTab === tab.id }), true), false), escape(tab.icon()))
	})), pipWindow().pipWindow !== null ? escape(null) : ssr(_tmpl$37, ssrStyleProperty("margin-top:", "auto") + ssrStyleProperty(";width:", "100%"), ssrAttribute("class", escape(clsx(styles().tab, "detach"), true), false), escape(createComponent(PiP, {})), ssrAttribute("class", escape(clsx(styles().tab, "close"), true), false), escape(createComponent(X, {}))));
};
var _tmpl$20 = [
	"<div",
	">",
...
var TabContent = (props) => {
	...
	return ssr(_tmpl$20, ssrAttribute("class", escape(styles().tabContent, true), false), escape(component()?.({ isOpen: props.isOpen })));
};
var _tmpl$21 = [
	"<div style=\"",
	"\">",
...
function DevTools() {
	...
	createEffect(() => {
		onCleanup(devtoolsEventClient.on("trigger-toggled", (event) => {
			if (pip().pipWindow) return;
			const shouldBeOpen = event.payload.isOpen;
	...
	createEffect(() => {
		...
		for (const permutation of permutations) createShortcut(permutation, () => {
							...
							return [createComponent(Trigger, {
								...
								get children() {
									return createComponent(ContentPanel, {
										...
										get children() {
											return [createComponent(Tabs, { toggleOpen }), createComponent(TabContent, { get isOpen() {
												return isOpen();
											} })];
										}
									});
