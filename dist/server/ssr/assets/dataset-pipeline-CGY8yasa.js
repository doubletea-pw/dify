//#region i18n/ar-TN/dataset-pipeline.json
var configurationTip = "تكوين {{pluginName}}";
var editPipelineInfo = "تعديل معلومات سير العمل";
var editPipelineInfoNameRequired = "يرجى إدخال اسم لقاعدة المعرفة.";
var inputField = "حقل الإدخال";
var knowledgeDescription = "وصف المعرفة";
var knowledgeDescriptionPlaceholder = "صف ما يوجد في قاعدة المعرفة هذه. يسمح الوصف التفصيلي للذكاء الاصطناعي بالوصول إلى محتوى مجموعة البيانات بشكل أكثر دقة. إذا كان فارغًا، فسيستخدم Dify استراتيجية المطابقة الافتراضية. (اختياري)";
var knowledgeNameAndIcon = "اسم وأيقونة المعرفة";
var knowledgeNameAndIconPlaceholder = "يرجى إدخال اسم قاعدة المعرفة";
var knowledgePermissions = "أذونات";
var pipelineNameAndIcon = "اسم وأيقونة سير العمل";
