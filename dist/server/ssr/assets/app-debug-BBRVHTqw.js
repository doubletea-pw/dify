//#region i18n/fr-FR/app-debug.json
var autoAddVar = "Des variables indéfinies référencées dans le pre-prompt, voulez-vous les ajouter dans le formulaire d'entrée de l'utilisateur ?";
var chatSubTitle = "Instructions";
var completionSubTitle = "Indicatif de Prompt";
var debugAsMultipleModel = "Déboguer en tant que Modèles Multiples";
var debugAsSingleModel = "Déboguer comme Modèle Unique";
var duplicateModel = "Dupliquer";
var formattingChangedText = "La modification du formatage réinitialisera la zone de débogage, êtes-vous sûr ?";
var formattingChangedTitle = "Formatage modifié";
var noResult = "La sortie sera affichée ici.";
var notSetVar = "Les variables permettent aux utilisateurs d'introduire des mots de prompt ou des remarques d'ouverture lors du remplissage des formulaires. Vous pouvez essayer de saisir \"{{input}}\" dans les mots de prompt.";
var orchestrate = "Orchestrer";
var promptTip = "Les prompts guident les réponses de l'IA avec des instructions et des contraintes. Insérez des variables comme {{input}}. Ce prompt ne sera pas visible pour les utilisateurs.";
var publishAs = "Publier comme";
var result = "Texte de sortie";
var variableTip = "Les utilisateurs remplissent des variables dans un formulaire, remplaçant automatiquement les variables dans le prompt.";
...
var app_debug_default = {
	...
	"codegen.overwriteConfirmMessage": "Cette action remplacera le code existant. Voulez-vous continuer\xA0?",
