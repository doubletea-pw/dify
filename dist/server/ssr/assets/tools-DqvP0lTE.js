//#region i18n/fa-IR/tools.json
var allTools = "همه ابزارها";
var author = "توسط";
var builtInPromptTitle = "پرامپت";
var copyToolName = "کپی نام";
var createCustomTool = "ایجاد ابزار سفارشی";
var customToolTip = "بیشتر در مورد ابزارهای سفارشی Dify بیاموزید";
var howToGet = "چگونه دریافت کنید";
var includeToolNum = "{{num}} {{action}} ابزار شامل شد";
var noTools = "هیچ ابزاری یافت نشد";
var notAuthorized = "ابزار مجوز ندارد";
var openInStudio = "باز کردن در استودیو";
var title = "ابزارها";
var toolNameUsageTip = "نام فراخوانی ابزار برای استدلال و پرامپت‌های عامل";
var toolRemoved = "ابزار حذف شد";
var tools_default = {
	...
	"mcp.modal.invalidServerIdentifier": "لطفاً یک شناسه سرور معتبر وارد کنید",
	"mcp.modal.invalidServerUrl": "لطفاً یک URL سرور معتبر وارد کنید",
	...
	"mcp.server.modal.addTitle": "برای فعال‌سازی سرور MCP توضیحات اضافه کنید",
	"mcp.server.modal.confirm": "فعال‌سازی سرور MCP",
	...
	"mcp.server.modal.parametersPlaceholder": "هدف و محدودیت‌های پارامتر",
	"mcp.server.modal.parametersTip": "برای کمک به LLM در درک هدف و محدودیت‌ها، برای هر پارامتر توضیحات اضافه کنید.",
	...
	"mcp.toolUpdateConfirmContent": "به‌روزرسانی فهرست ابزارها ممکن است بر برنامه‌های موجود تأثیر بگذارد. آیا ادامه می‌دهید؟",
	"mcp.toolUpdateConfirmTitle": "به‌روزرسانی فهرست ابزارها",
	"mcp.toolsCount": "{{count}} ابزار",
	"mcp.toolsEmpty": "ابزارها بارگیری نشدند",
	"mcp.toolsNum": "{{count}} ابزار موجود است",
	"mcp.update": "به‌روزرسانی",
	"mcp.updateTime": "آخرین بروزرسانی",
	"mcp.updateTools": "به‌روزرسانی ابزارها...",
	"mcp.updating": "در حال به‌روزرسانی...",
	"noCustomTool.content": "ابزارهای سفارشی خود را در اینجا اضافه و مدیریت کنید تا برنامه‌های هوش مصنوعی بسازید.",
	...
	"noSearchRes.title": "متأسفیم، نتیجه‌ای پیدا نشد!",
	noTools,
	notAuthorized,
	openInStudio,
	...
	"test.testResultPlaceholder": "نتیجه آزمایش در اینجا نمایش داده می‌شود",
	"test.title": "آزمایش",
	"test.value": "مقدار",
