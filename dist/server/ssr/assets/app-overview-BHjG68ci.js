//#region i18n/zh-Hans/app-overview.json
var app_overview_default = {
	...
	"apiKeyInfo.callTimes": "调用次数",
	"apiKeyInfo.cloud.exhausted.description": "您的试用配额已用完。请设置您自己的模型提供商或购买额外配额。",
	"apiKeyInfo.cloud.exhausted.title": "您的试用额度已用完，请设置您的 APIKey。",
	...
	"overview.apiInfo.accessibleAddress": "API 访问凭据",
	...
	"overview.appInfo.enableTooltip.description": "要启用此功能，请在画布中添加用户输入节点。（草稿中可能已存在，发布后生效）",
	"overview.appInfo.enableTooltip.learnMore": "了解更多",
	"overview.appInfo.explanation": "开箱即用的 AI web app",
	"overview.appInfo.launch": "启动",
	"overview.appInfo.preUseReminder": "使用前请先打开开关",
	"overview.appInfo.preview": "预览",
	"overview.appInfo.qrcode.download": "下载二维码",
	"overview.appInfo.qrcode.scan": "扫码分享应用",
	"overview.appInfo.qrcode.title": "二维码分享",
	"overview.appInfo.regenerate": "重新生成",
	"overview.appInfo.regenerateNotice": "您是否要重新生成公开访问 URL？",
	...
	"overview.appInfo.settings.sso.description": "启用后，所有用户都需要先进行 SSO 认证才能访问",
	...
	"overview.appInfo.settings.workflow.hide": "隐藏",
	"overview.appInfo.settings.workflow.show": "显示",
	...
	"overview.title": "概览",
	"overview.triggerInfo.explanation": "工作流触发器管理",
	"overview.triggerInfo.learnAboutTriggers": "了解触发器",
	"overview.triggerInfo.noTriggerAdded": "未添加触发器",
	"overview.triggerInfo.title": "触发器",
	"overview.triggerInfo.triggerStatusDescription": "触发器节点状态显示在这里。（草稿中可能已存在，发布后生效）",
	"overview.triggerInfo.triggersAdded": "已添加 {{count}} 个触发器",
	"welcome.enterKeyTip": "请先在下方输入你的 OpenAI API Key",
	"welcome.firstStepTip": "开始之前，",
	"welcome.getKeyTip": "从 OpenAI 获取你的 API Key",
