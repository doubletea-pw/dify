//#region i18n/pt-BR/app-debug.json
var autoAddVar = "Variáveis indefinidas referenciadas na pré-solicitação, você deseja adicioná-las no formulário de entrada do usuário?";
var chatSubTitle = "Instruções";
var completionSubTitle = "Prefixo da Solicitação";
var debugAsMultipleModel = "Depurar como vários modelos";
var debugAsSingleModel = "Depurar como modelo único";
var duplicateModel = "Duplicar";
var formattingChangedText = "Modificar a formatação redefinirá a área de depuração, você tem certeza?";
var formattingChangedTitle = "Formatação alterada";
var noResult = "A saída será exibida aqui.";
var notSetVar = "As variáveis permitem que os usuários introduzam palavras de solicitação ou observações iniciais ao preencher formulários. Você pode tentar digitar \"{{input}}\" nas palavras de solicitação.";
var orchestrate = "Orquestrar";
var promptTip = "As solicitações guiam as respostas da IA com instruções e restrições. Insira variáveis como {{input}}. Este prompt não será visível para os usuários.";
var publishAs = "Publicar como";
var result = "Texto de Saída";
var variableTip = "Os usuários preenchem as variáveis em um formulário, substituindo automaticamente as variáveis na solicitação.";
var variableTitle = "Variáveis";
