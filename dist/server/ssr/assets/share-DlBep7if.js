...
var share_default = {
	...
	"chat.newChatDefaultName": "Nueva conversación",
	...
	"generation.errorMsg.atLeastOne": "Por favor, ingresa al menos una fila en el archivo cargado.",
	"generation.errorMsg.empty": "Por favor, ingresa contenido en el archivo cargado.",
	"generation.errorMsg.emptyLine": "La fila {{rowIndex}} está vacía",
	"generation.errorMsg.fileStructNotMatch": "El archivo CSV cargado no coincide con la estructura.",
	"generation.errorMsg.invalidLine": "Fila {{rowIndex}}: el valor de {{varName}} no puede estar vacío",
	"generation.errorMsg.moreThanMaxLengthLine": "Fila {{rowIndex}}: el valor de {{varName}} no puede tener más de {{maxLength}} caracteres",
	"generation.execution": "Ejecutar",
	...
	"generation.savedNoData.title": "¡Aún no has guardado ningún resultado!",
	"generation.stopRun": "Detener ejecución",
	"generation.tabs.batch": "Ejecutar en lote",
