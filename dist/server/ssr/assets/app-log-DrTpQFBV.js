//#region i18n/uk-UA/app-log.json
var agentLog = "Журнал агента";
var dateFormat = "ДД/ММ/РРРР";
var dateTimeFormat = "MM/DD/YYYY hh:mm:ss A";
var description = "Журнали фіксують робочий статус додатка, включаючи введення користувачів та відповіді штучного інтелекту.";
var promptLog = "Журнал Запитань";
var title = "Журнали";
var viewLog = "Переглянути журнал";
var workflowSubtitle = "Журнал зареєстрував роботу Автоматизації.";
var workflowTitle = "Журнали Робочого Процесу";
var app_log_default = {
	agentLog,
