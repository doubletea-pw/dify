//#region i18n/zh-Hans/plugin.json
var allCategories = "所有类别";
var deprecated = "已弃用";
var difyVersionNotCompatible = "当前 Dify 版本不兼容该插件，其最低版本要求为 {{minimalDifyVersion}}";
var endpointsEnabled = "{{num}} 组端点已启用";
var findMoreInMarketplace = "在 Marketplace 中查找更多";
var from = "来自";
var fromMarketplace = "来自市场";
var install = "{{num}} 次安装";
var installAction = "安装";
var installFrom = "安装源";
var installPlugin = "安装插件";
var publishPlugins = "发布插件";
var requestAPlugin = "申请插件";
var search = "搜索";
var searchCategories = "搜索类别";
var searchInMarketplace = "在 Marketplace 中搜索";
var searchPlugins = "搜索插件";
var searchTools = "搜索工具...";
var plugin_default = {
	...
	"auth.clientInfo": "由于未找到此工具提供者的系统客户端密钥，因此需要手动设置，对于 redirect_uri，请使用",
	...
	"autoUpdate.excludeUpdate": "以下 {{num}} 个插件将不会自动更新",
	"autoUpdate.nextUpdateTime": "下次自动更新时间: {{time}}",
	"autoUpdate.noPluginPlaceholder.noFound": "未找到插件",
	"autoUpdate.noPluginPlaceholder.noInstalled": "未安装插件",
	"autoUpdate.operation.clearAll": "清除所有",
	"autoUpdate.operation.select": "选择插件",
	"autoUpdate.partialUPdate": "仅以下 {{num}} 个插件将自动更新",
	"autoUpdate.pluginDowngradeWarning.description": "此插件目前已启用自动更新。降级版本可能会导致您的更改在下次自动更新时被覆盖。",
	"autoUpdate.pluginDowngradeWarning.downgrade": "仍然降级",
	"autoUpdate.pluginDowngradeWarning.exclude": "从自动更新中排除",
	"autoUpdate.pluginDowngradeWarning.title": "插件降级",
	"autoUpdate.specifyPluginsToUpdate": "指定要更新的插件",
	"autoUpdate.strategy.disabled.description": "插件将不会自动更新",
	"autoUpdate.strategy.disabled.name": "禁用",
	"autoUpdate.strategy.fixOnly.description": "仅自动更新补丁版本（例如，1.0.1 → 1.0.2）。次要版本更改不会触发更新。",
	...
	"detailPanel.categoryTip.debugging": "调试插件",
	...
	"detailPanel.deprecation.fullMessage": "由于{{deprecatedReason}}，此插件已被弃用，将不再发布新版本。请使用<CustomLink href='https://example.com/'>{{-alternativePluginId}}</CustomLink>替代。",
	"detailPanel.deprecation.noReason": "此插件已被弃用，将不再发布新版本。",
	"detailPanel.deprecation.onlyReason": "由于{{deprecatedReason}}，此插件已被弃用，将不再发布新版本。",
	...
	"detailPanel.endpointModalDesc": "完成配置后可使用插件 API 端点提供的功能",
	...
	"detailPanel.endpointsTip": "此插件通过 API 端点提供特定功能，您可以为当前工作区配置多个 API 端点集。",
	...
	"detailPanel.operation.info": "插件信息",
	...
	"detailPanel.toolSelector.uninstalledContent": "此插件安装自 本地 / GitHub 仓库，请安装后使用。",
	"detailPanel.toolSelector.uninstalledLink": "在插件中管理",
	"detailPanel.toolSelector.uninstalledTitle": "工具未安装",
	"detailPanel.toolSelector.unsupportedContent": "已安装的插件版本不提供这个 action。",
	"detailPanel.toolSelector.unsupportedContent2": "点击切换版本",
	"detailPanel.toolSelector.unsupportedMCPTool": "当前选定的 Agent 策略插件版本不支持 MCP 工具。",
	...
	"installFromGitHub.installNote": "请确保只从可信源安装插件。",
	"installFromGitHub.installPlugin": "从 GitHub 安装插件",
	...
	"installFromGitHub.updatePlugin": "更新来自 GitHub 的插件",
	"installFromGitHub.uploadFailed": "上传失败",
	"installModal.back": "返回",
	"installModal.cancel": "取消",
	"installModal.close": "关闭",
	"installModal.dropPluginToInstall": "拖放插件包到此处安装",
	"installModal.fromTrustSource": "请保证仅从<trustSource>可信源</trustSource>安装插件。",
	"installModal.install": "安装",
	"installModal.installComplete": "安装完成",
	"installModal.installFailed": "安装失败",
	"installModal.installFailedDesc": "插件安装失败。",
	"installModal.installPlugin": "安装插件",
	"installModal.installWarning": "此插件不允许安装。",
	"installModal.installedSuccessfully": "安装成功",
	"installModal.installedSuccessfullyDesc": "插件已成功安装。",
	...
	"installModal.pluginLoadError": "插件加载错误",
	"installModal.pluginLoadErrorDesc": "此插件将不会被安装",
	"installModal.readyToInstall": "即将安装以下插件",
	"installModal.readyToInstallPackage": "即将安装以下插件",
	"installModal.readyToInstallPackages": "即将安装以下 {{num}} 个插件",
	"installModal.uploadFailed": "上传失败",
	"installModal.uploadingPackage": "上传 {{packageName}} 中...",
	installPlugin,
	"list.noInstalled": "无已安装的插件",
	"list.notFound": "未找到插件",
	"list.source.github": "从 GitHub 安装",
	"list.source.local": "本地插件",
