//#region i18n/es-ES/app.json
var accessControl = "Control de Acceso a la Aplicación Web";
var appDeleteFailed = "Error al eliminar app";
var appDeleted = "App eliminada";
var appNamePlaceholder = "Dale un nombre a tu aplicación";
var communityIntro = "Discute con miembros del equipo, colaboradores y desarrolladores en diferentes canales.";
var createApp = "CREAR APP";
var createFromConfigFile = "Crear desde archivo DSL";
var deleteAppConfirmContent = "Eliminar la app es irreversible. Los usuarios ya no podrán acceder a tu app y todas las configuraciones y registros de prompts se eliminarán permanentemente.";
var deleteAppConfirmInputLabel = "Para confirmar, escriba \"{{appName}}\" en el cuadro a continuación:";
var deleteAppConfirmInputPlaceholder = "Ingrese el nombre de la app";
var deleteAppConfirmTitle = "¿Eliminar esta app?";
var duplicate = "Duplicar";
var duplicateTitle = "Duplicar App";
var editApp = "Editar información";
var editAppTitle = "Editar información de la app";
var editDone = "Información de la app actualizada";
var editFailed = "Error al actualizar información de la app";
var exportFailed = "Error al exportar DSL.";
var importDSL = "Importar archivo DSL";
var importFromDSL = "Importar desde DSL";
var importFromDSLFile = "Desde el archivo DSL";
var importFromDSLUrl = "URL de origen";
var importFromDSLUrlPlaceholder = "Pegar enlace DSL aquí";
var join = "Únete a la comunidad";
var maxActiveRequests = "Máximas solicitudes concurrentes";
var maxActiveRequestsPlaceholder = "Introduce 0 para ilimitado";
var maxActiveRequestsTip = "Número máximo de solicitudes activas concurrentes por aplicación (0 para ilimitado)";
var noAccessPermission = "No se permite el acceso a la aplicación web";
var noUserInputNode = "Nodo de entrada de usuario faltante";
var notPublishedYet = "La aplicación aún no está publicada";
var openInExplore = "Abrir en Explorar";
var removeOriginal = "Eliminar la app original";
var roadmap = "Ver nuestro plan de desarrollo";
var showMyCreatedAppsOnly = "Mostrar solo mis aplicaciones creadas";
var switchLabel = "La copia de la app a crear";
var switchStart = "Iniciar cambio";
var switchTip = "volver";
var switchTipEnd = " a la Orquestación Básica.";
var switchTipStart = "Se creará una nueva copia de la app para ti y la nueva copia cambiará a Orquestación de Flujo de Trabajo. La nueva copia no permitirá";
var app_default = {
	accessControl,
