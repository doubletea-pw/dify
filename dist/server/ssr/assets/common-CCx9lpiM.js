...
var common_default = {
	...
	"actionMsg.downloadUnsuccessfully": "Не удалось загрузить. Пожалуйста, попробуйте позже.",
	...
	"chat.inputDisabledPlaceholder": "Только предпросмотр",
	"chat.inputPlaceholder": "Поговорить с {{botName}}",
	...
	"model.params.stop_sequencesTip": "До четырех последовательностей, где API\xA0прекратит генерировать дальнейшие токены.\xA0Возвращаемый текст не будет содержать стоп-последовательность.",
