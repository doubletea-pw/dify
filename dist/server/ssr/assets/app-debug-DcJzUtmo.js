//#region i18n/vi-VN/app-debug.json
var autoAddVar = "Phát hiện biến không xác định được tham chiếu trong tiền-lời nhắc, bạn có muốn thêm chúng vào biểu mẫu đầu vào người dùng không?";
var chatSubTitle = "Hướng dẫn";
var completionSubTitle = "Tiền tố lời nhắc";
var debugAsMultipleModel = "Gỡ lỗi như nhiều mô hình";
var debugAsSingleModel = "Gỡ lỗi như một mô hình";
var duplicateModel = "Sao chép";
var formattingChangedText = "Thay đổi định dạng sẽ đặt lại khu vực gỡ lỗi, bạn có chắc chắn không?";
var formattingChangedTitle = "Định dạng đã thay đổi";
var noResult = "Đầu ra sẽ được hiển thị ở đây.";
var notSetVar = "Biến cho phép người dùng đưa ra từ khóa lời nhắc hoặc mở đầu khi điền vào biểu mẫu. Bạn có thể thử nhập \"{{input}}\" trong các từ khóa lời nhắc.";
var orchestrate = "Điều phối";
var promptTip = "Lời nhắc hướng dẫn các phản hồi của AI với hướng dẫn và ràng buộc. Chèn biến như {{input}}. Lời nhắc này sẽ không được hiển thị cho người dùng.";
var publishAs = "Xuất bản dưới dạng";
var result = "Văn bản đầu ra";
var variableTip = "Người dùng điền các biến vào một biểu mẫu, tự động thay thế các biến trong lời nhắc.";
var variableTitle = "Biến";
