...
import { M as FW } from "./react-D5xHzNYo.js";
import { b as useTranslation } from "./floating-ui.utils.dom-B62kDwTz.js";
import { r as __extends, t as __assign } from "./tslib.es6-BSnKF3gl.js";
import { t as cn } from "./classnames-LHQnX9lX.js";
import { t as Divider } from "./divider-DZD56ykp.js";
import { h as DISABLE_UPLOAD_IMAGE_AS_ICON } from "./config-Dopncj5R.js";
import { t as noop } from "./noop--k6oqy4d.js";
import { t as Button } from "./button-BqYXL-Bc.js";
import { t as Modal } from "./modal-9VFVByDR.js";
import { t as ALLOW_FILE_EXTENSIONS } from "./app-DPjSIfgb.js";
import { t as EmojiPickerInner } from "./Inner-Cd93zOxF.js";
import { r as useLocalFileUploader, t as Icon } from "./images-D3Uv050C.js";
...
//#endregion
//#region node_modules/.pnpm/react-easy-crop@5.5.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/react-easy-crop/index.module.mjs
...
function getCropSize(mediaWidth, mediaHeight, containerWidth, containerHeight, aspect, rotation) {
	...
	var _a = rotateSize$1(mediaWidth, mediaHeight, rotation), width = _a.width, height = _a.height;
...
function restrictPosition(position, mediaSize, cropSize, zoom, rotation) {
	if (rotation === void 0) rotation = 0;
	var _a = rotateSize$1(mediaSize.width, mediaSize.height, rotation), width = _a.width, height = _a.height;
	return {
...
var Cropper = function(_super) {
	...
	function Cropper() {
		...
		_this.cropperRef = React$1.createRef();
		_this.imageRef = React$1.createRef();
		_this.videoRef = React$1.createRef();
	...
	Cropper.prototype.render = function() {
		...
		return React$1.createElement("div", {
		...
		}, image ? React$1.createElement("img", __assign({
			alt: "",
		...
		})) : video && React$1.createElement("video", __assign({
			autoPlay: true,
			playsInline: true,
			loop: true,
			muted: true,
			...
			return React$1.createElement("source", __assign({ key: item.src }, item));
		})), this.state.cropSize && React$1.createElement("div", __assign({
			ref: this.cropperRef,
...
//#endregion
//#region app/components/base/app-icon-picker/hooks.tsx
var useDraggableUploader = (setImageFn) => {
...
//#endregion
//#region app/components/base/app-icon-picker/utils.ts
...
*/
async function getCroppedImg(imageSrc, pixelCrop, fileName, rotation = 0, flip = {
	horizontal: false,
	vertical: false
}) {
	...
	return new Promise((resolve, reject) => {
		croppedCanvas.toBlob((file) => {
			...
			else reject(/* @__PURE__ */ new Error("Could not create a blob"));
		}, mimeType);
	});
}
function checkIsAnimatedImage(file) {
	return new Promise((resolve, reject) => {
		...
		fileReader.onload = function(e) {
			...
			if (file.name.toLowerCase().endsWith(".gif")) resolve(true);
			else if (isWebP(arr)) resolve(checkWebPAnimation(arr));
			else resolve(false);
		};
...
function isWebP(arr) {
	return arr[0] === 82 && arr[1] === 73 && arr[2] === 70 && arr[3] === 70 && arr[8] === 87 && arr[9] === 69 && arr[10] === 66 && arr[11] === 80;
}
function checkWebPAnimation(arr) {
	for (let i = 12; i < arr.length - 4; i++) if (arr[i] === 65 && arr[i + 1] === 78 && arr[i + 2] === 73 && arr[i + 3] === 77) return true;
	return false;
}
//#endregion
//#region app/components/base/app-icon-picker/ImageInput.tsx
var ImageInput = ({ className, cropShape, onImageInput }) => {
	...
	const { isDragActive, handleDragEnter, handleDragOver, handleDragLeave, handleDrop } = useDraggableUploader((file) => setInputImage({
		file,
		url: URL.createObjectURL(file)
	}));
	const inputRef = createRef();
	const handleShowImage = () => {
		if (isAnimatedImage) return /* @__PURE__ */ jsx("img", {
			src: inputImage?.url,
			alt: "",
			"data-testid": "animated-image"
		});
		return /* @__PURE__ */ jsx(Cropper, {
	...
	return /* @__PURE__ */ jsx("div", {
		className: cn(className, "w-full px-3 py-1.5"),
		children: /* @__PURE__ */ jsx("div", {
			...
			onDrop: handleDrop,
			children: !inputImage ? /* @__PURE__ */ jsxs(Fragment$1, { children: [
				/* @__PURE__ */ jsx(Icon, { className: "pointer-events-none mb-3 h-[30px] w-[30px]" }),
				/* @__PURE__ */ jsxs("div", {
					className: "mb-[2px] text-sm font-medium",
					children: [
						/* @__PURE__ */ jsxs("span", {
							className: "pointer-events-none",
							children: [t("imageInput.dropImageHere", { ns: "common" }), "\xA0"]
						}),
						/* @__PURE__ */ jsx("button", {
							type: "button",
							className: "text-components-button-primary-bg",
							onClick: () => inputRef.current?.click(),
							children: t("imageInput.browse", { ns: "common" })
						}),
						/* @__PURE__ */ jsx("input", {
							ref: inputRef,
							type: "file",
				...
				/* @__PURE__ */ jsx("div", {
					className: "pointer-events-none",
					children: t("imageInput.supportedFormats", { ns: "common" })
				})
			] }) : handleShowImage()
		})
	});
};
var style_module_default = { container: "_container_3rig1_1" };
//#endregion
//#region app/components/base/app-icon-picker/index.tsx
var AppIconPicker = ({ onSelect, onClose, className }) => {
	const { t } = useTranslation();
	const tabs = [{
		key: "emoji",
		...
		icon: /* @__PURE__ */ jsx(FW, { className: "size-4" })
	}];
	...
	const handleSelect = async () => {
		if (activeTab === "emoji") {
			...
			handleLocalFileUpload(new File([blob], inputImageInfo.fileName, { type: blob.type }));
		}
	};
	return /* @__PURE__ */ jsxs(Modal, {
		...
		className: cn(style_module_default.container, "!h-[462px] !w-[362px] !p-0"),
		children: [
			!DISABLE_UPLOAD_IMAGE_AS_ICON && /* @__PURE__ */ jsx("div", {
				className: "w-full p-2 pb-0",
				children: /* @__PURE__ */ jsx("div", {
					className: "flex items-center justify-center gap-2 rounded-xl bg-background-body p-1 text-text-primary",
					children: tabs.map((tab) => /* @__PURE__ */ jsxs("button", {
						type: "button",
						className: cn("system-sm-medium flex h-8 flex-1 shrink-0 items-center justify-center rounded-lg p-2 text-text-tertiary", activeTab === tab.key && "bg-components-main-nav-nav-button-bg-active text-text-accent shadow-md"),
			...
			activeTab === "emoji" && /* @__PURE__ */ jsx(EmojiPickerInner, {
				className: cn("flex-1 overflow-hidden pt-2"),
				onSelect: handleSelectEmoji
			}),
			activeTab === "image" && /* @__PURE__ */ jsx(ImageInput, {
...
//#endregion
export { ImageInput as n, getCroppedImg as r, AppIconPicker as t };
