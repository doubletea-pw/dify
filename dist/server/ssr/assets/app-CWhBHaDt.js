//#region i18n/uk-UA/app.json
var accessControl = "Контроль доступу до веб-додатків";
var appDeleteFailed = "Не вдалося видалити додаток";
var appDeleted = "Додаток видалено";
var appNamePlaceholder = "Дайте вашому додатку назву";
var communityIntro = "Обговорюйте з членами команди, співавторами та розробниками на різних каналах.";
var createApp = "Створити додаток";
var createFromConfigFile = "Створити з файлу DSL";
var deleteAppConfirmContent = "Видалення додатка незворотнє. Користувачі більше не зможуть отримати доступ до вашого додатка, і всі налаштування запитів та журнали будуть остаточно видалені.";
var deleteAppConfirmInputLabel = "Для підтвердження введіть \"{{appName}}\" у поле нижче:";
var deleteAppConfirmInputPlaceholder = "Введіть назву додатка";
var deleteAppConfirmTitle = "Видалити цей додаток?";
var duplicate = "Дублювати";
var duplicateTitle = "Дублювати додаток";
var editApp = "Редагувати інформацію";
var editAppTitle = "Редагувати інформацію про додаток";
var editDone = "Інформація про додаток оновлена";
var editFailed = "Не вдалося оновити інформацію про додаток";
var exportFailed = "Не вдалося експортувати DSL.";
var importDSL = "Імпортувати файл DSL";
var importFromDSL = "Імпорт з DSL";
var importFromDSLFile = "З DSL-файлу";
var importFromDSLUrl = "З URL";
var importFromDSLUrlPlaceholder = "Вставте посилання на DSL тут";
var join = "Приєднуйтесь до спільноти";
var maxActiveRequests = "Максимальна кількість одночасних запитів";
var maxActiveRequestsPlaceholder = "Введіть 0 для необмеженого";
var maxActiveRequestsTip = "Максимальна кількість одночасних активних запитів на додаток (0 для необмеженої кількості)";
var noAccessPermission = "Немає дозволу на доступ до веб-додатку";
var noUserInputNode = "Відсутній вузол введення користувача";
var notPublishedYet = "Додаток ще не опублікований";
var openInExplore = "Відкрити в Огляді";
var removeOriginal = "Видалити початковий додаток";
var roadmap = "Переглянути наш план розвитку";
var showMyCreatedAppsOnly = "Показати лише створені мною додатки";
var switchLabel = "Копія додатка, яка буде створена";
var switchStart = "Почати перемикання";
var switchTip = "повернутися";
var switchTipEnd = " до базової оркестрації.";
var switchTipStart = "Для вас буде створена нова копія додатка, і нова копія перейде до оркестрації робочого процесу. Нова копія не дозволить ";
var app_default = {
	accessControl,
	...
	"gotoAnything.emptyState.tryDifferentTerm": "Спробуйте інший пошуковий термін",
