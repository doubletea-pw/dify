//#region i18n/ja-JP/app-log.json
var agentLog = "エージェントログ";
var dateFormat = "YYYY/MM/DD";
var dateTimeFormat = "YYYY/MM/DD hh:mm:ss A";
var description = "ログは、アプリケーションの実行状態を記録します。ユーザーの入力や AI の応答などが含まれます。";
var promptLog = "プロンプトログ";
var title = "ログ";
var viewLog = "ログを表示";
var workflowSubtitle = "このログは Automate の操作を記録しました。";
var workflowTitle = "ワークフローログ";
var app_log_default = {
	agentLog,
