//#region i18n/de-DE/app-debug.json
var autoAddVar = "Im Vor-Prompt referenzierte undefinierte Variablen, möchten Sie sie im Benutzereingabeformular hinzufügen?";
var chatSubTitle = "Anweisungen";
var completionSubTitle = "Vor-Prompt";
var debugAsMultipleModel = "Als Mehrfachmodelle debuggen";
var debugAsSingleModel = "Als Einzelmodell debuggen";
var duplicateModel = "Duplizieren";
var formattingChangedText = "Die Änderung der Formatierung wird den Debug-Bereich zurücksetzen, sind Sie sicher?";
var formattingChangedTitle = "Formatierung geändert";
var noResult = "Hier wird die Ausgabe angezeigt.";
var notSetVar = "Variablen ermöglichen es Benutzern, Aufforderungswörter oder Eröffnungsbemerkungen einzuführen, wenn sie Formulare ausfüllen. Sie könnten versuchen, \"{{input}}\" im Prompt einzugeben.";
var orchestrate = "Orchestrieren";
var promptTip = "Prompts leiten KI-Antworten mit Anweisungen und Einschränkungen. Fügen Sie Variablen wie {{input}} ein. Dieses Prompt wird den Benutzern nicht angezeigt.";
var publishAs = "Veröffentlichen als";
var result = "Ausgabetext";
var variableTip = "Benutzer füllen Variablen in einem Formular aus, automatisches Ersetzen von Variablen im Prompt.";
var variableTitle = "Variablen";
