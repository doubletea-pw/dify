...
import { Ar as o2, Fr as pv, Mr as p, S as D, Vt as S7, Zr as uH, _ as CH, a as $l, on as Vb, rr as f1, wr as mM, xr as lH, xt as P7, zr as r2 } from "./react-D5xHzNYo.js";
...
import { Ct as ToolTypeEnum, St as TabsEnum, xt as BlockClassificationEnum } from "./utils-DqpfZ3W-.js";
import { r as CollectionType } from "./types-DzFjbMeE.js";
import { Ot as BlockEnum, ft as isServer } from "./config-Dopncj5R.js";
import { zr as block_icon_default } from "./hooks-Bj_4KA1b.js";
import { t as noop } from "./noop--k6oqy4d.js";
import { k as useTags } from "./semver-olnXAeJC.js";
...
import { a as useLocale, f as useTranslation$1, r as useGetLanguage } from "./i18n-lDm19WzR.js";
import { n as require_debounce, r as require_isObject } from "./useDebounceFn-Y4NS6c4S.js";
import { t as Checkbox } from "./checkbox-DTSgkYdc.js";
import { t as Link } from "./link-1R-efKLW.js";
import { Wt as useRAGRecommendedPlugins, i as useDownloadPlugin } from "./use-refresh-plugin-list-C8aKRYG-.js";
import { a as Icon$6, i as Icon$5 } from "./other-sSUV3aYW.js";
import { n as formatNumber } from "./format-BCVnrx09.js";
import { r as Icon$7 } from "./general-C8w9hIeL.js";
import { H as PluginCategoryEnum, O as getFormattedPlugin, T as useMarketplacePlugins } from "./hooks-BTelimHS.js";
...
//#region app/components/plugins/marketplace/search-box/trigger/marketplace.tsx
var MarketplaceTrigger = ({ selectedTagsLength, open, tags, tagsMap, onTagsChange }) => {
	const { t } = useTranslation$1();
	return /* @__PURE__ */ jsxs("div", {
		className: cn("flex h-8 cursor-pointer select-none items-center rounded-lg px-2 py-1 text-text-tertiary", !!selectedTagsLength && "border-[0.5px] border-components-button-secondary-border bg-components-button-secondary-bg shadow-xs shadow-shadow-shadow-3", open && !selectedTagsLength && "bg-state-base-hover"),
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "p-0.5",
				children: /* @__PURE__ */ jsx($l, { className: cn("size-4", !!selectedTagsLength && "text-text-secondary") })
			}),
			/* @__PURE__ */ jsxs("div", {
				className: "system-sm-medium flex items-center gap-x-1 p-1",
				children: [
					!selectedTagsLength && /* @__PURE__ */ jsx("span", { children: t("allTags", { ns: "pluginTags" }) }),
					!!selectedTagsLength && /* @__PURE__ */ jsx("span", {
						className: "text-text-secondary",
						children: tags.map((tag) => tagsMap[tag].label).slice(0, 2).join(",")
					}),
					selectedTagsLength > 2 && /* @__PURE__ */ jsxs("div", {
						className: "system-xs-medium text-text-tertiary",
						children: ["+", selectedTagsLength - 2]
					})
				]
			}),
			!!selectedTagsLength && /* @__PURE__ */ jsx(S7, {
				className: "size-4 text-text-quaternary",
				onClick: () => onTagsChange([])
			}),
			!selectedTagsLength && /* @__PURE__ */ jsx("div", {
				className: "p-0.5",
				children: /* @__PURE__ */ jsx(f1, { className: "size-4 text-text-tertiary" })
			})
		]
	});
};
var marketplace_default = React$1.memo(MarketplaceTrigger);
//#endregion
//#region app/components/plugins/marketplace/search-box/trigger/tool-selector.tsx
var ToolSelectorTrigger = ({ selectedTagsLength, open, tags, tagsMap, onTagsChange }) => {
	return /* @__PURE__ */ jsxs("div", {
		className: cn("flex h-7 cursor-pointer select-none items-center rounded-md p-0.5 text-text-tertiary", !selectedTagsLength && "py-1 pl-1.5 pr-2", !!selectedTagsLength && "border-[0.5px] border-components-button-secondary-border bg-components-button-secondary-bg py-0.5 pl-1 pr-1.5 shadow-xs shadow-shadow-shadow-3", open && !selectedTagsLength && "bg-state-base-hover"),
		children: [
			/* @__PURE__ */ jsx("div", {
				className: "p-0.5",
				children: /* @__PURE__ */ jsx(mM, { className: cn("size-4", !!selectedTagsLength && "text-text-secondary") })
			}),
			!!selectedTagsLength && /* @__PURE__ */ jsxs("div", {
				className: "system-sm-medium flex items-center gap-x-0.5 px-0.5 py-1",
...
var tool_selector_default = React$1.memo(ToolSelectorTrigger);
//#endregion
//#region app/components/plugins/marketplace/search-box/tags-filter.tsx
var TagsFilter = ({ tags, onTagsChange, usedInMarketplace = false }) => {
	const { t } = useTranslation$1();
	...
	const handleCheck = (id) => {
		if (tags.includes(id)) onTagsChange(tags.filter((tag) => tag !== id));
	...
	return /* @__PURE__ */ jsxs(PortalToFollowElem, {
		...
		children: [/* @__PURE__ */ jsxs(PortalToFollowElemTrigger, {
			className: "shrink-0",
			onClick: () => setOpen((v) => !v),
			children: [usedInMarketplace && /* @__PURE__ */ jsx(marketplace_default, {
				selectedTagsLength,
				open,
				tags,
				tagsMap,
				onTagsChange
			}), !usedInMarketplace && /* @__PURE__ */ jsx(tool_selector_default, {
				selectedTagsLength,
				open,
				tags,
				tagsMap,
			...
			children: /* @__PURE__ */ jsxs("div", {
				className: "w-[240px] rounded-xl border-[0.5px] border-components-panel-border bg-components-panel-bg-blur shadow-lg backdrop-blur-sm",
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: filteredOptions.map((option) => /* @__PURE__ */ jsxs("div", {
...
//#endregion
//#region app/components/plugins/marketplace/search-box/index.tsx
var SearchBox = ({ search, onSearchChange, wrapperClassName, inputClassName, tags, onTagsChange, placeholder = "", usedInMarketplace = false, supportAddCustomTool, onShowAddCustomCollectionModal, autoFocus = false }) => {
	return /* @__PURE__ */ jsxs("div", {
		className: cn("z-[11] flex items-center", wrapperClassName),
		children: [/* @__PURE__ */ jsxs("div", {
			className: cn("flex items-center", usedInMarketplace && "rounded-xl border border-components-chat-input-border bg-components-panel-bg-blur p-1.5 shadow-md", !usedInMarketplace && "radius-md border border-transparent bg-components-input-bg-normal focus-within:border-components-input-border-active hover:border-components-input-border-hover", inputClassName),
			children: [usedInMarketplace && /* @__PURE__ */ jsxs(Fragment$1, { children: [
				/* @__PURE__ */ jsx(TagsFilter, {
					tags,
					onTagsChange,
				...
				/* @__PURE__ */ jsxs("div", {
					className: "flex grow items-center gap-x-2 p-1",
					children: [/* @__PURE__ */ jsx("input", {
						className: cn("body-md-medium inline-block grow appearance-none bg-transparent text-text-secondary outline-none"),
						value: search,
						onChange: (e) => {
							onSearchChange(e.target.value);
						},
						placeholder
					}), search && /* @__PURE__ */ jsx(ActionButton, {
						onClick: () => onSearchChange(""),
						className: "shrink-0",
						children: /* @__PURE__ */ jsx(P7, { className: "size-4" })
					})]
				})
			] }), !usedInMarketplace && /* @__PURE__ */ jsxs(Fragment$1, { children: [
				/* @__PURE__ */ jsxs("div", {
					className: "flex grow items-center py-[7px] pl-2 pr-3",
					children: [
						/* @__PURE__ */ jsx(pv, { className: "size-4 text-components-input-text-placeholder" }),
						/* @__PURE__ */ jsx("input", {
							autoFocus,
							className: cn("system-sm-regular ml-1.5 mr-1 inline-block grow appearance-none bg-transparent text-components-input-text-filled outline-none placeholder:text-components-input-text-placeholder", search && "mr-2"),
							value: search,
							onChange: (e) => {
								onSearchChange(e.target.value);
							},
		...
		}), supportAddCustomTool && /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region app/components/workflow/block-selector/constants.tsx
var BLOCK_CLASSIFICATIONS = [
...
var DEFAULT_FILE_EXTENSIONS_IN_LOCAL_FILE_DATA_SOURCE = [
	"txt",
	"markdown",
	"mdx",
	"pdf",
...
//#endregion
//#region app/components/workflow/block-selector/hooks.ts
var useBlocks = () => {
...
var useTabs = ({ noBlocks, noSources, noTools, noStart = true, defaultActiveTab, hasUserInputNode = false, forceEnableStartTab = false }) => {
	const { t } = useTranslation();
	...
	const getValidTabKey = useCallback((targetKey) => {
		if (!targetKey) return void 0;
		const tab = tabs.find((tabItem) => tabItem.key === targetKey);
		if (!tab || tab.disabled) return void 0;
		return tab.key;
	}, [tabs]);
	...
	useEffect(() => {
		...
		if (!currentTab || currentTab.disabled) setActiveTab(initialTab);
	}, [
		tabs,
		activeTab,
		initialTab
...
var useToolTabs = (isHideMCPTools) => {
	const { t } = useTranslation();
	const tabs = [
		{
	...
	if (!isHideMCPTools) tabs.push({
		key: ToolTypeEnum.MCP,
		name: "MCP"
	});
	return tabs;
};
var ArrowDownDoubleLine_default = {
	icon: {
		"type": "element",
		"isRootNode": true,
		"name": "svg",
...
//#endregion
//#region app/components/base/icons/src/vender/solid/arrows/ArrowDownDoubleLine.tsx
var Icon$4 = ({ ref, ...props }) => /* @__PURE__ */ jsx(IconBase, {
	...props,
	ref,
	data: ArrowDownDoubleLine_default
});
Icon$4.displayName = "ArrowDownDoubleLine";
...
//#endregion
//#region app/components/base/icons/src/vender/solid/arrows/ArrowDownRoundFill.tsx
var Icon$3 = ({ ref, ...props }) => /* @__PURE__ */ jsx(IconBase, {
	...props,
	ref,
	data: ArrowDownRoundFill_default
});
Icon$3.displayName = "ArrowDownRoundFill";
var ArrowUpDoubleLine_default = {
	icon: {
		"type": "element",
		"isRootNode": true,
		"name": "svg",
...
//#endregion
//#region app/components/base/icons/src/vender/solid/arrows/ArrowUpDoubleLine.tsx
var Icon$2 = ({ ref, ...props }) => /* @__PURE__ */ jsx(IconBase, {
	...props,
	ref,
	data: ArrowUpDoubleLine_default
});
Icon$2.displayName = "ArrowUpDoubleLine";
var ChevronDown_default = {
	icon: {
		"type": "element",
		"isRootNode": true,
		"name": "svg",
...
//#endregion
//#region app/components/base/icons/src/vender/solid/arrows/ChevronDown.tsx
var Icon$1 = ({ ref, ...props }) => /* @__PURE__ */ jsx(IconBase, {
	...props,
	ref,
	data: ChevronDown_default
});
Icon$1.displayName = "ChevronDown";
var HighPriority_default = {
	icon: {
		"type": "element",
		"isRootNode": true,
		"name": "svg",
...
//#endregion
//#region app/components/base/icons/src/vender/solid/arrows/HighPriority.tsx
var Icon = ({ ref, ...props }) => /* @__PURE__ */ jsx(IconBase, {
	...props,
	ref,
	data: HighPriority_default
});
Icon.displayName = "HighPriority";
//#endregion
//#region app/components/workflow/block-selector/market-place-plugin/action.tsx
var OperationDropdown = ({ open, onOpenChange, author, name, version }) => {
	const { t } = useTranslation();
	const { theme } = z();
	...
	useEffect(() => {
		if (!needDownload || !blob) return;
		downloadBlob({
			data: blob,
			fileName: `${author}-${name}_${version}.zip`
		});
	...
	return /* @__PURE__ */ jsxs(PortalToFollowElem, {
		...
		children: [/* @__PURE__ */ jsx(PortalToFollowElemTrigger, {
			...
			children: /* @__PURE__ */ jsx(ActionButton, {
				...
				children: /* @__PURE__ */ jsx(CH, { className: "h-4 w-4 text-components-button-secondary-accent-text" })
			})
		}), /* @__PURE__ */ jsx(PortalToFollowElemContent, {
			className: "z-[9999]",
			children: /* @__PURE__ */ jsxs("div", {
				className: "min-w-[176px] rounded-xl border-[0.5px] border-components-panel-border bg-components-panel-bg-blur p-1 shadow-lg",
				children: [/* @__PURE__ */ jsx("div", {
					onClick: handleDownload,
					className: "system-md-regular cursor-pointer rounded-lg px-3 py-1.5 text-text-secondary hover:bg-state-base-hover",
					children: t("operation.download", { ns: "common" })
				}), /* @__PURE__ */ jsx("a", {
					href: getMarketplaceUrl(`/plugins/${author}/${name}`, { theme }),
					target: "_blank",
					className: "system-md-regular block cursor-pointer rounded-lg px-3 py-1.5 text-text-secondary hover:bg-state-base-hover",
					children: t("operation.viewDetails", { ns: "common" })
				})]
			})
		})]
	});
};
var action_default = React$1.memo(OperationDropdown);
//#endregion
...
//#endregion
//#region node_modules/.pnpm/ahooks@3.9.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/ahooks/es/useThrottleFn/index.js
...
function useThrottleFn(fn, options) {
	...
	var throttled = useMemo(function() {
		return (0, import_throttle.default)(function() {
			var args = [];
...
//#endregion
//#region app/components/workflow/block-selector/use-sticky-scroll.ts
var ScrollPosition = /* @__PURE__ */ function(ScrollPosition) {
	ScrollPosition["belowTheWrap"] = "belowTheWrap";
	ScrollPosition["showing"] = "showing";
	ScrollPosition["aboveTheWrap"] = "aboveTheWrap";
	return ScrollPosition;
}({});
var useStickyScroll = ({ wrapElemRef, nextToStickyELemRef }) => {
	const [scrollPosition, setScrollPosition] = React$1.useState(ScrollPosition.belowTheWrap);
...
//#endregion
//#region app/components/workflow/block-selector/market-place-plugin/item.tsx
var Item$1 = ({ payload }) => {
	const { t } = useTranslation();
	const [open, setOpen] = React$1.useState(false);
	const locale = useLocale();
	const getLocalizedText = (obj) => obj?.[locale] || obj?.["en-US"] || obj?.en_US || "";
	const [isShowInstallModal, { setTrue: showInstallModal, setFalse: hideInstallModal }] = useBoolean(false);
	return /* @__PURE__ */ jsxs("div", {
		className: "group/plugin flex rounded-lg py-1 pl-3 pr-1 hover:bg-state-base-hover",
		children: [/* @__PURE__ */ jsx("div", {
			...
			className: "ml-2 flex w-0 grow",
			children: [
				/* @__PURE__ */ jsxs("div", {
					className: "w-0 grow",
					children: [
						/* @__PURE__ */ jsx("div", {
							className: "system-sm-medium h-4 truncate leading-4 text-text-primary ",
							children: getLocalizedText(payload.label)
						}),
						/* @__PURE__ */ jsx("div", {
							className: "system-xs-regular h-5 truncate leading-5 text-text-tertiary",
							children: getLocalizedText(payload.brief)
						}),
						/* @__PURE__ */ jsxs("div", {
							className: "system-xs-regular flex space-x-1 text-text-tertiary",
							children: [
								/* @__PURE__ */ jsx("div", { children: payload.org }),
								/* @__PURE__ */ jsx("div", { children: "·" }),
								/* @__PURE__ */ jsx("div", { children: t("install", {
									ns: "plugin",
									num: formatNumber(payload.install_count || 0)
								}) })
							]
						})
					]
				...
				/* @__PURE__ */ jsxs("div", {
					className: cn(!open ? "hidden" : "flex", "system-xs-medium h-4 items-center space-x-1 text-components-button-secondary-accent-text group-hover/plugin:flex"),
					children: [/* @__PURE__ */ jsx("div", {
				...
				isShowInstallModal && /* @__PURE__ */ jsx(InstallFromMarketplace, {
...
//#endregion
//#region app/components/workflow/block-selector/market-place-plugin/list.tsx
var List$1 = ({ wrapElemRef, searchText, tags, list, category, toolContentClassName, disableMaxWidth = false, hideFindMoreFooter = false, ref }) => {
	const { t } = useTranslation();
	const noFilter = !searchText && tags.length === 0;
	const hasRes = list.length > 0;
	const urlWithSearchText = getMarketplaceUrl("", {
		q: searchText,
		tags: tags.join(",")
	});
	const nextToStickyELemRef = useRef(null);
	...
	const stickyClassName = useMemo(() => {
		switch (scrollPosition) {
			case ScrollPosition.aboveTheWrap: return "top-0 h-9 pt-3 pb-2 shadow-xs bg-components-panel-bg-blur cursor-pointer";
			case ScrollPosition.showing: return "bottom-0 pt-3 pb-1";
			case ScrollPosition.belowTheWrap: return "bottom-0 items-center rounded-b-xl border-t border-[0.5px] border-components-panel-border bg-components-panel-bg-blur shadow-lg rounded-b-lg cursor-pointer";
		}
	}, [scrollPosition]);
	...
	return /* @__PURE__ */ jsxs(Fragment$1, { children: [hasRes && /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("span", { children: t("fromMarketplace", { ns: "plugin" }) }), /* @__PURE__ */ jsxs(Link, {
			href: urlWithSearchText,
			target: "_blank",
			className: "flex items-center text-text-accent-light-mode-only",
			onClick: (e) => e.stopPropagation(),
			children: [/* @__PURE__ */ jsx("span", { children: t("searchInMarketplace", { ns: "plugin" }) }), /* @__PURE__ */ jsx(o2, { className: "ml-0.5 h-3 w-3" })]
		})]
	}), /* @__PURE__ */ jsxs("div", {
		className: cn("p-1", !disableMaxWidth && maxWidthClassName),
		ref: nextToStickyELemRef,
		children: [list.map((item, index) => /* @__PURE__ */ jsx(item_default$1, {
			payload: item,
			onAction: noop
		}, index)), hasRes && /* @__PURE__ */ jsxs("div", {
			className: "mb-3 mt-2 flex items-center justify-center space-x-2",
			children: [
				/* @__PURE__ */ jsx("div", { className: "h-[2px] w-[90px] bg-gradient-to-l from-[rgba(16,24,40,0.08)] to-[rgba(255,255,255,0.01)]" }),
				/* @__PURE__ */ jsxs(Link, {
					href: urlWithSearchText,
					target: "_blank",
					className: "system-sm-medium flex h-4 shrink-0 items-center text-text-accent-light-mode-only",
					children: [/* @__PURE__ */ jsx(pv, { className: "mr-0.5 h-3 w-3" }), /* @__PURE__ */ jsx("span", { children: t("searchInMarketplace", { ns: "plugin" }) })]
				}),
				/* @__PURE__ */ jsx("div", { className: "h-[2px] w-[90px] bg-gradient-to-l from-[rgba(255,255,255,0.01)] to-[rgba(16,24,40,0.08)]" })
			]
		})]
	})] });
};
...
//#endregion
//#region app/components/tools/provider/empty.tsx
var getLink = (type) => {
	switch (type) {
		case ToolTypeEnum.Custom: return "/tools?category=api";
		case ToolTypeEnum.MCP: return "/tools?category=mcp";
		default: return "/tools?category=api";
	}
};
var Empty = ({ type, isAgent }) => {
	const { t } = useTranslation();
	const { theme } = useTheme();
	const hasLink = type && [ToolTypeEnum.Custom, ToolTypeEnum.MCP].includes(type);
	const Comp = hasLink ? Link : "div";
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx(Icon$5, { className: theme === "dark" ? "invert" : "" }),
			/* @__PURE__ */ jsx("div", {
				className: "mb-1 mt-2 text-[13px] font-medium leading-[18px] text-text-primary",
				children: hasTitle && renderType ? t(`addToolModal.${renderType}.title`, { ns: "tools" }) : "No tools available"
			}),
			!!(!isAgent && hasTitle && renderType) && /* @__PURE__ */ jsxs(Comp, {
				className: cn("flex items-center text-[13px] leading-[18px] text-text-tertiary", hasLink && "cursor-pointer hover:text-text-accent"),
				...linkProps,
				children: [
					t(`addToolModal.${renderType}.tip`, { ns: "tools" }),
					" ",
					hasLink && /* @__PURE__ */ jsx(o2, { className: "ml-0.5 h-3 w-3" })
				]
			})
		]
	});
...
//#endregion
//#region node_modules/.pnpm/pinyin-pro@3.28.0/node_modules/pinyin-pro/dist/index.mjs
...
OutputFormat.AllSegment;
//#endregion
//#region app/components/workflow/block-selector/index-bar.tsx
var CUSTOM_GROUP_NAME = "@@@custom@@@";
var WORKFLOW_GROUP_NAME = "@@@workflow@@@";
var DATA_SOURCE_GROUP_NAME = "@@@data_source@@@";
var AGENT_GROUP_NAME = "@@@agent@@@";
var groupItems = (items, getFirstChar) => {
	const groups = items.reduce((acc, item) => {
		const firstChar = getFirstChar(item);
		if (!firstChar || firstChar.length === 0) return acc;
		let letter;
		if (/[\u4E00-\u9FA5]/.test(firstChar)) letter = pinyin(firstChar, {
			pattern: "first",
			toneType: "none"
		})[0].toUpperCase();
...
var IndexBar = ({ letters, itemRefs, className }) => {
	const handleIndexClick = (letter) => {
		const element = itemRefs.current?.[letter];
		if (element) element.scrollIntoView({ behavior: "smooth" });
	};
	return /* @__PURE__ */ jsxs("div", {
		className: cn("index-bar sticky top-[20px] flex h-full w-6 flex-col items-center justify-center text-xs font-medium text-text-quaternary", className),
		children: [/* @__PURE__ */ jsx("div", { className: cn("absolute left-0 top-0 h-full w-px bg-[linear-gradient(270deg,rgba(255,255,255,0)_0%,rgba(16,24,40,0.08)_30%,rgba(16,24,40,0.08)_50%,rgba(16,24,40,0.08)_70.5%,rgba(255,255,255,0)_100%)]") }), letters.map((letter) => /* @__PURE__ */ jsx("div", {
...
//#endregion
//#region app/components/workflow/block-selector/view-type-select.tsx
var ViewType = /* @__PURE__ */ function(ViewType) {
	ViewType["flat"] = "flat";
	ViewType["tree"] = "tree";
	return ViewType;
}({});
var ViewTypeSelect = ({ viewType, onChange }) => {
	const handleChange = useCallback((nextViewType) => {
		return () => {
	...
	return /* @__PURE__ */ jsxs("div", {
		className: "flex items-center rounded-lg bg-components-segmented-control-bg-normal p-px",
		children: [/* @__PURE__ */ jsx("div", {
			className: cn("rounded-lg p-[3px]", viewType === ViewType.flat ? "bg-components-segmented-control-item-active-bg text-text-accent-light-mode-only shadow-xs" : "cursor-pointer text-text-tertiary"),
			onClick: handleChange(ViewType.flat),
			children: /* @__PURE__ */ jsx(Vb, { className: "h-4 w-4" })
		}), /* @__PURE__ */ jsx("div", {
			className: cn("rounded-lg p-[3px]", viewType === ViewType.tree ? "bg-components-segmented-control-item-active-bg text-text-accent-light-mode-only shadow-xs" : "cursor-pointer text-text-tertiary"),
			onClick: handleChange(ViewType.tree),
			children: /* @__PURE__ */ jsx(uH, { className: "h-4 w-4 " })
		})]
	});
};
var view_type_select_default = React$1.memo(ViewTypeSelect);
//#endregion
//#region app/components/workflow/nodes/_base/components/mcp-tool-availability.tsx
var MCPToolAvailabilityContext = createContext(void 0);
var MCPToolAvailabilityProvider = ({ versionSupported, children }) => /* @__PURE__ */ jsx(MCPToolAvailabilityContext.Provider, {
	value: { versionSupported },
	children
});
var useMCPToolAvailability = () => {
	const context = useContext(MCPToolAvailabilityContext);
	if (context === void 0) return { allowed: true };
...
//#endregion
//#region app/components/workflow/nodes/_base/components/mcp-tool-not-support-tooltip.tsx
var McpToolNotSupportTooltip = () => {
	const { t } = useTranslation();
	return /* @__PURE__ */ jsx(tooltip_default, {
		popupContent: /* @__PURE__ */ jsx("div", {
			className: "w-[256px]",
			children: t("detailPanel.toolSelector.unsupportedMCPTool", { ns: "plugin" })
		}),
		children: /* @__PURE__ */ jsx(D, { className: "size-4 text-text-warning-secondary" })
	});
};
var mcp_tool_not_support_tooltip_default = React$1.memo(McpToolNotSupportTooltip);
//#endregion
//#region app/components/workflow/block-selector/tool/action-item.tsx
var normalizeProviderIcon$1 = (icon) => {
	if (!icon) return icon;
	if (typeof icon === "string" && basePath && icon.startsWith("/") && !icon.startsWith(`${basePath}/`)) return `${basePath}${icon}`;
	return icon;
};
var ToolItem = ({ provider, payload, onSelect, disabled, isAdded }) => {
	const { t } = useTranslation();
	const language = useGetLanguage();
	const { theme } = useTheme();
	const normalizedIcon = useMemo(() => {
		return normalizeProviderIcon$1(provider.icon) ?? provider.icon;
	}, [provider.icon]);
	const normalizedIconDark = useMemo(() => {
		if (!provider.icon_dark) return void 0;
		return normalizeProviderIcon$1(provider.icon_dark) ?? provider.icon_dark;
	}, [provider.icon_dark]);
...
var action_item_default = React$1.memo(ToolItem);
//#endregion
//#region app/components/workflow/block-selector/tool/tool.tsx
var normalizeProviderIcon = (icon) => {
	if (!icon) return icon;
	if (typeof icon === "string" && basePath && icon.startsWith("/") && !icon.startsWith(`${basePath}/`)) return `${basePath}${icon}`;
	return icon;
};
var Tool = ({ className, payload, viewType, hasSearchText, onSelect, canNotSelectMultiple, onSelectMultiple, selectedTools }) => {
	const { t } = useTranslation();
	...
	const getIsDisabled = useCallback((tool) => {
	...
	const notShowProviderSelectInfo = useMemo(() => {
		if (isAllSelected) return /* @__PURE__ */ jsx("span", {
			className: "system-xs-regular text-text-tertiary",
			children: t("addToolModal.added", { ns: "tools" })
		});
	}, [isAllSelected, t]);
	const selectedInfo = useMemo(() => {
		if (isHovering && !isAllSelected) return /* @__PURE__ */ jsx("span", {
			...
			onClick: () => {
				onSelectMultiple?.(BlockEnum.Tool, actions.filter((action) => !getIsDisabled(action)).map((tool) => {
					const params = {};
					if (tool.parameters) tool.parameters.forEach((item) => {
						params[item.name] = "";
					});
					return {
			...
			children: t("tabs.addAll", { ns: "workflow" })
		});
		if (selectedToolsNum === 0) return /* @__PURE__ */ jsx(Fragment$1, {});
		return /* @__PURE__ */ jsx("span", {
			className: "system-xs-regular text-text-tertiary",
			children: isAllSelected ? t("tabs.allAdded", { ns: "workflow" }) : `${selectedToolsNum} / ${totalToolsNum}`
		});
	}, [
		actions,
		getIsDisabled,
	...
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					className: cn("flex h-8 grow items-center", isShowCanNotChooseMCPTip && "opacity-30"),
					children: [/* @__PURE__ */ jsx(block_icon_default, {
						className: "shrink-0",
						type: BlockEnum.Tool,
						toolIcon: providerIcon
					}), /* @__PURE__ */ jsxs("div", {
						className: "ml-2 flex w-0 grow items-center text-sm text-text-primary",
						children: [
							/* @__PURE__ */ jsx("span", {
								className: "max-w-[250px] truncate",
								children: notShowProvider ? actions[0]?.label[language] : payload.label[language]
							}),
							isFlatView && groupName && /* @__PURE__ */ jsx("span", {
								className: "system-xs-regular ml-2 shrink-0 text-text-quaternary",
								children: groupName
							}),
							isMCPTool && /* @__PURE__ */ jsx(Icon$6, { className: "ml-2 size-3.5 shrink-0 text-text-quaternary" })
						]
					})]
				}), /* @__PURE__ */ jsxs("div", {
					...
					children: [
						...
						hasAction && /* @__PURE__ */ jsx(FoldIcon, { className: cn("h-4 w-4 shrink-0 text-text-tertiary group-hover/item:text-text-tertiary", isFold && "text-text-quaternary") })
					]
				})]
...
var tool_default = React$1.memo(Tool);
//#endregion
//#region app/components/workflow/block-selector/tool/tool-list-flat-view/list.tsx
var ToolViewFlatView = ({ letters, payload, isShowLetterIndex, indexBar, hasSearchText, onSelect, canNotSelectMultiple, onSelectMultiple, toolRefs, selectedTools }) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			className: "mr-1 grow",
			children: payload.map((tool) => /* @__PURE__ */ jsx("div", {
				ref: (el) => {
					const letter = firstLetterToolIds[tool.id];
					if (letter) toolRefs.current[letter] = el;
				},
				children: /* @__PURE__ */ jsx(tool_default, {
					payload: tool,
...
var list_default$1 = React$1.memo(ToolViewFlatView);
//#endregion
//#region app/components/workflow/block-selector/tool/tool-list-tree-view/item.tsx
var Item = ({ groupName, toolList, hasSearchText, onSelect, canNotSelectMultiple, onSelectMultiple, selectedTools }) => {
	return /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("div", {
		className: "flex h-[22px] items-center px-3 text-xs font-medium text-text-tertiary",
		children: groupName
	}), /* @__PURE__ */ jsx("div", { children: toolList.map((tool) => /* @__PURE__ */ jsx(tool_default, {
		payload: tool,
...
//#endregion
//#region app/components/workflow/block-selector/tool/tool-list-tree-view/list.tsx
var ToolListTreeView = ({ payload, hasSearchText, onSelect, canNotSelectMultiple, onSelectMultiple, selectedTools }) => {
	const { t } = useTranslation();
	const getI18nGroupName = useCallback((name) => {
		if (name === "@@@custom@@@") return t("tabs.customTool", { ns: "workflow" });
		if (name === "@@@workflow@@@") return t("tabs.workflowTool", { ns: "workflow" });
		if (name === "@@@agent@@@") return t("tabs.agent", { ns: "workflow" });
		return name;
	}, [t]);
	if (!payload) return null;
	return /* @__PURE__ */ jsx("div", { children: Object.keys(payload).map((groupName) => /* @__PURE__ */ jsx(item_default, {
...
var list_default = React$1.memo(ToolListTreeView);
//#endregion
//#region app/components/workflow/block-selector/tools.tsx
var Tools = ({ onSelect, canNotSelectMultiple, onSelectMultiple, tools, viewType, hasSearchText, toolType, isAgent, className, indexBarClassName, selectedTools }) => {
	const language = useGetLanguage();
	const isFlatView = viewType === ViewType.flat;
	...
	return /* @__PURE__ */ jsxs("div", {
		className: cn("max-w-[100%] p-1", className),
		children: [!tools.length && !hasSearchText && /* @__PURE__ */ jsx("div", {
			className: "py-10",
			children: /* @__PURE__ */ jsx(Empty, {
				type: toolType,
				isAgent
			})
		}), !!tools.length && (isFlatView ? /* @__PURE__ */ jsx(list_default$1, {
			toolRefs,
			letters,
			...
			onSelectMultiple,
			selectedTools,
			indexBar: /* @__PURE__ */ jsx(IndexBar, {
				letters,
				itemRefs: toolRefs,
...
var tools_default = memo(Tools);
//#endregion
//#region app/components/workflow/block-selector/featured-tools.tsx
var MAX_RECOMMENDED_COUNT = 15;
var INITIAL_VISIBLE_COUNT = 5;
var STORAGE_KEY$1 = "workflow_tools_featured_collapsed";
var FeaturedTools = ({ plugins, providerMap, onSelect, selectedTools, isLoading = false, onInstallSuccess }) => {
	const { t } = useTranslation();
	const language = useGetLanguage();
	const [visibleCount, setVisibleCount] = useState(INITIAL_VISIBLE_COUNT);
	const [isCollapsed, setIsCollapsed] = useState(() => {
		if (isServer) return false;
		return window.localStorage.getItem(STORAGE_KEY$1) === "true";
	});
	useEffect(() => {
		if (isServer) return;
	...
	useEffect(() => {
		if (isServer) return;
		window.localStorage.setItem(STORAGE_KEY$1, String(isCollapsed));
	}, [isCollapsed]);
	useEffect(() => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("button", {
			...
			}), /* @__PURE__ */ jsx(Icon$3, { className: `ml-0.5 h-4 w-4 text-text-tertiary transition-transform ${isCollapsed ? "-rotate-90" : "rotate-0"}` })]
			...
			showEmptyState && /* @__PURE__ */ jsx("p", {
				...
				children: /* @__PURE__ */ jsx(Link, {
					...
					children: t("tabs.noFeaturedPlugins", { ns: "workflow" })
				})
			}),
			!showEmptyState && !isLoading && /* @__PURE__ */ jsxs(Fragment$1, { children: [visibleInstalledProviders.length > 0 && /* @__PURE__ */ jsx(tools_default, {
				className: "p-0",
				...
				children: visibleUninstalledPlugins.map((plugin) => /* @__PURE__ */ jsx(FeaturedToolUninstalledItem, {
					plugin,
					language,
			...
			!isLoading && totalVisible > 0 && canToggleVisibility && /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsx(lH, { className: "size-4 group-hover:hidden" }), isExpanded ? /* @__PURE__ */ jsx(Icon$2, { className: "hidden size-4 group-hover:block" }) : /* @__PURE__ */ jsx(Icon$4, { className: "hidden size-4 group-hover:block" })]
				}), /* @__PURE__ */ jsx("div", {
...
function FeaturedToolUninstalledItem({ plugin, language, onInstallSuccess, t }) {
...
//#endregion
//#region app/components/workflow/block-selector/rag-tool-recommendations/uninstalled-item.tsx
var UninstalledItem = ({ payload }) => {
	const { t } = useTranslation();
	const locale = useLocale();
	const getLocalizedText = (obj) => obj?.[locale] || obj?.["en-US"] || obj?.en_US || "";
	const [isShowInstallModal, { setTrue: showInstallModal, setFalse: hideInstallModal }] = useBoolean(false);
	return /* @__PURE__ */ jsxs("div", {
		className: "flex h-8 items-center rounded-lg pl-3 pr-2 hover:bg-state-base-hover",
		children: [/* @__PURE__ */ jsx(block_icon_default, {
			className: "shrink-0",
			type: BlockEnum.Tool,
			toolIcon: payload.icon
		}), /* @__PURE__ */ jsxs("div", {
			className: "ml-2 flex w-0 grow items-center",
			children: [
				/* @__PURE__ */ jsxs("div", {
					className: "flex w-0 grow items-center gap-x-2",
					children: [/* @__PURE__ */ jsx("span", {
						className: "system-sm-regular truncate text-text-primary",
						children: getLocalizedText(payload.label)
					}), /* @__PURE__ */ jsx("span", {
						className: "system-xs-regular text-text-quaternary",
						children: payload.org
					})]
				}),
				/* @__PURE__ */ jsx("div", {
...
var uninstalled_item_default = React$1.memo(UninstalledItem);
//#endregion
//#region app/components/workflow/block-selector/rag-tool-recommendations/list.tsx
var List = ({ onSelect, tools, viewType, unInstalledPlugins, className }) => {
	const language = useGetLanguage();
	const isFlatView = viewType === ViewType.flat;
	const { letters, groups: withLetterAndGroupViewToolsData } = groupItems(tools, (tool) => tool.label[language][0]);
	const treeViewToolsData = useMemo(() => {
	...
	const toolRefs = useRef({});
	const handleSelect = useCallback((type, tool) => {
		onSelect(type, tool);
	}, [onSelect]);
	return /* @__PURE__ */ jsxs("div", {
		className: cn("max-w-[100%] p-1", className),
		children: [!!tools.length && (isFlatView ? /* @__PURE__ */ jsx(list_default$1, {
			toolRefs,
			letters,
			payload: listViewToolData,
			...
			return /* @__PURE__ */ jsx(uninstalled_item_default, { payload: item }, item.plugin_id);
		})]
	});
};
//#endregion
//#region app/components/workflow/block-selector/rag-tool-recommendations/index.tsx
var STORAGE_KEY = "workflow_rag_recommendations_collapsed";
var RAGToolRecommendations = ({ viewType, onSelect, onTagsChange }) => {
	const { t } = useTranslation();
	const [isCollapsed, setIsCollapsed] = useState(() => {
		if (isServer) return false;
	...
	const { data: ragRecommendedPlugins, isLoading: isLoadingRAGRecommendedPlugins, isFetching: isFetchingRAGRecommendedPlugins } = useRAGRecommendedPlugins("tool");
	...
	const unInstalledPlugins = useMemo(() => {
		if (ragRecommendedPlugins) return ragRecommendedPlugins.uninstalled_recommended_plugins.map(getFormattedPlugin);
		return [];
	}, [ragRecommendedPlugins]);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("button", {
			...
			children: [/* @__PURE__ */ jsx("span", {
				className: "system-xs-medium text-text-tertiary",
				children: t("ragToolSuggestions.title", { ns: "pipeline" })
			}), /* @__PURE__ */ jsx(Icon$3, { className: `ml-1 h-4 w-4 text-text-tertiary transition-transform ${isCollapsed ? "-rotate-90" : "rotate-0"}` })]
		}), !isCollapsed && /* @__PURE__ */ jsxs(Fragment$1, { children: [
			isLoadingRAGRecommendedPlugins && /* @__PURE__ */ jsx("div", {
				className: "py-2",
				children: /* @__PURE__ */ jsx(Loading, { type: "app" })
			}),
			!isFetchingRAGRecommendedPlugins && recommendedPlugins.length === 0 && unInstalledPlugins.length === 0 && /* @__PURE__ */ jsx("p", {
				className: "system-xs-regular px-3 py-1 text-text-tertiary",
				children: /* @__PURE__ */ jsx(Trans, {
					i18nKey: "ragToolSuggestions.noRecommendationPlugins",
					ns: "pipeline",
					components: { CustomLink: /* @__PURE__ */ jsx(Link, {
						className: "text-text-accent",
						target: "_blank",
						rel: "noopener noreferrer",
			...
			(recommendedPlugins.length > 0 || unInstalledPlugins.length > 0) && /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx(List, {
				...
				children: [/* @__PURE__ */ jsx("div", {
					className: "px-1",
					children: /* @__PURE__ */ jsx(lH, { className: "size-4 text-text-tertiary" })
				}), /* @__PURE__ */ jsx("div", {
					className: "system-xs-regular text-text-tertiary",
					children: t("operation.more", { ns: "common" })
				})]
			})] })
		] })]
	});
};
var rag_tool_recommendations_default = React$1.memo(RAGToolRecommendations);
//#endregion
//#region app/components/workflow/block-selector/all-tools.tsx
...
var DEFAULT_TAGS = [];
var AllTools = ({ className, toolContentClassName, searchText, tags = DEFAULT_TAGS, onSelect, canNotSelectMultiple, onSelectMultiple, buildInTools, workflowTools, customTools, mcpTools = [], selectedTools, onTagsChange, isInRAGPipeline = false, featuredPlugins = [], featuredLoading = false, showFeatured = false, onFeaturedInstallSuccess }) => {
	const { t } = useTranslation();
	const language = useGetLanguage();
	const tabs = useToolTabs();
	const [activeTab, setActiveTab] = useState(ToolTypeEnum.All);
	const [activeView, setActiveView] = useState(ViewType.flat);
	...
	const tools = useMemo(() => {
		let mergedTools = [];
		if (activeTab === ToolTypeEnum.All) mergedTools = [
			...buildInTools,
			...customTools,
			...workflowTools,
			...mcpTools
		...
		if (!hasFilter || !normalizedSearch) return mergedTools.filter((toolWithProvider) => toolWithProvider.tools.length > 0);
		return mergedTools.reduce((acc, toolWithProvider) => {
			const providerLabel = getLocalizedText(toolWithProvider.label);
			if ([toolWithProvider.name, providerLabel].some((text) => isMatchingKeywords(text || "", normalizedSearch))) {
			...
			const matchedTools = toolWithProvider.tools.filter((tool) => {
				...
				return [tool.name, toolLabel].some((text) => isMatchingKeywords(text || "", normalizedSearch));
			});
			if (matchedTools.length > 0) acc.push({
				...toolWithProvider,
				tools: matchedTools
			});
			return acc;
	...
	const shouldShowFeatured = showFeatured && enable_marketplace && !isInRAGPipeline && activeTab === ToolTypeEnum.All && !hasFilter;
	const shouldShowMarketplaceFooter = enable_marketplace && !hasFilter;
	const handleRAGSelect = useCallback((type, pluginDefaultValue) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			className: "flex items-center justify-between border-b border-divider-subtle px-3",
			children: [/* @__PURE__ */ jsx("div", {
				className: "flex h-8 items-center space-x-1",
				children: tabs.map((tab) => /* @__PURE__ */ jsx("div", {
					className: cn("flex h-6 cursor-pointer items-center rounded-md px-2 hover:bg-state-base-hover", "text-xs font-medium text-text-secondary", activeTab === tab.key && "bg-state-base-hover-alt"),
					onClick: () => setActiveTab(tab.key),
					children: tab.name
				}, tab.key))
			}), isSupportGroupView && /* @__PURE__ */ jsx(view_type_select_default, {
				viewType: activeView,
				onChange: setActiveView
			})]
		}), /* @__PURE__ */ jsxs("div", {
			className: "flex max-h-[464px] flex-col",
			children: [/* @__PURE__ */ jsxs("div", {
				ref: wrapElemRef,
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: [
						isShowRAGRecommendations && onTagsChange && /* @__PURE__ */ jsx(rag_tool_recommendations_default, {
							viewType: isSupportGroupView ? activeView : ViewType.flat,
							onSelect: handleRAGSelect,
							onTagsChange
						}),
						shouldShowFeatured && /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx(FeaturedTools, {
						...
						hasToolsListContent && /* @__PURE__ */ jsxs(Fragment$1, { children: [/* @__PURE__ */ jsx("div", {
							className: "px-3 pb-1 pt-2",
							children: /* @__PURE__ */ jsx("span", {
								className: "system-xs-medium text-text-primary",
								children: t("allTools", { ns: "tools" })
							})
						}), /* @__PURE__ */ jsx(tools_default, {
						...
						enable_marketplace && /* @__PURE__ */ jsx(List$1, {
							ref: pluginRef,
							wrapElemRef,
					...
					children: [
						/* @__PURE__ */ jsx(Icon$7, { className: "h-8 w-8 text-text-quaternary" }),
						/* @__PURE__ */ jsx("div", {
			...
			}), shouldShowMarketplaceFooter && /* @__PURE__ */ jsxs(Link, {
...
//#endregion
export { BLOCK_CLASSIFICATIONS as _, useMCPToolAvailability as a, START_BLOCKS as b, Empty as c, action_default as d, Icon$2 as f, useTabs as g, useBlocks as h, MCPToolAvailabilityProvider as i, List$1 as l, Icon$4 as m, tools_default as n, ViewType as o, Icon$3 as p, mcp_tool_not_support_tooltip_default as r, view_type_select_default as s, AllTools as t, require_throttle as u, DEFAULT_FILE_EXTENSIONS_IN_LOCAL_FILE_DATA_SOURCE as v, SearchBox as x, ENTRY_NODE_TYPES as y };
