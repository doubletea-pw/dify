...
var common_default = {
	...
	"account.changeEmail.codePlaceholder": "Pegue el código de 6 dígitos",
	"account.changeEmail.content1": "Si continúas, enviaremos un código de verificación a <email>{{email}}</email> para la reautenticación.",
	"account.changeEmail.content2": "Tu correo electrónico actual es <email>{{email}}</email>. Se ha enviado un código de verificación a esta dirección de correo electrónico.",
	"account.changeEmail.content3": "Introduce un nuevo correo electrónico y te enviaremos un código de verificación.",
	"account.changeEmail.content4": "Acabamos de enviarte un código de verificación temporal a <email>{{email}}</email>.",
	"account.changeEmail.continue": "Continuar",
	"account.changeEmail.emailLabel": "Nuevo correo electrónico",
	"account.changeEmail.emailPlaceholder": "Introduce un nuevo correo electrónico",
	"account.changeEmail.existingEmail": "Ya existe un usuario con este correo electrónico.",
	"account.changeEmail.newEmail": "Configura una nueva dirección de correo electrónico",
	"account.changeEmail.resend": "Reenviar",
	"account.changeEmail.resendCount": "Reenviar en {{count}}s",
	"account.changeEmail.resendTip": "¿No recibiste un código?",
	"account.changeEmail.sendVerifyCode": "Enviar código de verificación",
	"account.changeEmail.title": "Cambiar Correo Electrónico",
	"account.changeEmail.unAvailableEmail": "Este correo electrónico no está disponible temporalmente.",
	"account.changeEmail.verifyEmail": "Verifica tu correo electrónico actual",
	"account.changeEmail.verifyNew": "Verifica tu nuevo correo electrónico",
	"account.confirmPassword": "Confirmar contraseña",
	"account.currentPassword": "Contraseña actual",
	"account.delete": "Eliminar cuenta",
	"account.deleteLabel": "Para confirmar, escriba su correo electrónico a continuación",
	"account.deletePlaceholder": "Por favor, introduzca su correo electrónico",
	"account.deletePrivacyLink": "Política de privacidad.",
	"account.deletePrivacyLinkTip": "Para obtener más información sobre cómo manejamos sus datos, consulte nuestra",
	"account.deleteSuccessTip": "Su cuenta necesita tiempo para terminar de eliminarse. Te enviaremos un correo electrónico cuando todo esté listo.",
	"account.deleteTip": "Eliminar tu cuenta borrará permanentemente todos tus datos y no se podrán recuperar.",
	"account.editName": "Editar Nombre",
	"account.editWorkspaceInfo": "Editar información del espacio de trabajo",
	"account.email": "Correo electrónico",
	"account.feedbackLabel": "¿Cuéntanos por qué eliminaste tu cuenta?",
	"account.feedbackPlaceholder": "Opcional",
	"account.feedbackTitle": "Retroalimentación",
	"account.langGeniusAccount": "Cuenta Dify",
	"account.langGeniusAccountTip": "Tu cuenta Dify y los datos de usuario asociados.",
	"account.myAccount": "Mi Cuenta",
	"account.name": "Nombre",
	"account.newPassword": "Nueva contraseña",
	"account.notEqual": "Las dos contraseñas son diferentes.",
	"account.password": "Contraseña",
	"account.passwordTip": "Puedes establecer una contraseña permanente si no deseas usar códigos de inicio de sesión temporales",
	"account.permanentlyDeleteButton": "Eliminar cuenta de forma permanente",
	"account.resetPassword": "Restablecer contraseña",
	"account.sendVerificationButton": "Enviar código de verificación",
	"account.setPassword": "Establecer una contraseña",
	"account.showAppLength": "Mostrar {{length}} apps",
	"account.studio": "Estudio Dify",
	...
	"actionMsg.modifiedUnsuccessfully": "Modificación no exitosa",
	"actionMsg.noModification": "No hay modificaciones en este momento.",
	"actionMsg.payCancelled": "Pago cancelado",
	"actionMsg.paySucceeded": "Pago exitoso",
	...
	"api.saved": "Guardado",
	"api.success": "Éxito",
	"apiBasedExtension.add": "Agregar Extensión API",
	"apiBasedExtension.link": "Aprende cómo desarrollar tu propia Extensión API.",
	"apiBasedExtension.modal.apiEndpoint.placeholder": "Por favor ingresa el punto final de la API",
	"apiBasedExtension.modal.apiEndpoint.title": "Punto final de la API",
	"apiBasedExtension.modal.apiKey.lengthError": "La longitud de la clave API no puede ser menor a 5 caracteres",
	"apiBasedExtension.modal.apiKey.placeholder": "Por favor ingresa la clave API",
	"apiBasedExtension.modal.apiKey.title": "Clave API",
	"apiBasedExtension.modal.editTitle": "Editar Extensión API",
	"apiBasedExtension.modal.name.placeholder": "Por favor ingresa el nombre",
	"apiBasedExtension.modal.name.title": "Nombre",
	"apiBasedExtension.modal.title": "Agregar Extensión API",
	"apiBasedExtension.selector.manage": "Gestionar Extensión API",
	"apiBasedExtension.selector.placeholder": "Por favor selecciona extensión API",
	"apiBasedExtension.selector.title": "Extensión API",
	...
	"chat.citation.linkToDataset": "Enlace al Conocimiento",
	"chat.citation.title": "CITAS",
	"chat.citation.vectorHash": "Hash de vector:",
	"chat.conversationName": "Nombre de la conversación",
	"chat.conversationNameCanNotEmpty": "Nombre de la conversación requerido",
	"chat.conversationNamePlaceholder": "Por favor ingresa el nombre de la conversación",
	...
	"compliance.iso27001": "Certificación ISO 27001:2022",
	"compliance.professionalUpgradeTooltip": "Solo disponible con un plan de equipo o superior.",
	...
	"datasetMenus.viewDoc": "Ver documentación",
	"dynamicSelect.error": "Error al cargar las opciones",
	"dynamicSelect.loading": "Cargando opciones...",
	"dynamicSelect.noData": "No hay opciones disponibles",
	...
	"feedback.placeholder": "Por favor, describe qué salió mal o cómo podemos mejorar...",
	"feedback.subtitle": "Por favor, díganos qué salió mal con esta respuesta.",
	"feedback.title": "Proporcionar retroalimentación",
	"fileUploader.fileExtensionBlocked": "Este tipo de archivo está bloqueado por motivos de seguridad",
	"fileUploader.fileExtensionNotSupport": "Extensión de archivo no compatible",
	"fileUploader.pasteFileLink": "Pegar enlace de archivo",
	"fileUploader.pasteFileLinkInputPlaceholder": "Introduzca la URL...",
	...
	"imageUploader.pasteImageLinkInvalid": "Enlace de imagen inválido",
	"imageUploader.uploadFromComputer": "Cargar desde la Computadora",
	"imageUploader.uploadFromComputerLimit": "Las imágenes cargadas no pueden exceder {{size}} MB",
	...
	"members.emailPlaceholder": "Por favor ingresa correos electrónicos",
	"members.failedInvitationEmails": "Los siguientes usuarios no fueron invitados exitosamente",
	"members.invitationLink": "Enlace de invitación",
	"members.invitationSent": "Invitación enviada",
	"members.invitationSentTip": "Invitación enviada, y pueden iniciar sesión en Dify para acceder a tus datos del equipo.",
	"members.invite": "Agregar",
	"members.inviteTeamMember": "Agregar miembro del equipo",
	...
	"members.transferModal.resendCount": "Reenviar en {{count}}s",
	"members.transferModal.resendTip": "¿No recibiste un código?",
	"members.transferModal.sendTip": "Si continúas, enviaremos un código de verificación a <email>{{email}}</email> para la reautenticación.",
	"members.transferModal.sendVerifyCode": "Enviar código de verificación",
	"members.transferModal.title": "Transferir la propiedad del espacio de trabajo",
	"members.transferModal.transfer": "Transferir la propiedad del espacio de trabajo",
	"members.transferModal.transferLabel": "Transferir la propiedad del espacio de trabajo a",
	"members.transferModal.transferPlaceholder": "Selecciona un miembro del espacio de trabajo...",
	"members.transferModal.verifyContent": "Tu correo electrónico actual es <email>{{email}}</email>.",
	"members.transferModal.verifyContent2": "Enviaremos un código de verificación temporal a este correo electrónico para la re-autenticación.",
	"members.transferModal.verifyEmail": "Verifica tu correo electrónico actual",
	"members.transferModal.warning": "Estás a punto de transferir la propiedad de “{{workspace}}”. Esto tendrá efecto inmediato y no se puede deshacer.",
	"members.transferModal.warningTip": "Te convertirás en un miembro administrador, y el nuevo propietario tendrá el control total.",
	"members.transferOwnership": "Transferir propiedad",
	"members.you": "(Tú)",
	"menus.account": "Cuenta",
	...
	"menus.pluginsTips": "Integrar plugins de terceros o crear Plugins AI compatibles con ChatGPT.",
	"menus.status": "beta",
	...
	"modelProvider.auth.addCredential": "Agregar credencial",
	"modelProvider.auth.addModel": "Agregar modelo",
	...
	"modelProvider.auth.authRemoved": "Autorización retirada",
	...
	"modelProvider.auth.manageCredentials": "Administrar credenciales",
	"modelProvider.auth.modelCredential": "Credencial modelo",
	"modelProvider.auth.modelCredentials": "Credenciales del modelo",
	"modelProvider.auth.providerManaged": "Proveedor gestionado",
	"modelProvider.auth.providerManagedTip": "La configuración actual es hospedada por el proveedor.",
	"modelProvider.auth.removeModel": "Eliminar modelo",
	...
	"modelProvider.emptyProviderTip": "Instale primero un proveedor de modelos.",
	"modelProvider.emptyProviderTitle": "Proveedor de modelos no configurado",
	...
	"operation.close": "Cerrar",
	"operation.config": "Config",
	"operation.confirm": "Confirmar",
	"operation.confirmAction": "Por favor, confirme su acción.",
	...
	"tag.placeholder": "Todas las Etiquetas",
	...
	"voice.language.enUS": "Inglés",
	"voice.language.esES": "Español",
	"voice.language.faIR": "Persa",
	"voice.language.frFR": "Francés",
	"voice.language.hiIN": "Hindi",
	"voice.language.idID": "Indonesio",
	"voice.language.itIT": "Italiano",
	"voice.language.jaJP": "Japonés",
	"voice.language.koKR": "Coreano",
	"voice.language.plPL": "Polaco",
	"voice.language.ptBR": "Portugués",
	"voice.language.roRO": "Rumano",
	"voice.language.ruRU": "Ruso",
	"voice.language.slSI": "Esloveno",
	"voice.language.thTH": "Tailandés",
	"voice.language.trTR": "Turco",
	"voice.language.ukUA": "Ucraniano",
	"voice.language.viVN": "Vietnamita",
	"voice.language.zhHans": "Chino",
	"voice.language.zhHant": "Chino Tradicional",
