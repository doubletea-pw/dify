//#region i18n/it-IT/app-debug.json
var autoAddVar = "Le variabili non definite riferite nel pre-prompt, vuoi aggiungerle nel modulo di input dell'utente?";
var chatSubTitle = "Istruzioni";
var completionSubTitle = "Prompt di prefisso";
var debugAsMultipleModel = "Debug come modelli multipli";
var debugAsSingleModel = "Debug come modello singolo";
var duplicateModel = "Duplica";
var formattingChangedText = "Modificare il formato resetterà l'area di debug, sei sicuro?";
var formattingChangedTitle = "Formato modificato";
var noResult = "L'output verrà visualizzato qui.";
var notSetVar = "Le variabili consentono agli utenti di introdurre parole del prompt o osservazioni di apertura quando compilano i moduli. Puoi provare a inserire `{{input}}` nelle parole del prompt.";
var orchestrate = "Orchestra";
var promptTip = "I prompt guidano le risposte dell'IA con istruzioni e vincoli. Inserisci variabili come {{input}}. Questo prompt non sarà visibile agli utenti.";
var publishAs = "Pubblica come";
var result = "Testo di output";
var variableTip = "Gli utenti riempiono le variabili in un modulo, sostituendo automaticamente le variabili nel prompt.";
var variableTitle = "Variabili";
