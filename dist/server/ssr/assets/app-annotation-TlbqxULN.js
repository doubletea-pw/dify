//#region i18n/ar-TN/app-annotation.json
var editBy = "تم تعديل الإجابة بواسطة {{author}}";
var embeddingModelSwitchTip = "سيؤدي تبديل نموذج التضمين للنص التوضيحي إلى إعادة التضمين، مما يؤدي إلى تكاليف إضافية.";
var name = "رد التعليق التوضيحي";
var title = "التعليقات التوضيحية";
