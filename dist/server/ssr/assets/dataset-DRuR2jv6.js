//#region i18n/ar-TN/dataset.json
var allExternalTip = "عند استخدام المعرفة الخارجية فقط، يمكن للمستخدم اختيار ما إذا كان سيمكن نموذج إعادة الترتيب. إذا لم يتم تمكينه، فسيتم فرز القطع المسترجعة بناءً على الدرجات. عندما تكون استراتيجيات الاسترجاع لقواعد المعرفة المختلفة غير متسقة، فستكون غير دقيقة.";
var allKnowledge = "كل المعرفة";
var allKnowledgeDescription = "حدد لعرض كل المعرفة في مساحة العمل هذه. يمكن لمالك مساحة العمل فقط إدارة كل المعرفة.";
var appCount = " تطبيقات مرتبطة";
var connectDataset = "الاتصال بقاعدة معرفة خارجية";
var createDataset = "إنشاء المعرفة";
var createDatasetIntro = "استيراد بيانات النص الخاصة بك أو كتابة البيانات في الوقت الفعلي عبر Webhook لتحسين سياق LLM.";
var createExternalAPI = "إضافة واجهة برمجة تطبيقات معرفة خارجية";
var createFromPipeline = "إنشاء من سير عمل المعرفة";
var createNewExternalAPI = "إنشاء واجهة برمجة تطبيقات معرفة خارجية جديدة";
var datasetDeleteFailed = "فشل حذف المعرفة";
var datasetDeleted = "تم حذف المعرفة";
var datasetUsedByApp = "يتم استخدام المعرفة بواسطة بعض التطبيقات. لن تتمكن التطبيقات بعد الآن من استخدام هذه المعرفة، وسيتم حذف جميع تكوينات الموجه والسجلات بشكل دائم.";
var datasets = "المعرفة";
var datasetsApi = "الوصول إلى API";
var defaultRetrievalTip = "يستخدم الاسترجاع متعدد المسارات افتراضيًا. يتم استرجاع المعرفة من قواعد معرفة متعددة ثم إعادة ترتيبها.";
var deleteDatasetConfirmContent = "حذف المعرفة لا رجعة فيه. لن يتمكن المستخدمون بعد الآن من الوصول إلى معرفتك، وسيتم حذف جميع تكوينات الموجه والسجلات بشكل دائم.";
var deleteDatasetConfirmTitle = "حذف هذه المعرفة؟";
var didYouKnow = "هل تعلم؟";
var docAllEnabled_one = "{{count}} مستند ممكن";
var docAllEnabled_other = "تم تمكين جميع المستندات البالغ عددها {{count}}";
var docsFailedNotice = "فشل فهرسة المستندات";
var documentCount = " مستندات";
var documentsDisabled = "{{num}} مستندات معطلة - غير نشطة لأكثر من 30 يومًا";
var editExternalAPIFormTitle = "تعديل واجهة برمجة تطبيقات المعرفة الخارجية";
var editExternalAPITooltipTitle = "المعرفة المرتبطة";
var embeddingModelNotAvailable = "نموذج التضمين غير متوفر.";
var enable = "تمكين";
var externalAPI = "واجهة برمجة تطبيقات خارجية";
var externalAPIPanelDescription = "تُستخدم واجهة برمجة تطبيقات المعرفة الخارجية للاتصال بقاعدة معرفة خارج Dify واسترجاع المعرفة من قاعدة المعرفة تلك.";
var externalAPIPanelDocumentation = "تعرف على كيفية إنشاء واجهة برمجة تطبيقات المعرفة الخارجية";
var externalAPIPanelTitle = "واجهة برمجة تطبيقات المعرفة الخارجية";
var externalKnowledgeBase = "قاعدة المعرفة الخارجية";
var externalKnowledgeDescription = "وصف المعرفة";
var externalKnowledgeDescriptionPlaceholder = "صف ما يوجد في قاعدة المعرفة هذه (اختياري)";
var externalKnowledgeId = "معرف المعرفة الخارجية";
var externalKnowledgeIdPlaceholder = "يرجى إدخال معرف المعرفة";
var externalKnowledgeName = "اسم المعرفة الخارجية";
var externalKnowledgeNamePlaceholder = "يرجى إدخال اسم قاعدة المعرفة";
var externalTag = "خارجي";
var inconsistentEmbeddingModelTip = "مطلوب نموذج إعادة الترتيب إذا كانت نماذج التضمين لقواعد المعرفة المختارة غير متسقة.";
var intro1 = "يمكن دمج المعرفة في تطبيق Dify ";
var intro2 = "كسياق";
var intro3 = "،";
var intro4 = "أو ";
var intro5 = "يمكن نشرها";
var intro6 = " كخدمة مستقلة.";
var knowledge = "المعرفة";
var learnHowToWriteGoodKnowledgeDescription = "تعرف على كيفية كتابة وصف جيد للمعرفة";
var localDocs = "مستندات محلية";
var mixtureHighQualityAndEconomicTip = "مطلوب نموذج إعادة الترتيب لخلط قواعد المعرفة عالية الجودة والاقتصادية.";
var mixtureInternalAndExternalTip = "مطلوب نموذج إعادة الترتيب لخلط المعرفة الداخلية والخارجية.";
var multimodal = "متعدد الوسائط";
var nTo1RetrievalLegacy = "سيتم إيقاف الاسترجاع من N إلى 1 رسميًا اعتبارًا من سبتمبر. يوصى باستخدام أحدث استرجاع متعدد المسارات للحصول على نتائج أفضل. ";
var nTo1RetrievalLegacyLink = "تعرف على المزيد";
var nTo1RetrievalLegacyLinkText = " سيتم إيقاف الاسترجاع من N إلى 1 رسميًا في سبتمبر.";
var noExternalKnowledge = "لا توجد واجهة برمجة تطبيقات معرفة خارجية حتى الآن، انقر هنا لإنشاء";
var partialEnabled_one = "إجمالي {{count}} مستند، {{num}} متاح";
var partialEnabled_other = "إجمالي {{count}} مستندات، {{num}} متاح";
var preprocessDocument = "{{num}} معالجة المستندات مسبقًا";
var rerankSettings = "إعداد إعادة الترتيب";
var retrievalSettings = "إعداد الاسترجاع";
var retry = "إعادة المحاولة";
var unavailable = "غير متاح";
var unknownError = "خطأ غير معروف";
var updated = "محدث";
var wordCount = " ألف كلمة";
var dataset_default = {
	allExternalTip,
	allKnowledge,
	...
	"externalKnowledgeForm.connectedFailed": "فشل الاتصال بقاعدة المعرفة الخارجية",
	"externalKnowledgeForm.connectedSuccess": "تم الاتصال بقاعدة المعرفة الخارجية بنجاح",
	externalKnowledgeId,
