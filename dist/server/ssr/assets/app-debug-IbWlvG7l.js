//#region i18n/ar-TN/app-debug.json
var autoAddVar = "المتغيرات غير المحددة المشار إليها في ما قبل المطالبة، هل ترغب في إضافتها في نموذج إدخال المستخدم؟";
var chatSubTitle = "تعليمات";
var completionSubTitle = "مقدمة المطالبة";
var debugAsMultipleModel = "تصحيح كنماذج متعددة";
var debugAsSingleModel = "تصحيح كنموذج واحد";
var duplicateModel = "تكرار";
var formattingChangedText = "سيؤدي تعديل التنسيق إلى إعادة تعيين منطقة التصحيح، هل أنت متأكد؟";
var formattingChangedTitle = "تغيير التنسيق";
var noResult = "سيتم عرض الإخراج هنا.";
var notSetVar = "تسمح المتغيرات للمستخدمين بتقديم كلمات مطالبة أو ملاحظات افتتاحية عند ملء النماذج. يمكنك محاولة إدخال \"{{input}}\" في كلمات المطالبة.";
var orchestrate = "تنسيق";
var promptTip = "توجه المطالبات استجابات الذكاء الاصطناعي بالتعليمات والقيود. أدرج متغيرات مثل {{input}}. لن تكون هذه المطالبة مرئية للمستخدمين.";
var publishAs = "نشر كـ";
var result = "نص الإخراج";
var variableTip = "يملأ المستخدمون المتغيرات في نموذج، ويستبدلون المتغيرات تلقائيًا في المطالبة.";
var variableTitle = "المتغيرات";
