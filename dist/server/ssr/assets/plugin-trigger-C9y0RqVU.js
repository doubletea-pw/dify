//#region i18n/es-ES/plugin-trigger.json
var plugin_trigger_default = {
	...
	"modal.oauth.title": "Crear con OAuth",
	"modal.oauthRedirectInfo": "Dado que no se encontraron secretos de cliente del sistema para este proveedor de herramientas, es necesario configurarlo manualmente; para redirect_uri, por favor use",
	...
	"subscription.list.item.actions.deleteConfirm.confirmInputWarning": "Por favor, ingrese el nombre correcto para confirmar.",
	"subscription.list.item.actions.deleteConfirm.content": "Una vez eliminada, esta suscripción no se puede recuperar. Por favor, confirme.",
	"subscription.list.item.actions.deleteConfirm.contentWithApps": "La suscripción actual está referenciada por {{count}} aplicaciones. Eliminarla hará que las aplicaciones configuradas dejen de recibir eventos de suscripción.",
