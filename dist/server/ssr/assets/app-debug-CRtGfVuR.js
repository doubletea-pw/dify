//#region i18n/tr-TR/app-debug.json
var autoAddVar = "Ön promptta referans verilen tanımlanmamış değişkenler, kullanıcı giriş formunda eklemek istiyor musunuz?";
var chatSubTitle = "Talimatlar";
var completionSubTitle = "Ön Prompt";
var debugAsMultipleModel = "Çoklu Model Olarak Hata Ayıkla";
var debugAsSingleModel = "Tek Model Olarak Hata Ayıkla";
var duplicateModel = "Çoğalt";
var formattingChangedText = "Biçimlendirmeyi değiştirmek hata ayıklama alanını sıfırlayacaktır, emin misiniz?";
var formattingChangedTitle = "Biçimlendirme değiştirildi";
var manageModels = "Modelleri yönet";
var noModelProviderConfigured = "Yapılandırılmış model sağlayıcı yok";
var noModelProviderConfiguredTip = "Başlamak için bir model sağlayıcı yükleyin veya yapılandırın.";
var noModelSelected = "Model seçilmedi";
var noModelSelectedTip = "Devam etmek için yukarıdan bir model yapılandırın.";
var noResult = "Çıktı burada görüntülenecektir.";
var notSetVar = "Değişkenler, kullanıcıların form doldururken prompt kelimelerini veya açılış ifadelerini getirmesine izin verir. Prompt kelimelerine \"{{input}}\" yazmayı deneyebilirsiniz.";
var orchestrate = "Düzenle";
var promptTip = "Promptlar, yapay zekayı talimatlar ve kısıtlamalarla yönlendirir. {{input}} gibi değişkenler ekleyin. Bu prompt, kullanıcılara görünmeyecek.";
var publishAs = "Olarak Yayınla";
var result = "Çıktı Metni";
var variableTip = "Kullanıcılar değişkenleri bir formda doldurur ve otomatik olarak prompt içinde değişkenler değiştirilir.";
var variableTitle = "Değişkenler";
