...
import { B as setAccDescription, C as getDiagramTitle, K as setupGraphViewbox, L as sanitizeText, V as setAccTitle, W as setDiagramTitle, _ as getAccDescription, a as clear, b as getConfig2, d as defaultConfig_default, v as getAccTitle, y as getConfig } from "./chunk-7R4GIKGN-BePrRbZt.js";
import { r as cleanAndMerge, s as getEdgeId } from "./chunk-GEFDOKGD-Bv_tAWdK.js";
import { t as selectSvgElement } from "./chunk-HHEYEP7N-BFwvZyBl.js";
import "./dist-Doh15-aH.js";
import { a as unknownIcon, i as registerIconPacks, n as createText, r as getIconSVG } from "./chunk-PU5JKC2W-C64b5AnD.js";
...
import { t as populateCommonDb } from "./chunk-4BX2VUAB-sqeJuE_L.js";
import { t as parse } from "./mermaid-parser.core-DC0q5KOL.js";
import { t as cytoscape$1 } from "./cytoscape.esm-Czo37f4P.js";
...
var require_layout_base = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function(modules) {
			...
			function __vite_rsc_require__(moduleId) {
				...
				modules[moduleId].call(module$19.exports, module$19, module$19.exports, __vite_rsc_require__);
				module$19.l = true;
				return module$19.exports;
			}
			__vite_rsc_require__.m = modules;
			__vite_rsc_require__.c = installedModules;
			__vite_rsc_require__.i = function(value) {
				return value;
			};
			__vite_rsc_require__.d = function(exports$1, name, getter) {
				if (!__vite_rsc_require__.o(exports$1, name)) Object.defineProperty(exports$1, name, {
					configurable: false,
					enumerable: true,
					get: getter
				});
			};
			__vite_rsc_require__.n = function(module$20) {
				var getter = module$20 && module$20.__esModule ? function getDefault() {
					return module$20["default"];
				} : function getModuleExports() {
					return module$20;
				};
				__vite_rsc_require__.d(getter, "a", getter);
				return getter;
			};
			__vite_rsc_require__.o = function(object, property) {
				return Object.prototype.hasOwnProperty.call(object, property);
			};
			__vite_rsc_require__.p = "";
			return __vite_rsc_require__(__vite_rsc_require__.s = 28);
		})([
			(function(module$21, exports$2, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$22, exports$3, __vite_rsc_require__) {
				"use strict";
				var LGraphObject = __vite_rsc_require__(2);
				var IGeometry = __vite_rsc_require__(8);
				var IMath = __vite_rsc_require__(9);
			...
			(function(module$23, exports$4, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$24, exports$5, __vite_rsc_require__) {
				"use strict";
				var LGraphObject = __vite_rsc_require__(2);
				var Integer = __vite_rsc_require__(10);
				var RectangleD = __vite_rsc_require__(13);
				var LayoutConstants = __vite_rsc_require__(0);
				var RandomSeed = __vite_rsc_require__(16);
				var PointD = __vite_rsc_require__(5);
			...
			(function(module$25, exports$6, __vite_rsc_require__) {
				"use strict";
				var LayoutConstants = __vite_rsc_require__(0);
			...
			(function(module$26, exports$7, __vite_rsc_require__) {
				"use strict";
				function PointD(x, y) {
					if (x == null && y == null) {
						this.x = 0;
			...
			(function(module$27, exports$8, __vite_rsc_require__) {
				"use strict";
				var LGraphObject = __vite_rsc_require__(2);
				var Integer = __vite_rsc_require__(10);
				var LayoutConstants = __vite_rsc_require__(0);
				var LGraphManager = __vite_rsc_require__(7);
				var LNode = __vite_rsc_require__(3);
				var LEdge = __vite_rsc_require__(1);
				var RectangleD = __vite_rsc_require__(13);
				var Point = __vite_rsc_require__(12);
				var LinkedList = __vite_rsc_require__(11);
			...
			(function(module$28, exports$9, __vite_rsc_require__) {
				"use strict";
				var LGraph;
				var LEdge = __vite_rsc_require__(1);
				function LGraphManager(layout) {
					LGraph = __vite_rsc_require__(6);
					this.layout = layout;
					this.graphs = [];
					this.edges = [];
				}
			...
			(function(module$29, exports$10, __vite_rsc_require__) {
				"use strict";
				/**
			...
			(function(module$30, exports$11, __vite_rsc_require__) {
				"use strict";
				function IMath() {}
				/**
			...
			(function(module$31, exports$12, __vite_rsc_require__) {
				"use strict";
				function Integer() {}
			...
			(function(module$32, exports$13, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$33, exports$14, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$34, exports$15, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$35, exports$16, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$36, exports$17, __vite_rsc_require__) {
				"use strict";
				...
				var LNode = __vite_rsc_require__(3);
				var LEdge = __vite_rsc_require__(1);
				var LGraph = __vite_rsc_require__(6);
				var PointD = __vite_rsc_require__(5);
				var Transform = __vite_rsc_require__(17);
				var Emitter = __vite_rsc_require__(29);
			...
			(function(module$37, exports$18, __vite_rsc_require__) {
				"use strict";
				function RandomSeed() {}
				RandomSeed.seed = 1;
				RandomSeed.x = 0;
			...
			(function(module$38, exports$19, __vite_rsc_require__) {
				"use strict";
				var PointD = __vite_rsc_require__(5);
			...
			(function(module$39, exports$20, __vite_rsc_require__) {
				"use strict";
				function _toConsumableArray(arr) {
					if (Array.isArray(arr)) {
						for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) arr2[i] = arr[i];
				...
				var Layout = __vite_rsc_require__(15);
				var FDLayoutConstants = __vite_rsc_require__(4);
				var LayoutConstants = __vite_rsc_require__(0);
				var IGeometry = __vite_rsc_require__(8);
				var IMath = __vite_rsc_require__(9);
				function FDLayout() {
			...
			(function(module$40, exports$21, __vite_rsc_require__) {
				"use strict";
				var LEdge = __vite_rsc_require__(1);
				var FDLayoutConstants = __vite_rsc_require__(4);
			...
			(function(module$41, exports$22, __vite_rsc_require__) {
				"use strict";
				var LNode = __vite_rsc_require__(3);
				var FDLayoutConstants = __vite_rsc_require__(4);
			...
			(function(module$42, exports$23, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$43, exports$24, __vite_rsc_require__) {
				"use strict";
				var UniqueIDGeneretor = __vite_rsc_require__(14);
				function HashMap() {
					this.map = {};
					this.keys = [];
				}
			...
			(function(module$44, exports$25, __vite_rsc_require__) {
				"use strict";
				var UniqueIDGeneretor = __vite_rsc_require__(14);
				function HashSet() {
					this.set = {};
			...
			(function(module$45, exports$26, __vite_rsc_require__) {
				"use strict";
				function Matrix() {}
				/**
			...
			(function(module$46, exports$27, __vite_rsc_require__) {
				"use strict";
				var _createClass = function() {
					function defineProperties(target, props) {
						for (var i = 0; i < props.length; i++) {
			...
			(function(module$47, exports$28, __vite_rsc_require__) {
				"use strict";
				function SVD() {}
				SVD.svd = function(A) {
					this.U = null;
			...
			(function(module$48, exports$29, __vite_rsc_require__) {
				"use strict";
				var _createClass = function() {
					function defineProperties(target, props) {
						for (var i = 0; i < props.length; i++) {
			...
			(function(module$49, exports$30, __vite_rsc_require__) {
				"use strict";
				var layoutBase = function layoutBase() {};
				layoutBase.FDLayout = __vite_rsc_require__(18);
				layoutBase.FDLayoutConstants = __vite_rsc_require__(4);
				layoutBase.FDLayoutEdge = __vite_rsc_require__(19);
				layoutBase.FDLayoutNode = __vite_rsc_require__(20);
				layoutBase.DimensionD = __vite_rsc_require__(21);
				layoutBase.HashMap = __vite_rsc_require__(22);
				layoutBase.HashSet = __vite_rsc_require__(23);
				layoutBase.IGeometry = __vite_rsc_require__(8);
				layoutBase.IMath = __vite_rsc_require__(9);
				layoutBase.Integer = __vite_rsc_require__(10);
				layoutBase.Point = __vite_rsc_require__(12);
				layoutBase.PointD = __vite_rsc_require__(5);
				layoutBase.RandomSeed = __vite_rsc_require__(16);
				layoutBase.RectangleD = __vite_rsc_require__(13);
				layoutBase.Transform = __vite_rsc_require__(17);
				layoutBase.UniqueIDGeneretor = __vite_rsc_require__(14);
				layoutBase.Quicksort = __vite_rsc_require__(25);
				layoutBase.LinkedList = __vite_rsc_require__(11);
				layoutBase.LGraphObject = __vite_rsc_require__(2);
				layoutBase.LGraph = __vite_rsc_require__(6);
				layoutBase.LEdge = __vite_rsc_require__(1);
				layoutBase.LGraphManager = __vite_rsc_require__(7);
				layoutBase.LNode = __vite_rsc_require__(3);
				layoutBase.Layout = __vite_rsc_require__(15);
				layoutBase.LayoutConstants = __vite_rsc_require__(0);
				layoutBase.NeedlemanWunsch = __vite_rsc_require__(27);
				layoutBase.Matrix = __vite_rsc_require__(24);
				layoutBase.SVD = __vite_rsc_require__(26);
				module$49.exports = layoutBase;
			}),
			(function(module$50, exports$31, __vite_rsc_require__) {
				"use strict";
				function Emitter() {
					this.listeners = [];
				}
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (() => {
			...
			var __webpack_modules__ = {
				45: ((module$9, __unused_webpack_exports, __vite_rsc_require__) => {
					var coseBase = {};
					coseBase.layoutBase = __vite_rsc_require__(551);
					coseBase.CoSEConstants = __vite_rsc_require__(806);
					coseBase.CoSEEdge = __vite_rsc_require__(767);
					coseBase.CoSEGraph = __vite_rsc_require__(880);
					coseBase.CoSEGraphManager = __vite_rsc_require__(578);
					coseBase.CoSELayout = __vite_rsc_require__(765);
					coseBase.CoSENode = __vite_rsc_require__(991);
					coseBase.ConstraintHandler = __vite_rsc_require__(902);
					module$9.exports = coseBase;
				}),
				806: ((module$10, __unused_webpack_exports, __vite_rsc_require__) => {
					var FDLayoutConstants = __vite_rsc_require__(551).FDLayoutConstants;
				...
				767: ((module$11, __unused_webpack_exports, __vite_rsc_require__) => {
					var FDLayoutEdge = __vite_rsc_require__(551).FDLayoutEdge;
				...
				880: ((module$12, __unused_webpack_exports, __vite_rsc_require__) => {
					var LGraph = __vite_rsc_require__(551).LGraph;
				...
				578: ((module$13, __unused_webpack_exports, __vite_rsc_require__) => {
					var LGraphManager = __vite_rsc_require__(551).LGraphManager;
				...
				765: ((module$14, __unused_webpack_exports, __vite_rsc_require__) => {
					var FDLayout = __vite_rsc_require__(551).FDLayout;
					var CoSEGraphManager = __vite_rsc_require__(578);
					var CoSEGraph = __vite_rsc_require__(880);
					var CoSENode = __vite_rsc_require__(991);
					var CoSEEdge = __vite_rsc_require__(767);
					var CoSEConstants = __vite_rsc_require__(806);
					var ConstraintHandler = __vite_rsc_require__(902);
					var FDLayoutConstants = __vite_rsc_require__(551).FDLayoutConstants;
					var LayoutConstants = __vite_rsc_require__(551).LayoutConstants;
					var Point = __vite_rsc_require__(551).Point;
					var PointD = __vite_rsc_require__(551).PointD;
					var DimensionD = __vite_rsc_require__(551).DimensionD;
					var Layout = __vite_rsc_require__(551).Layout;
					var Integer = __vite_rsc_require__(551).Integer;
					var IGeometry = __vite_rsc_require__(551).IGeometry;
					var LGraph = __vite_rsc_require__(551).LGraph;
					var Transform = __vite_rsc_require__(551).Transform;
					var LinkedList = __vite_rsc_require__(551).LinkedList;
					function CoSELayout() {
						FDLayout.call(this);
						this.toBeTiled = {};
						this.constraints = {};
				...
				991: ((module$15, __unused_webpack_exports, __vite_rsc_require__) => {
					var FDLayoutNode = __vite_rsc_require__(551).FDLayoutNode;
					var IMath = __vite_rsc_require__(551).IMath;
				...
				902: ((module$16, __unused_webpack_exports, __vite_rsc_require__) => {
					function _toConsumableArray(arr) {
						if (Array.isArray(arr)) {
							for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) arr2[i] = arr[i];
							return arr2;
					...
					var CoSEConstants = __vite_rsc_require__(806);
					var LinkedList = __vite_rsc_require__(551).LinkedList;
					var Matrix = __vite_rsc_require__(551).Matrix;
					var SVD = __vite_rsc_require__(551).SVD;
			...
			function __vite_rsc_require__(moduleId) {
				...
				__webpack_modules__[moduleId](module$18, module$18.exports, __vite_rsc_require__);
				return module$18.exports;
			}
			return __vite_rsc_require__(45);
		})();
	});
}));
//#endregion
//#region node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.core/architectureDiagram-2XIMDMQ5.mjs
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (() => {
			...
			var __webpack_modules__ = {
				...
				548: ((module$2, __unused_webpack_exports, __vite_rsc_require__) => {
					...
					var LinkedList = __vite_rsc_require__(140).layoutBase.LinkedList;
					var auxiliary = {};
				...
				816: ((module$3, __unused_webpack_exports, __vite_rsc_require__) => {
					/**
					The implementation of the postprocessing part that applies CoSE layout over the spectral layout
					*/
					var aux = __vite_rsc_require__(548);
					var CoSELayout = __vite_rsc_require__(140).CoSELayout;
					var CoSENode = __vite_rsc_require__(140).CoSENode;
					var PointD = __vite_rsc_require__(140).layoutBase.PointD;
					var DimensionD = __vite_rsc_require__(140).layoutBase.DimensionD;
					var LayoutConstants = __vite_rsc_require__(140).layoutBase.LayoutConstants;
					var FDLayoutConstants = __vite_rsc_require__(140).layoutBase.FDLayoutConstants;
					var CoSEConstants = __vite_rsc_require__(140).CoSEConstants;
				...
				212: ((module$4, __unused_webpack_exports, __vite_rsc_require__) => {
					var _createClass = function() {
						function defineProperties(target, props) {
							for (var i = 0; i < props.length; i++) {
								var descriptor = props[i];
					...
					*/
					var assign = __vite_rsc_require__(658);
					var aux = __vite_rsc_require__(548);
					var spectralLayout = __vite_rsc_require__(657).spectralLayout;
					var coseLayout = __vite_rsc_require__(816).coseLayout;
				...
				657: ((module$5, __unused_webpack_exports, __vite_rsc_require__) => {
					/**
					The implementation of the spectral layout that is the first part of the fcose layout algorithm
					*/
					var aux = __vite_rsc_require__(548);
					var Matrix = __vite_rsc_require__(140).layoutBase.Matrix;
					var SVD = __vite_rsc_require__(140).layoutBase.SVD;
				...
				579: ((module$6, __unused_webpack_exports, __vite_rsc_require__) => {
					var impl = __vite_rsc_require__(212);
			...
			function __vite_rsc_require__(moduleId) {
				...
				__webpack_modules__[moduleId](module$8, module$8.exports, __vite_rsc_require__);
				return module$8.exports;
			}
			return __vite_rsc_require__(579);
		})();
	});
})))(), 1);
