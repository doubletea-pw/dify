import { b as Ct } from "./react-D5xHzNYo.js";
...
//#region node_modules/.pnpm/ahooks@3.9.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/ahooks/es/useEventListener/index.js
...
//#endregion
//#region node_modules/.pnpm/ahooks@3.9.6_react-dom@19.2.4_react@19.2.4__react@19.2.4/node_modules/ahooks/es/useHover/index.js
...
//#endregion
//#region node_modules/.pnpm/emoji-mart@5.6.0/node_modules/emoji-mart/dist/module.js
...
//#endregion
//#region app/components/base/app-icon/index.tsx
$7adb23b0109cc36a$export$2cd8252107eb640b({ data: native_default });
var appIconVariants = cva("flex items-center justify-center relative grow-0 shrink-0 overflow-hidden leading-none border-[0.5px] border-divider-regular", {
	variants: {
		size: {
...
var EditIconWrapperVariants = cva("absolute left-0 top-0 z-10 flex items-center justify-center bg-background-overlay-alt", {
	variants: {
		size: {
...
var EditIconVariants = cva("text-text-primary-on-surface", {
	variants: { size: {
		xs: "size-3",
		tiny: "size-3.5",
		small: "size-5",
...
var AppIcon = ({ size = "medium", rounded = false, iconType, icon, background, imageUrl, className, innerIcon, coverElement, onClick, showEditIcon = false }) => {
	const isValidImageIcon = iconType === "image" && imageUrl;
	const Icon = icon && icon !== "" ? /* @__PURE__ */ jsx("em-emoji", { id: icon }) : /* @__PURE__ */ jsx("em-emoji", { id: "🤖" });
	const wrapperRef = useRef(null);
	const isHovering = useHover_default(wrapperRef);
	return /* @__PURE__ */ jsxs("span", {
		ref: wrapperRef,
		className: cn(appIconVariants({
			size,
			rounded
		}), className),
		style: { background: isValidImageIcon ? void 0 : background || "#FFEAD5" },
		onClick,
		children: [
			isValidImageIcon ? /* @__PURE__ */ jsx("img", {
				src: imageUrl,
				className: "h-full w-full",
				alt: "app icon"
			}) : innerIcon || Icon,
			showEditIcon && isHovering && /* @__PURE__ */ jsx("div", {
				className: EditIconWrapperVariants({
					size,
					rounded
				}),
				children: /* @__PURE__ */ jsx(Ct, { className: EditIconVariants({ size }) })
			}),
			coverElement
		]
	});
};
var app_icon_default = React$1.memo(AppIcon);
//#endregion
export { useHover_default as a, native_default as i, $7adb23b0109cc36a$export$2cd8252107eb640b as n, useEventListener as o, $c4d155af13ad4d4b$export$2e2bcd8739ae039 as r, app_icon_default as t };
