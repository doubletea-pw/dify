//#region i18n/fa-IR/app-debug.json
var autoAddVar = "متغیرهای تعریف نشده که در پیش اعلان ارجاع داده شده اند، آیا می خواهید آنها را به صورت ورودی کاربر اضافه کنید؟";
var chatSubTitle = "دستورالعمل";
var completionSubTitle = "اعلان پیشوند";
var debugAsMultipleModel = "اشکال زدایی به عنوان چندین مدل";
var debugAsSingleModel = "اشکال زدایی به عنوان مدل واحد";
var duplicateModel = "تکراری";
var formattingChangedText = "با تغییر قالب بندی، ناحیه اشکال زدایی بازنشانی می شود، مطمئن هستید؟";
var formattingChangedTitle = "قالب بندی تغییر کرد";
var noResult = "خروجی در اینجا نمایش داده می شود.";
var notSetVar = "متغیرها به کاربران امکان می‌دهند تا هنگام پر کردن فرم‌ها، کلمات راهنما یا سخنان افتتاحیه را وارد کنند. می‌توانید امتحان کنید که '{{input}}' را در کلمات راهنما وارد کنید.";
var orchestrate = "هماهنگ کردن";
var promptTip = "پرومپت‌ها پاسخ‌های هوش مصنوعی را با دستورالعمل‌ها و محدودیت‌ها هدایت می‌کنند. متغیرهایی مانند {{input}} را وارد کنید. این پرومپت برای کاربران قابل مشاهده نخواهد بود.";
var publishAs = "انتشار به عنوان";
var result = "متن خروجی";
var variableTip = "کاربران متغیرها را در یک فرم پر می کنند و به طور خودکار متغیرها را در اعلان جایگزین می کنند.";
var variableTitle = "متغیرهای";
var app_debug_default = {
	...
	"errorMessage.valueOfVarRequired": "مقدار {{key}} نمی‌تواند خالی باشد",
	...
	"feature.annotation.description": "می‌توانید پاسخ‌های با کیفیت بالا را به صورت دستی به حافظه کش اضافه کنید تا با سوالات مشابه کاربران تطبیق یابد.",
	...
	"feature.annotation.resDes": "پاسخ حاشیه‌نویسی فعال شده است",
	...
	"feature.annotation.title": "پاسخ حاشیه‌نویسی",
	"feature.audioUpload.description": "فعال‌سازی صوت به مدل اجازه می‌دهد فایل‌های صوتی را برای رونویسی و تجزیه و تحلیل پردازش کند.",
	"feature.audioUpload.title": "صوتی",
	"feature.bar.empty": "فعال‌سازی ویژگی برای بهبود تجربه کاربری اپلیکیشن وب",
	"feature.bar.enableText": "ویژگی‌های فعال",
	"feature.bar.manage": "مدیریت",
	"feature.citation.description": "پس از فعال شدن، سند منبع و بخش استناد شده از محتوای تولید شده را نشان می‌دهد.",
	"feature.citation.resDes": "ارجاعات و استنادات فعال شده است",
	"feature.citation.title": "ارجاعات و استنادات",
	"feature.conversationHistory.description": "تنظیم پیشوند نام‌ها برای نقش‌های مکالمه",
	"feature.conversationHistory.editModal.assistantPrefix": "پیشوند دستیار",
	"feature.conversationHistory.editModal.title": "ویرایش نام نقش‌های مکالمه",
	...
	"feature.conversationOpener.description": "در یک برنامه چت، اولین جمله‌ای که AI فعالانه با کاربر صحبت می‌کند، معمولاً به عنوان خوشامدگویی استفاده می‌شود.",
	"feature.conversationOpener.title": "شروع‌کننده گفتگو",
	"feature.dataSet.noData": "شما می‌توانید دانش را به عنوان زمینه وارد کنید",
	"feature.dataSet.noDataSet": "هیچ دانشی یافت نشد",
	"feature.dataSet.notSupportSelectMulti": "در حال حاضر فقط یک دانش پشتیبانی می‌شود",
	"feature.dataSet.queryVariable.choosePlaceholder": "انتخاب متغیر پرس و جو",
	"feature.dataSet.queryVariable.contextVarNotEmpty": "متغیر پرس و جو زمینه نمی‌تواند خالی باشد",
	"feature.dataSet.queryVariable.deleteContextVarTip": "این متغیر به عنوان متغیر پرس و جو زمینه تنظیم شده است و حذف آن بر استفاده عادی از دانش تأثیر می‌گذارد. اگر هنوز نیاز به حذف دارید، لطفاً آن را در بخش زمینه دوباره انتخاب کنید.",
	...
	"feature.dataSet.queryVariable.tip": "این متغیر به عنوان ورودی پرس و جو برای بازیابی زمینه استفاده خواهد شد و اطلاعات زمینه مرتبط با ورودی این متغیر را به دست می‌آورد.",
	...
	"feature.documentUpload.description": "فعال‌سازی سند به مدل اجازه می‌دهد اسناد را دریافت کرده و درباره آن‌ها پاسخ دهد.",
	"feature.documentUpload.title": "سند",
	"feature.fileUpload.description": "جعبه ورودی چت امکان آپلود تصاویر، اسناد و سایر فایل‌ها را فراهم می‌کند.",
	"feature.fileUpload.modalTitle": "تنظیمات آپلود فایل",
	"feature.fileUpload.numberLimit": "حداکثر آپلود",
	"feature.fileUpload.supportedTypes": "انواع فایل‌های پشتیبانی شده",
	"feature.fileUpload.title": "آپلود فایل",
	"feature.groupChat.description": "افزودن تنظیمات پیش از گفتگو برای برنامه‌ها می‌تواند تجربه کاربری را بهبود بخشد.",
	"feature.groupChat.title": "تقویت گفتگو",
	"feature.groupExperience.title": "تقویت تجربه",
	"feature.imageUpload.description": "امکان آپلود تصاویر را فراهم می‌کند.",
	"feature.imageUpload.modalTitle": "تنظیمات آپلود تصویر",
	"feature.imageUpload.numberLimit": "حداکثر آپلود",
	"feature.imageUpload.supportedTypes": "انواع فایل‌های پشتیبانی شده",
	...
	"feature.moderation.modal.content.errorMessage": "پاسخ‌های پیش فرض نمی‌تواند خالی باشد",
	"feature.moderation.modal.content.fromApi": "پاسخ‌های پیش فرض از API برگردانده می‌شود",
	"feature.moderation.modal.content.input": "مدیریت محتوای ورودی",
	"feature.moderation.modal.content.output": "مدیریت محتوای خروجی",
	"feature.moderation.modal.content.placeholder": "محتوای پاسخ‌های پیش فرض در اینجا",
	"feature.moderation.modal.content.preset": "پاسخ‌های پیش فرض",
	...
	"feature.moreLikeThis.tip": "استفاده از این ویژگی هزینه‌های اضافی توکن‌ها را به همراه دارد",
	"feature.moreLikeThis.title": "بیشتر از این",
	"feature.speechToText.description": "پس از فعال شدن، می‌توانید از ورودی صوتی استفاده کنید.",
	...
	"feature.textToSpeech.description": "پس از فعال شدن، متن می‌تواند به گفتار تبدیل شود.",
	...
	"feature.tools.tips": "ابزارها یک روش استاندارد برای فراخوانی API فراهم می‌کنند و ورودی کاربر یا متغیرها را به عنوان پارامترهای درخواست برای پرس و جو داده‌های خارجی به عنوان زمینه می‌گیرند.",
	...
	"generate.codeGenInstructionPlaceHolderLine": "هر چه بازخورد دقیق‌تر باشد، مانند نوع داده‌های ورودی و خروجی و همچنین نحوه پردازش متغیرها، تولید کد دقیق‌تر خواهد بود.",
	...
	"generate.idealOutputPlaceholder": "ایده‌آل پاسخ شما چه شکلی باید باشد؟ لطفاً درباره فرمت، طول، لحن و الزامات محتوایی آن توضیح دهید ...",
	...
	"generate.instructionPlaceHolderLine3": "لحن خیلی تند است، لطفاً آن را دوستانه‌تر کنید.",
	"generate.instructionPlaceHolderTitle": "توصیف کنید که چگونه می‌خواهید این دستورالعمل را بهبود ببخشید. به عنوان مثال:",
	...
	"generate.optimizationNote": "یادداشت بهینه‌سازی",
	"generate.optimizePromptTooltip": "بهینه‌سازی در تولیدکننده پرامپت",
	...
	noResult,
	"notSetAPIKey.description": "کلید ارائه‌دهنده LLM تنظیم نشده است و باید قبل از دیباگ تنظیم شود.",
	"notSetAPIKey.settingBtn": "به تنظیمات بروید",
	"notSetAPIKey.title": "کلید ارائه‌دهنده LLM تنظیم نشده است",
	...
	"openingStatement.openingQuestionPlaceholder": "می‌توانید از متغیرها استفاده کنید، امتحان کنید {{variable}} را تایپ کنید.",
	"openingStatement.placeholder": "پیام شروع خود را اینجا بنویسید، می‌توانید از متغیرها استفاده کنید، امتحان کنید تایپ {{variable}}.",
	...
	"openingStatement.varTip": "می‌توانید از متغیرها استفاده کنید، نوع {{variable}} را امتحان کنید",
	...
	"operation.stopResponding": "توقف پاسخ‌دهی",
	...
	"promptMode.advancedWarning.description": "در حالت کارشناس، می‌توانید کل پرومپت را ویرایش کنید.",
	"promptMode.advancedWarning.learnMore": "بیشتر بدانید",
	"promptMode.advancedWarning.ok": "باشه",
	"promptMode.advancedWarning.title": "شما به حالت کارشناس رفته‌اید، و پس از تغییر پرومپت، نمی‌توانید به حالت ساده برگردید.",
	"promptMode.contextMissing": "مولفه زمینه‌ای از دست رفته است، اثر بخشی پرومپت ممکن است خوب نباشد.",
	...
	"trailUseGPT4Info.title": "در حال حاضر پشتیبانی نمی‌شود gpt-4",
	"varKeyError.canNoBeEmpty": "{{key}} مورد نیاز است",
	"varKeyError.keyAlreadyExists": "{{key}} قبلاً موجود است",
	"varKeyError.notStartWithNumber": "{{key}} نمی‌تواند با یک عدد شروع شود",
	"varKeyError.notValid": "{{key}} نامعتبر است. فقط می‌تواند شامل حروف، اعداد و زیرخط باشد",
	"varKeyError.tooLong": "{{key}} خیلی طولانی است. نمی‌تواند بیش از ۳۰ کاراکتر باشد",
	...
	"variableConfig.jsonSchema": "طرح‌واره JSON",
...
//#endregion
export { autoAddVar, chatSubTitle, completionSubTitle, debugAsMultipleModel, debugAsSingleModel, app_debug_default as default, duplicateModel, formattingChangedText, formattingChangedTitle, noResult, notSetVar, orchestrate, promptTip, publishAs, result, variableTip, variableTitle };
