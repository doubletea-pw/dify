	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function(modules) {
			...
			function __vite_rsc_require__(moduleId) {
				...
				modules[moduleId].call(module$15.exports, module$15, module$15.exports, __vite_rsc_require__);
				module$15.l = true;
			...
			__vite_rsc_require__.d = function(exports$13, name, getter) {
				if (!__vite_rsc_require__.o(exports$13, name)) Object.defineProperty(exports$13, name, {
					configurable: false,
					enumerable: true,
					get: getter
				});
			};
			__vite_rsc_require__.n = function(module$16) {
			...
			return __vite_rsc_require__(__vite_rsc_require__.s = 26);
		})([
			(function(module$17, exports$14, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$18, exports$15, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$19, exports$16, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$20, exports$17, __vite_rsc_require__) {
				"use strict";
				var LGraphObject = __vite_rsc_require__(2);
				...
				var PointD = __vite_rsc_require__(4);
			...
			(function(module$21, exports$18, __vite_rsc_require__) {
				"use strict";
				function PointD(x, y) {
					if (x == null && y == null) {
						this.x = 0;
			...
			(function(module$22, exports$19, __vite_rsc_require__) {
				"use strict";
				var LGraphObject = __vite_rsc_require__(2);
				var Integer = __vite_rsc_require__(10);
				var LayoutConstants = __vite_rsc_require__(0);
				var LGraphManager = __vite_rsc_require__(6);
			...
			(function(module$23, exports$20, __vite_rsc_require__) {
				"use strict";
				var LGraph;
				var LEdge = __vite_rsc_require__(1);
				function LGraphManager(layout) {
					LGraph = __vite_rsc_require__(5);
					this.layout = layout;
					this.graphs = [];
					this.edges = [];
				}
			...
			(function(module$24, exports$21, __vite_rsc_require__) {
				"use strict";
				var LayoutConstants = __vite_rsc_require__(0);
			...
			(function(module$25, exports$22, __vite_rsc_require__) {
				"use strict";
				/**
			...
			(function(module$26, exports$23, __vite_rsc_require__) {
				"use strict";
				function IMath() {}
				/**
			...
			(function(module$27, exports$24, __vite_rsc_require__) {
				"use strict";
				function Integer() {}
			...
			(function(module$28, exports$25, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$29, exports$26, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$30, exports$27, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$31, exports$28, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$32, exports$29, __vite_rsc_require__) {
				"use strict";
				...
				var LNode = __vite_rsc_require__(3);
				var LEdge = __vite_rsc_require__(1);
				var LGraph = __vite_rsc_require__(5);
				var PointD = __vite_rsc_require__(4);
				var Transform = __vite_rsc_require__(17);
				var Emitter = __vite_rsc_require__(27);
			...
			(function(module$33, exports$30, __vite_rsc_require__) {
				"use strict";
				function RandomSeed() {}
				RandomSeed.seed = 1;
				RandomSeed.x = 0;
			...
			(function(module$34, exports$31, __vite_rsc_require__) {
				"use strict";
				var PointD = __vite_rsc_require__(4);
			...
			(function(module$35, exports$32, __vite_rsc_require__) {
				"use strict";
				function _toConsumableArray(arr) {
					if (Array.isArray(arr)) {
						for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) arr2[i] = arr[i];
				...
				var FDLayoutConstants = __vite_rsc_require__(7);
				var LayoutConstants = __vite_rsc_require__(0);
				var IGeometry = __vite_rsc_require__(8);
				var IMath = __vite_rsc_require__(9);
				function FDLayout() {
			...
			(function(module$36, exports$33, __vite_rsc_require__) {
				"use strict";
				var LEdge = __vite_rsc_require__(1);
				var FDLayoutConstants = __vite_rsc_require__(7);
			...
			(function(module$37, exports$34, __vite_rsc_require__) {
				"use strict";
				var LNode = __vite_rsc_require__(3);
			...
			(function(module$38, exports$35, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$39, exports$36, __vite_rsc_require__) {
				"use strict";
			...
			(function(module$40, exports$37, __vite_rsc_require__) {
				"use strict";
				var UniqueIDGeneretor = __vite_rsc_require__(14);
				function HashSet() {
					this.set = {};
			...
			(function(module$41, exports$38, __vite_rsc_require__) {
				"use strict";
				var _createClass = function() {
					function defineProperties(target, props) {
						for (var i = 0; i < props.length; i++) {
			...
			(function(module$42, exports$39, __vite_rsc_require__) {
				"use strict";
				var _createClass = function() {
					function defineProperties(target, props) {
						for (var i = 0; i < props.length; i++) {
			...
			(function(module$43, exports$40, __vite_rsc_require__) {
				"use strict";
				var layoutBase = function layoutBase() {};
				layoutBase.FDLayout = __vite_rsc_require__(18);
				layoutBase.FDLayoutConstants = __vite_rsc_require__(7);
				...
				layoutBase.PointD = __vite_rsc_require__(4);
				...
				layoutBase.Quicksort = __vite_rsc_require__(24);
				layoutBase.LinkedList = __vite_rsc_require__(11);
				layoutBase.LGraphObject = __vite_rsc_require__(2);
				layoutBase.LGraph = __vite_rsc_require__(5);
				layoutBase.LEdge = __vite_rsc_require__(1);
				layoutBase.LGraphManager = __vite_rsc_require__(6);
				...
				layoutBase.NeedlemanWunsch = __vite_rsc_require__(25);
				module$43.exports = layoutBase;
			}),
			(function(module$44, exports$41, __vite_rsc_require__) {
				"use strict";
				function Emitter() {
					this.listeners = [];
				}
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function(modules) {
			...
			function __vite_rsc_require__(moduleId) {
				...
				modules[moduleId].call(module$5.exports, module$5, module$5.exports, __vite_rsc_require__);
				module$5.l = true;
			...
			__vite_rsc_require__.d = function(exports$4, name, getter) {
				if (!__vite_rsc_require__.o(exports$4, name)) Object.defineProperty(exports$4, name, {
					configurable: false,
					enumerable: true,
					get: getter
				});
			};
			__vite_rsc_require__.n = function(module$6) {
			...
			__vite_rsc_require__.p = "";
			return __vite_rsc_require__(__vite_rsc_require__.s = 7);
		})([
			(function(module$7, exports$5) {
				module$7.exports = __WEBPACK_EXTERNAL_MODULE_0__;
			}),
			(function(module$8, exports$6, __vite_rsc_require__) {
				"use strict";
				var FDLayoutConstants = __vite_rsc_require__(0).FDLayoutConstants;
			...
			(function(module$9, exports$7, __vite_rsc_require__) {
				"use strict";
				var FDLayoutEdge = __vite_rsc_require__(0).FDLayoutEdge;
			...
			(function(module$10, exports$8, __vite_rsc_require__) {
				"use strict";
				var LGraph = __vite_rsc_require__(0).LGraph;
			...
			(function(module$11, exports$9, __vite_rsc_require__) {
				"use strict";
				var LGraphManager = __vite_rsc_require__(0).LGraphManager;
			...
			(function(module$12, exports$10, __vite_rsc_require__) {
				"use strict";
				var FDLayoutNode = __vite_rsc_require__(0).FDLayoutNode;
				var IMath = __vite_rsc_require__(0).IMath;
			...
			(function(module$13, exports$11, __vite_rsc_require__) {
				"use strict";
				var FDLayout = __vite_rsc_require__(0).FDLayout;
				var CoSEGraphManager = __vite_rsc_require__(4);
				var CoSEGraph = __vite_rsc_require__(3);
				var CoSENode = __vite_rsc_require__(5);
				var CoSEEdge = __vite_rsc_require__(2);
				var CoSEConstants = __vite_rsc_require__(1);
				var FDLayoutConstants = __vite_rsc_require__(0).FDLayoutConstants;
				var LayoutConstants = __vite_rsc_require__(0).LayoutConstants;
				var Point = __vite_rsc_require__(0).Point;
				var PointD = __vite_rsc_require__(0).PointD;
				var Layout = __vite_rsc_require__(0).Layout;
				var Integer = __vite_rsc_require__(0).Integer;
				var IGeometry = __vite_rsc_require__(0).IGeometry;
				var LGraph = __vite_rsc_require__(0).LGraph;
				var Transform = __vite_rsc_require__(0).Transform;
				function CoSELayout() {
					FDLayout.call(this);
					this.toBeTiled = {};
				}
			...
			(function(module$14, exports$12, __vite_rsc_require__) {
				"use strict";
				var coseBase = {};
				coseBase.layoutBase = __vite_rsc_require__(0);
				coseBase.CoSEConstants = __vite_rsc_require__(1);
				coseBase.CoSEEdge = __vite_rsc_require__(2);
				coseBase.CoSEGraph = __vite_rsc_require__(3);
				coseBase.CoSEGraphManager = __vite_rsc_require__(4);
				coseBase.CoSELayout = __vite_rsc_require__(6);
				coseBase.CoSENode = __vite_rsc_require__(5);
...
//#endregion
//#region node_modules/.pnpm/mermaid@11.13.0/node_modules/mermaid/dist/chunks/mermaid.core/cose-bilkent-S5V4N54A.mjs
	...
	(function webpackUniversalModuleDefinition(root, factory) {
		...
		return (function(modules) {
			...
			function __vite_rsc_require__(moduleId) {
				...
				modules[moduleId].call(module$1.exports, module$1, module$1.exports, __vite_rsc_require__);
				module$1.l = true;
			...
			__vite_rsc_require__.n = function(module$2) {
			...
			__vite_rsc_require__.p = "";
			return __vite_rsc_require__(__vite_rsc_require__.s = 1);
		})([(function(module$3, exports$2) {
			module$3.exports = __WEBPACK_EXTERNAL_MODULE_0__;
		}), (function(module$4, exports$3, __vite_rsc_require__) {
			"use strict";
			var LayoutConstants = __vite_rsc_require__(0).layoutBase.LayoutConstants;
			var FDLayoutConstants = __vite_rsc_require__(0).layoutBase.FDLayoutConstants;
			var CoSEConstants = __vite_rsc_require__(0).CoSEConstants;
			var CoSELayout = __vite_rsc_require__(0).CoSELayout;
			var CoSENode = __vite_rsc_require__(0).CoSENode;
			var PointD = __vite_rsc_require__(0).layoutBase.PointD;
			var DimensionD = __vite_rsc_require__(0).layoutBase.DimensionD;
			var defaults = {
