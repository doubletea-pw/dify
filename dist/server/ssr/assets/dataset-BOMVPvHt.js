//#region i18n/fa-IR/dataset.json
var allExternalTip = "هنگامی که فقط از دانش خارجی استفاده می کنید، کاربر می تواند انتخاب کند که آیا مدل Rerank را فعال کند یا خیر. اگر فعال نباشد، تکه های بازیابی شده بر اساس امتیازات مرتب می شوند. هنگامی که استراتژی های بازیابی پایگاه های دانش مختلف متناقض باشد، نادرست خواهد بود.";
var allKnowledge = "همه دانش ها";
var allKnowledgeDescription = "برای نمایش تمام دانش در این فضای کاری انتخاب کنید. فقط مالک فضای کاری می تواند تمام دانش را مدیریت کند.";
var appCount = " برنامه‌های متصل";
var connectDataset = "اتصال به یک پایگاه دانش خارجی";
var createDataset = "ایجاد دانش";
var createDatasetIntro = "داده‌های متنی خود را وارد کنید یا از طریق Webhook در زمان واقعی برای بهبود زمینه LLM بنویسید.";
var createExternalAPI = "افزودن یک API دانش خارجی";
var createFromPipeline = "ایجاد از پایپ لاین دانش";
var createNewExternalAPI = "ایجاد یک API دانش خارجی جدید";
var datasetDeleteFailed = "حذف دانش ناموفق بود";
var datasetDeleted = "دانش حذف شد";
var datasetUsedByApp = "دانش توسط برخی برنامه‌ها استفاده می‌شود. برنامه‌ها دیگر نمی‌توانند از این دانش استفاده کنند و تمام تنظیمات درخواست و گزارش‌ها به طور دائم حذف خواهند شد.";
var datasets = "دانش";
var datasetsApi = "دسترسی API";
var defaultRetrievalTip = "بازیابی چند مسیره به طور پیش فرض استفاده می شود. دانش از چندین پایگاه دانش بازیابی می شود و سپس دوباره رتبه بندی می شود.";
var deleteDatasetConfirmContent = "حذف دانش غیر قابل برگشت است. کاربران دیگر نمی‌توانند به دانش شما دسترسی پیدا کنند و تمام تنظیمات درخواست و گزارش‌ها به طور دائم حذف خواهند شد.";
var deleteDatasetConfirmTitle = "حذف این دانش؟";
var didYouKnow = "آیا می‌دانستید؟";
var docAllEnabled_one = "سند {{count}} فعال شد";
var docAllEnabled_other = "تمام اسناد {{count}} فعال شدند";
var docsFailedNotice = "اسناد نتوانستند فهرست‌بندی شوند";
var documentCount = " سند";
var documentsDisabled = "{{num}} اسناد غیرفعال - غیرفعال برای بیش از 30 روز";
var editExternalAPIFormTitle = "ویرایش API دانش خارجی";
var editExternalAPITooltipTitle = "دانش مرتبط";
var embeddingModelNotAvailable = "مدل جاسازی در دسترس نیست.";
var enable = "فعال";
var externalAPI = "API خارجی";
var externalAPIPanelDescription = "API دانش خارجی برای اتصال به یک پایگاه دانش خارج از Dify و بازیابی دانش از آن پایگاه دانش استفاده می شود.";
var externalAPIPanelDocumentation = "یادگیری نحوه ایجاد یک API دانش خارجی";
var externalAPIPanelTitle = "API دانش خارجی";
var externalKnowledgeBase = "پایگاه دانش خارجی";
var externalKnowledgeDescription = "توضیحات دانش";
var externalKnowledgeDescriptionPlaceholder = "آنچه در این پایگاه دانش وجود دارد را توضیح دهید (اختیاری)";
var externalKnowledgeId = "شناسه دانش خارجی";
var externalKnowledgeIdPlaceholder = "لطفا شناسه دانش را وارد کنید";
var externalKnowledgeName = "نام دانش خارجی";
var externalKnowledgeNamePlaceholder = "لطفا نام پایگاه دانش را وارد کنید";
var externalTag = "خارجی";
var inconsistentEmbeddingModelTip = "مدل دوباره رتبه‌بندی لازم است اگر مدل‌های جاسازی پایگاه‌های دانش انتخابی ناسازگار باشند.";
var intro1 = "دانش می‌تواند در برنامه Dify ";
var intro2 = "به عنوان یک زمینه";
var intro3 = "ادغام شود";
var intro4 = "یا می‌تواند ";
var intro5 = "به عنوان یک افزونه مستقل ChatGPT برای انتشار";
var intro6 = "ایجاد شود";
var knowledge = "دانش";
var learnHowToWriteGoodKnowledgeDescription = "یاد بگیرید که چگونه یک توضیحات دانش خوب بنویسید.";
var localDocs = "اسناد محلی";
var mixtureHighQualityAndEconomicTip = "مدل دوباره رتبه‌بندی برای ترکیب پایگاه‌های دانش با کیفیت بالا و اقتصادی لازم است.";
var mixtureInternalAndExternalTip = "مدل Rerank برای آمیختگی دانش درونی و بیرونی مورد نیاز است.";
var multimodal = "چندوجهی";
var nTo1RetrievalLegacy = "بازیابی N-to-1 از سپتامبر به طور رسمی منسوخ خواهد شد. توصیه می‌شود از بازیابی چند مسیر جدید استفاده کنید تا نتایج بهتری بدست آورید.";
var nTo1RetrievalLegacyLink = "بیشتر بدانید";
var nTo1RetrievalLegacyLinkText = " بازیابی N-to-1 از سپتامبر به طور رسمی منسوخ خواهد شد.";
var noExternalKnowledge = "هنوز هیچ API دانش خارجی وجود ندارد، برای ایجاد اینجا را کلیک کنید";
var partialEnabled_one = "مجموعاً {{count}} سند، {{num}} موجود";
var partialEnabled_other = "مجموع {{count}} سند، {{num}} موجود";
var preprocessDocument = "{{num}} اسناد پیش پردازش";
var rerankSettings = "تنظیمات دوباره رتبه‌بندی";
var retrievalSettings = "تنظیمات بازیابی";
var retry = "تلاش مجدد";
var unavailable = "در دسترس نیست";
var unknownError = "خطای ناشناخته";
var updated = "بروز رسانی";
var wordCount = " هزار کلمه";
var dataset_default = {
	allExternalTip,
	allKnowledge,
	...
	"externalKnowledgeForm.connectedFailed": "اتصال به پایگاه دانش خارجی ناموفق بود",
	"externalKnowledgeForm.connectedSuccess": "پایگاه دانش خارجی با موفقیت متصل شد",
	externalKnowledgeId,
	...
	"metadata.batchEditMetadata.applyToAllSelectDocumentTip": "به‌طور خودکار تمام متاداده‌های ویرایش شده و جدید فوق را برای تمام اسناد انتخاب شده ایجاد کنید، در غیر این صورت ویرایش متاداده فقط به اسنادی که دارای آن هستند اعمال خواهد شد.",
	...
	"metadata.datasetMetadata.builtIn": "ساخته شده درون‌سازی",
	"metadata.datasetMetadata.builtInDescription": "متاداده‌های داخلی به‌طور خودکار استخراج و تولید می‌شوند. قبل از استفاده باید فعال شود و قابل ویرایش نیست.",
	...
	"metadata.datasetMetadata.description": "شما می‌توانید تمام فراداده‌ها را در این دانش مدیریت کنید. تغییرات به هر سندی همزمان می‌شوند.",
	...
	"metadata.documentMetadata.metadataToolTip": "متادیتا به عنوان یک فیلتر حیاتی عمل می‌کند که دقت و ارتباط اطلاعات بازیابی را بهبود می‌بخشد. شما می‌توانید متادیتا را برای این سند در اینجا ویرایش و اضافه کنید.",
	"metadata.documentMetadata.startLabeling": "شروع برچسب‌گذاری",
	...
	"retrieval.full_text_search.description": "فهرست کردن تمام اصطلاحات در سند، به کاربران اجازه می‌دهد هر اصطلاحی را جستجو کنند و بخش متنی مربوط به آن اصطلاحات را بازیابی کنند.",
	...
	"serviceApi.card.endpoint": "نقطه انتهایی رابط برنامه‌نویسی سرویس",
	"serviceApi.card.title": "رابط برنامه‌نویسی سرویس پشتیبان",
	"serviceApi.disabled": "معلول",
	"serviceApi.enabled": "در حال خدمت",
	"serviceApi.title": "رابط برنامه‌نویسی سرویس",
	unavailable,
	unknownError,
	updated,
	"weightedScore.customized": "سفارشی‌سازی شده",
	"weightedScore.description": "با تنظیم وزن‌های اختصاص داده شده، این استراتژی دوباره رتبه‌بندی تعیین می‌کند که آیا اولویت با تطابق معنایی یا کلمات کلیدی است.",
