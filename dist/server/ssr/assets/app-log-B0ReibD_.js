//#region i18n/fr-FR/app-log.json
var agentLog = "Journal des agents";
var dateFormat = "JJ/MM/YYYY";
var dateTimeFormat = "MM/DD/YYYY hh:mm:ss A";
var description = "Les journaux enregistrent l'état d'exécution de l'application, y compris les entrées utilisateur et les réponses de l'IA.";
var promptLog = "Journal de consigne";
var title = "Journaux";
var viewLog = "Voir le journal";
var workflowSubtitle = "Le journal enregistre l'opération d'Automate.";
var workflowTitle = "Journaux de workflow";
var app_log_default = {
	agentLog,
	...
	"detail.operation.addAnnotation": "Ajouter une amélioration",
	"detail.operation.annotationPlaceholder": "Entrez la réponse attendue que vous souhaitez que l'IA donne, cela peut être utilisé pour le réglage fin du modèle et l'amélioration continue de la qualité de génération de texte à l'avenir.",
	"detail.operation.dislike": "je n'aime pas",
	"detail.operation.editAnnotation": "Modifier une amélioration",
	"detail.operation.like": "j'aime",
	"detail.promptTemplate": "Modèle de consigne",
	"detail.promptTemplateBeforeChat": "Modèle de consigne avant la conversation · En tant que message système",
	"detail.second": "s",
	"detail.time": "Heure",
